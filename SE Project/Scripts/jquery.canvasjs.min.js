...
*/
(function () {
    function oa(h, l) { h.prototype = fb(l.prototype); h.prototype.constructor = h; h.base = l.prototype } function fb(h) { function l() { } l.prototype = h; return new l } function Ya(h, l, v) {
        "millisecond" === v ? h.setMilliseconds(h.getMilliseconds() + 1 * l) : "second" === v ? h.setSeconds(h.getSeconds() + 1 * l) : "minute" === v ? h.setMinutes(h.getMinutes() + 1 * l) : "hour" === v ? h.setHours(h.getHours() + 1 * l) : "day" === v ? h.setDate(h.getDate() + 1 * l) : "week" === v ? h.setDate(h.getDate() + 7 * l) : "month" === v ? h.setMonth(h.getMonth() + 1 * l) : "year" === v && h.setFullYear(h.getFullYear() +
            1 * l); return h
    } function W(h, l) { var v = !1; 0 > h && (v = !0, h *= -1); h = "" + h; for (l = l ? l : 1; h.length < l;)h = "0" + h; return v ? "-" + h : h } function Ia(h) { if (!h) return h; h = h.replace(/^\s\s*/, ""); for (var l = /\s/, v = h.length; l.test(h.charAt(--v));); return h.slice(0, v + 1) } function Ea(h) {
        h.roundRect = function (h, v, r, w, qa, D, x, E) {
            x && (this.fillStyle = x); E && (this.strokeStyle = E); "undefined" === typeof qa && (qa = 5); this.lineWidth = D; this.beginPath(); this.moveTo(h + qa, v); this.lineTo(h + r - qa, v); this.quadraticCurveTo(h + r, v, h + r, v + qa); this.lineTo(h + r,
                v + w - qa); this.quadraticCurveTo(h + r, v + w, h + r - qa, v + w); this.lineTo(h + qa, v + w); this.quadraticCurveTo(h, v + w, h, v + w - qa); this.lineTo(h, v + qa); this.quadraticCurveTo(h, v, h + qa, v); this.closePath(); x && this.fill(); E && 0 < D && this.stroke()
        }
    } function Sa(h, l) { return h - l } function S(h) { var l = ((h & 16711680) >> 16).toString(16), v = ((h & 65280) >> 8).toString(16); h = ((h & 255) >> 0).toString(16); l = 2 > l.length ? "0" + l : l; v = 2 > v.length ? "0" + v : v; h = 2 > h.length ? "0" + h : h; return "#" + l + v + h } function gb(h, l) {
        var v = this.length >>> 0, r = Number(l) || 0, r = 0 > r ? Math.ceil(r) :
            Math.floor(r); for (0 > r && (r += v); r < v; r++)if (r in this && this[r] === h) return r; return -1
    } function r(h) { return null === h || "undefined" === typeof h } function Fa(h) { h.indexOf || (h.indexOf = gb); return h } function hb(h) { if (Y.fSDec) h[ia("`eeDwdouMhrudods")](ia("e`u`@ohl`uhnoHuds`uhnoDoe"), function () { Y._fTWm && Y._fTWm(h) }) } function Za(h, l, v) {
        v = v || "normal"; var r = h + "_" + l + "_" + v, w = $a[r]; if (isNaN(w)) {
            try {
                if (!xa) {
                    var qa = document.body; xa = document.createElement("span"); xa.innerHTML = ""; var D = document.createTextNode("Mpgyi"); xa.appendChild(D);
                    qa.appendChild(xa)
                } xa.style.display = ""; T(xa, { position: "absolute", left: "0px", top: "-20000px", padding: "0px", margin: "0px", border: "none", whiteSpace: "pre", lineHeight: "normal", fontFamily: h, fontSize: l + "px", fontWeight: v }); w = Math.round(xa.offsetHeight); xa.style.display = "none"
            } catch (x) { w = Math.ceil(1.1 * l) } w = Math.max(w, l); $a[r] = w
        } return w
    } function I(h, l) {
        var v = []; if (v = {
        ...
        }[h || "solid"]) for (var r = 0; r < v.length; r++)v[r] *= l; else v = []; return v
    } function K(h, l, v, w, ua) { w = w || []; ua = r(ua) ? ib ? { passive: !1, capture: !1 } : !1 : ua; w.push([h, l, v, ua]); return h.addEventListener ? (h.addEventListener(l, v, ua), v) : h.attachEvent ? (w = function (l) { l = l || window.event; l.preventDefault = l.preventDefault || function () { l.returnValue = !1 }; l.stopPropagation = l.stopPropagation || function () { l.cancelBubble = !0 }; v.call(h, l) }, h.attachEvent("on" + l, w), w) : !1 } function jb(h) {
        if (h._menuButton) h.exportEnabled ?
            (T(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), Na(h._menuButton), ra(h, h._menuButton, "menu")) : va(h._menuButton); else if (h.exportEnabled && w) {
                var l = !1; h._menuButton = document.createElement("button"); ra(h, h._menuButton, "menu"); h._toolBar.appendChild(h._menuButton); K(h._menuButton, "touchstart", function (h) { l = !0 }, h.allDOMEventHandlers); K(h._menuButton, "click", function () {
                    ...
                    }), 0 >= navigator.userAgent.search("MSIE") && T(h._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }))
                }, h.allDOMEventHandlers, !0)
            } if (h.exportEnabled && h._dropdownMenu) {
                T(h._dropdownMenu, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }); for (var v = h._dropdownMenu.childNodes, r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], ua = 0; ua < v.length; ua++)T(v[ua], {
                    backgroundColor: h.toolbar.itemBackgroundColor,
                    color: h.toolbar.fontColor
                }), v[ua].innerHTML = r[ua]
                ...
                v.innerHTML = h._cultureInfo.saveJPGText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), K(v, "touchstart", function (h) { l = !0 }, h.allDOMEventHandlers), K(v, "mousemove", function () { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), K(v, "mouseout", function () { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) },
                    h.allDOMEventHandlers, !0), K(v, "click", function () { h.exportChart({ format: "jpeg", fileName: h.exportFileName }); va(h._dropdownMenu) }, h.allDOMEventHandlers, !0), v = document.createElement("div"), T(v, { padding: "12px 8px 12px 8px" }), v.innerHTML = h._cultureInfo.savePNGText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), K(v, "touchstart", function (h) { l = !0 }, h.allDOMEventHandlers), K(v, "mousemove", function () {
                        l || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover,
                            this.style.color = h.toolbar.fontColorOnHover)
                    }, h.allDOMEventHandlers, !0), K(v, "mouseout", function () { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), K(v, "click", function () { h.exportChart({ format: "png", fileName: h.exportFileName }); va(h._dropdownMenu) }, h.allDOMEventHandlers, !0))
    } function ab(h, l, v) {
        h *= ka; l *= ka; h = v.getImageData(h, l, 2, 2).data; l = !0; for (v = 0; 4 > v; v++)if (h[v] !== h[v + 4] | h[v] !== h[v + 8] | h[v] !== h[v + 12]) { l = !1; break } return l ?
            h[0] << 16 | h[1] << 8 | h[2] : 0
    } function la(h, l, v) { return h in l ? l[h] : v[h] } function Oa(h, l, v, wa) { w && bb ? (wa = !r(wa) && wa ? h.getContext("2d", { willReadFrequently: !0 }) : h.getContext("2d"), Pa = wa.webkitBackingStorePixelRatio || wa.mozBackingStorePixelRatio || wa.msBackingStorePixelRatio || wa.oBackingStorePixelRatio || wa.backingStorePixelRatio || 1, ka = Ta / Pa, h.width = l * ka, h.height = v * ka, Ta !== Pa && (h.style.width = l + "px", h.style.height = v + "px", wa.scale(ka, ka))) : (h.width = l, h.height = v) } function kb(h) {
        if (!lb) {
            var l = !1, v = !1; "undefined" ===
                typeof pa.Chart.creditHref ? (h.creditHref = ia("iuuqr;..b`ow`rkr/bnl."), h.creditText = ia("B`ow`rKR/bnl")) : (l = h.updateOption("creditText"), v = h.updateOption("creditHref")); if (h.creditHref && h.creditText) {
    ...
    function ta(h, l, v) { Ja && (this.canvasCount |= 0, window.console.log(++this.canvasCount)); var r = document.createElement("canvas"); r.setAttribute("class", "canvasjs-chart-canvas"); Oa(r, h, l, v); w || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(r); return r } function T(h, l) { for (var v in l) h.style[v] = l[v] } function ra(h, l, v) {
        ...
        })); l.getAttribute("state") !== v && (l.setAttribute("state", v), l.setAttribute("type", "button"), T(l, { padding: "5px 12px", cursor: "pointer", "float": "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }), l.innerHTML = "<img src='" + mb[v].image + "' alt='" + h._cultureInfo[v + "Text"] + "' />", T(l.childNodes[0], { height: "95%", pointerEvents: "none" })); l.setAttribute("title", h._cultureInfo[v + "Text"])
    } function Na() {
        for (var h = null,
        ...
        this.options = v ? v : { _isPlaceholder: !0 }; this.setOptions(this.options, h)
    } function Ga(h, l, v, r, w) { "undefined" === typeof w && (w = 0); this._padding = w; this._x1 = h; this._y1 = l; this._x2 = v; this._y2 = r; this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding } function ja(h, l) { ja.base.constructor.call(this, "TextBlock", null, l, null, null); this.ctx = h; this._isDirty = !0; this._wrappedText = null; this._initialize() } function Va(h, l) {
        Va.base.constructor.call(this, "Toolbar", "toolbar", l, null, h); this.chart =
            h; this.canvas = h.canvas; this.ctx = this.chart.ctx; this.optionsName = "toolbar"
    } function Ba(h, l) {
        Ba.base.constructor.call(this, "Title", "title", l, null, h); this.chart = h; this.canvas = h.canvas; this.ctx = this.chart.ctx; this.optionsName = "title"; if (r(this.options.margin) && h.options.subtitles) for (var v = h.options.subtitles, w = 0; w < v.length; w++)if ((r(v[w].horizontalAlign) && "center" === this.horizontalAlign || v[w].horizontalAlign === this.horizontalAlign) && (r(v[w].verticalAlign) && "top" === this.verticalAlign || v[w].verticalAlign ===
            this.verticalAlign) && !v[w].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0; break } "undefined" === typeof this.options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize)); this.height = this.width = null; this.bounds = { x1: null, y1: null, x2: null, y2: null }
    } function Ka(h, l, v) {
        Ka.base.constructor.call(this, "Subtitle", "subtitles", l, v, h); this.chart = h; this.canvas = h.canvas; this.ctx = this.chart.ctx; this.optionsName = "subtitles"; this.isOptionsInArray = !0; "undefined" === typeof this.options.fontSize &&
    ...
    } function Wa() { this.pool = [] } function La(h) { var l; h && Ma[h] && (l = Ma[h]); La.base.constructor.call(this, "CultureInfo", null, l, null, null) } var Ja = !1, Y = {}, w = !!document.createElement("canvas").getContext, pa = {
        Chart: {
            ...
            name: null, verticalAlign: "center", horizontalAlign: "right",
            ...
            minimum: null, maximum: null, viewportMinimum: null, viewportMaximum: null, interval: null, intervalType: null, reversed: !1,
            ...
            labelBackgroundColor: w ? "transparent" : null, labelBorderColor: w ? "transparent" : null, labelBorderThickness: 0, labelCornerRadius: 0, labelPlacement: "outside", labelTextAlign: "left", prefix: "", suffix: "", includeZero: !1, tickLength: 5, tickColor: "black", tickThickness: 1, tickPlacement: "outside", lineColor: "black", lineThickness: 1, lineDashType: "solid", gridColor: "#A0A0A0", gridThickness: 0, gridDashType: "solid", interlacedColor: w ? "transparent" : null, valueFormatString: null, margin: 2, publicProperties: {
                options: "readWrite", stripLines: "readWrite",
            ...
            startValue: null, endValue: null, spacing: 8, type: "straight",
            color: "#FFFFFF", fillOpacity: 0.9, lineThickness: 2, lineColor: "#E16E6E", lineDashType: "solid", publicProperties: { options: "readWrite", scaleBreaks: "readOnly", bounds: "readOnly", chart: "readOnly" }
        }, Crosshair: {
            enabled: !1, snapToDataPoint: !1, color: "grey", opacity: null, thickness: 2, lineDashType: "solid", label: "", labelWrap: !0, labelMaxWidth: null, labelBackgroundColor: w ? "grey" : null, labelBorderColor: w ? "grey" : null, labelBorderThickness: 0, labelCornerRadius: 0, labelFontFamily: w ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" :
            ...
            name: null, dataPoints: null, label: "", bevelEnabled: !1, highlightEnabled: !0, cursor: "default", indexLabel: "", indexLabelPlacement: "auto", indexLabelOrientation: "horizontal", indexLabelTextAlign: "left", indexLabelFontColor: "black", indexLabelFontSize: 12,
            ...
            x: 0, y: 0, width: null, height: null, maxWidth: null, maxHeight: null, padding: 0, angle: 0, text: "", horizontalAlign: "center", textAlign: "left",
            fontSize: 12, fontFamily: "calibri", fontWeight: "normal", fontColor: "black", fontStyle: "normal", borderThickness: 0, borderColor: "black", cornerRadius: 0, backgroundColor: null, textBaseline: "top"
        }, CultureInfo: {
            decimalSeparator: ".", digitGroupSeparator: ",", zoomText: "Zoom", panText: "Pan", resetText: "Reset", menuText: "More Options", saveJPGText: "Save as JPEG", savePNGText: "Save as PNG", printText: "Print", days: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), shortDays: "Sun Mon Tue Wed Thu Fri Sat".split(" "),
            months: "January February March April May June July August September October November December".split(" "), shortMonths: "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")
        }
    }, Ma = { en: {} }, x = w ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Ha = w ? "Impact, Charcoal, sans-serif" : "Arial", Ca = {
    ...
    }, L, ca, U, ha, X; ca = "#333333"; U = "#000000"; L = "#666666"; X = ha = "#000000"; var V = 20, E = 14, Xa = {
        colorSet: "colorSet1", backgroundColor: "#FFFFFF", title: { fontFamily: Ha, fontSize: 32, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Ha, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{
            indexLabelFontFamily: x, indexLabelFontSize: E,
            indexLabelFontColor: ca, indexLabelFontWeight: "normal", indexLabelLineThickness: 1
        }], axisX: [{
            titleFontFamily: x, titleFontSize: V, titleFontColor: ca, titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 0, gridColor: L, stripLines: [{ labelFontFamily: x, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
                labelFontFamily: x,
                labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: X, color: ha, thickness: 1, lineDashType: "dash"
            }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
        }], axisX2: [{
            titleFontFamily: x, titleFontSize: V, titleFontColor: ca, titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 0, gridColor: L, stripLines: [{
                labelFontFamily: x,
                labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1
            }], crosshair: { labelFontFamily: x, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: X, color: ha, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
        }], axisY: [{
            titleFontFamily: x, titleFontSize: V, titleFontColor: ca, titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E,
            labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 1, gridColor: L, stripLines: [{ labelFontFamily: x, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: { labelFontFamily: x, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: X, color: ha, thickness: 1, lineDashType: "dash" }, scaleBreaks: {
                type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1,
                lineDashType: "solid"
            }
        }], axisY2: [{
            titleFontFamily: x, titleFontSize: V, titleFontColor: ca, titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 1, gridColor: L, stripLines: [{ labelFontFamily: x, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
                labelFontFamily: x, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal",
                labelBackgroundColor: X, color: ha, thickness: 1, lineDashType: "dash"
            }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
        }], legend: { fontFamily: x, fontSize: 14, fontColor: ca, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: x, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1 }, toolbar: {
    ...
    }; U = ca = "#F5F5F5"; L = "#FFFFFF"; ha = "#40BAF1"; X = "#F5F5F5"; var V = 20, E = 14, cb = {
        colorSet: "colorSet2", title: { fontFamily: x, fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: x, fontSize: E, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{ indexLabelFontFamily: x, indexLabelFontSize: E, indexLabelFontColor: "#666666", indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
            titleFontFamily: x, titleFontSize: V,
            titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 1, lineColor: "#BBBBBB", tickThickness: 1, tickColor: "#BBBBBB", gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{ labelFontFamily: x, labelFontSize: E, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1 }], crosshair: {
                labelFontFamily: x, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black",
                color: "black", thickness: 1, lineDashType: "dot"
            }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
        }], axisX2: [{
            titleFontFamily: x, titleFontSize: V, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 1, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{
                labelFontFamily: x, labelFontSize: E, labelFontColor: "#FFA500",
                labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1
            }], crosshair: { labelFontFamily: x, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
        }], axisY: [{
            titleFontFamily: x, titleFontSize: V, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: "#666666",
            ...
            titleFontFamily: x, titleFontSize: V, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 0, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{ labelFontFamily: x, labelFontSize: E, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1 }], crosshair: {
                labelFontFamily: x,
        ...
        }], legend: { fontFamily: x, fontSize: 14, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: x, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1 }, toolbar: {
    ...
    }; U = ca = "#F5F5F5"; L = "#FFFFFF"; ha = "#40BAF1"; X = "#F5F5F5"; V = 20; E = 14; Ha = {
        colorSet: "colorSet12", backgroundColor: "#2A2A2A", title: { fontFamily: Ha, fontSize: 32, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Ha, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: {
        ...
        }, data: [{ indexLabelFontFamily: x, indexLabelFontSize: E, indexLabelFontColor: U, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
            titleFontFamily: x, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 0, gridColor: L, stripLines: [{
                labelFontFamily: x, labelFontSize: E, labelFontColor: "#FF7300",
                labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1
            }], crosshair: { labelFontFamily: x, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: X, color: ha, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
        }], axisX2: [{
            titleFontFamily: x, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal",
        ...
        axisY: [{
            titleFontFamily: x, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 1, gridColor: L, stripLines: [{ labelFontFamily: x, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
                labelFontFamily: x, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: X,
                color: ha, thickness: 1, lineDashType: "dash"
            }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
        }], axisY2: [{
            titleFontFamily: x, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 1, gridColor: L, stripLines: [{
                labelFontFamily: x, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null,
                color: "#FF7300", thickness: 1
            }], crosshair: { labelFontFamily: x, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: X, color: ha, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
        }], legend: { fontFamily: x, fontSize: 14, fontColor: ca, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: {
            fontFamily: x, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1,
            fontColor: U, backgroundColor: "rgba(0, 0, 0, .7)"
        }
    }; L = "#FFFFFF"; U = ca = "#FAFAFA"; ha = "#40BAF1"; X = "#F5F5F5"; var V = 20, E = 14, db = {
        light1: Xa, light2: cb, dark1: Ha, dark2: {
            colorSet: "colorSet2", backgroundColor: "#32373A", title: { fontFamily: x, fontSize: 32, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: x, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: {
                itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372",
                buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5"
            }, data: [{ indexLabelFontFamily: x, indexLabelFontSize: E, indexLabelFontColor: U, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
                titleFontFamily: x, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 0, gridColor: L, stripLines: [{
            ...
            axisY: [{
                ...
                titleFontFamily: x, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: x, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 0, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 1, gridColor: L, stripLines: [{
                    labelFontFamily: x, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null,
                    color: "#FF7300", thickness: 1
                }], crosshair: { labelFontFamily: x, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: X, color: ha, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
            }], legend: { fontFamily: x, fontSize: 14, fontColor: ca, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: {
    ...
    }, J = { numberDuration: 1, yearDuration: 314496E5, monthDuration: 2592E6, weekDuration: 6048E5, dayDuration: 864E5, hourDuration: 36E5, minuteDuration: 6E4, secondDuration: 1E3, millisecondDuration: 1, dayOfWeekFromInt: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ") }; (function () {
        Y.fSDec = function (h) { for (var l = "", v = 0; v < h.length; v++)l += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(v)); return l }; delete pa[Y.fSDec("Bi`su")][Y.fSDec("bsdehuIsdg")];
        Y.pro = { sCH: pa[Y.fSDec("Bi`su")][Y.fSDec("bsdehuIsdg")] }; Y._fTWm = function (h) {
            if ("undefined" === typeof Y.pro.sCH && !eb) try {
                var l, v = h[Y.fSDec("buy")]; v[Y.fSDec("udyuC`rdmhod")] = Y.fSDec("unq"); v[Y.fSDec("gnou")] = 11 + Y.fSDec("qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg"); l = h.height - 11; v[Y.fSDec("bmd`sSdbu")](0, l, v[Y.fSDec("ld`rtsdUdyu")](Y.fSDec("B`ow`rKR!Ush`m")).width, 11); v[Y.fSDec("ghmmRuxmd")] = h.backgroundColor; v[Y.fSDec("ghmmSdbu")](0, l, v[Y.fSDec("ld`rtsdUdyu")](Y.fSDec("B`ow`rKR!Ush`m")).width,
                    11); v[Y.fSDec("ghmmRuxmd")] = Y.fSDec("fsdx"); v[Y.fSDec("ghmmUdyu")](Y.fSDec("B`ow`rKR!Ush`m"), 0, l)
            } catch (r) { }
        }
    })(); var ib = function () { var h = !1; try { var l = Object.defineProperty && Object.defineProperty({}, "passive", { get: function () { h = !0; return !1 } }); window.addEventListener && (window.addEventListener("test", null, l), window.removeEventListener("test", null, l)) } catch (v) { h = !1 } return h }(), $a = {}, xa = null, nb = function () {
        this.ctx.clearRect(0, 0, this.width, this.height); this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor,
            this.ctx.fillRect(0, 0, this.width, this.height))
    }, za = function (h) { h.width = 1; h.height = 1; h.getContext("2d") && h.getContext("2d").clearRect(0, 0, 1, 1) }, ob = function (h, l, v) { l = Math.min(this.width, this.height); return Math.max("theme4" === this.theme ? 0 : 300 <= l ? 12 : 11, Math.round(l * (h / 400))) }, Da = function () {
        var h = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g, l = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), v = "Sun Mon Tue Wed Thu Fri Sat".split(" "),
        r = "January February March April May June July August September October November December".split(" "), w = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), x = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, D = /[^-+\dA-Z]/g; return function (E, I, P) {
            var L = P ? P.days : l, S = P ? P.months : r, K = P ? P.shortDays : v, J = P ? P.shortMonths : w; P = ""; var Y = !1; E = E && E.getTime ? E : E ? new Date(E) : new Date; if (isNaN(E)) throw SyntaxError("invalid date");
            "UTC:" === I.slice(0, 4) && (I = I.slice(4), Y = !0); P = Y ? "getUTC" : "get"; var T = E[P + "Date"](), O = E[P + "Day"](), $ = E[P + "Month"](), a = E[P + "FullYear"](), d = E[P + "Hours"](), c = E[P + "Minutes"](), b = E[P + "Seconds"](), e = E[P + "Milliseconds"](), f = Y ? 0 : E.getTimezoneOffset(); return P = I.replace(h, function (m) {
                switch (m) {
                    case "D": return T; case "DD": return W(T, 2); case "DDD": return K[O]; case "DDDD": return L[O]; case "M": return $ + 1; case "MM": return W($ + 1, 2); case "MMM": return J[$]; case "MMMM": return S[$]; case "Y": return parseInt(String(a).slice(-2));
                    case "YY": return W(String(a).slice(-2), 2); case "YYY": return W(String(a).slice(-3), 3); case "YYYY": return W(a, 4); case "h": return d % 12 || 12; case "hh": return W(d % 12 || 12, 2); case "H": return d; case "HH": return W(d, 2); case "m": return c; case "mm": return W(c, 2); case "s": return b; case "ss": return W(b, 2); case "f": return W(String(e), 3).slice(0, 1); case "ff": return W(String(e), 3).slice(0, 2); case "fff": return W(String(e), 3).slice(0, 3); case "t": return 12 > d ? "a" : "p"; case "tt": return 12 > d ? "am" : "pm"; case "T": return 12 >
                        d ? "A" : "P"; case "TT": return 12 > d ? "AM" : "PM"; case "K": return Y ? "UTC" : (String(E).match(x) || [""]).pop().replace(D, ""); case "z": return (0 < f ? "-" : "+") + Math.floor(Math.abs(f) / 60); case "zz": return (0 < f ? "-" : "+") + W(Math.floor(Math.abs(f) / 60), 2); case "zzz": return (0 < f ? "-" : "+") + W(Math.floor(Math.abs(f) / 60), 2) + W(Math.abs(f) % 60, 2); default: return m.slice(1, m.length - 1)
                }
            })
        }
    }(), pb = function (h) {
        var l = 0 > h; if (1 > Math.abs(h)) {
            var v = parseInt(h.toString().split("e-")[1]); v && (h = (l ? -1 * h : h) * Math.pow(10, v - 1), h = "0." + Array(v).join("0") +
                h.toString().substring(2), h = l ? "-" + h : h)
        } else v = parseInt(h.toString().split("+")[1]), 20 < v && (v -= 20, h /= Math.pow(10, v), h = h.toString() + Array(v + 1).join("0")); return String(h)
    }, da = function (h, l, v) {
        if (null === h) return ""; if (!isFinite(h)) return h; h = Number(h); var r = 0 > h ? !0 : !1; r && (h *= -1); var w = v ? v.decimalSeparator : ".", x = v ? v.digitGroupSeparator : ",", D = ""; l = String(l); var D = 1, E = v = "", I = -1, P = [], L = [], S = 0, K = 0, J = 0, Y = !1, T = 0, E = l.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g); l = null; for (var O = 0; E && O < E.length; O++)if (l =
            E[O], "." === l && 0 > I) I = O; else { if ("%" === l) D *= 100; else if ("\u2030" === l) { D *= 1E3; continue } else if ("," === l[0] && "." === l[l.length - 1]) { D /= Math.pow(1E3, l.length - 1); I = O + l.length - 1; continue } else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || (Y = !0); 0 > I ? (P.push(l), "#" === l || "0" === l ? S++ : "," === l && J++) : (L.push(l), "#" !== l && "0" !== l || K++) } Y && (l = Math.floor(h), E = -Math.floor(Math.log(h) / Math.LN10 + 1), T = 0 === h ? 0 : 0 === l ? -(S + E) : pb(l).length - S, D /= Math.pow(10, T)); 0 > I && (I = O); D = (h * D).toFixed(K); l = D.split("."); D = (l[0] + "").split(""); h =
                (l[1] + "").split(""); D && "0" === D[0] && D.shift(); for (Y = E = O = K = I = 0; 0 < P.length;)if (l = P.pop(), "#" === l || "0" === l) if (I++, I === S) { var $ = D, D = []; if ("0" === l) for (l = S - K - ($ ? $.length : 0); 0 < l;)$.unshift("0"), l--; for (; 0 < $.length;)v = $.pop() + v, Y++, 0 === Y % E && (O === J && 0 < $.length) && (v = x + v) } else 0 < D.length ? (v = D.pop() + v, K++, Y++) : "0" === l && (v = "0" + v, K++, Y++), 0 === Y % E && (O === J && 0 < D.length) && (v = x + v); else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (O++, E = Y, Y = 0, 0 < D.length && (v = x + v)) : v = 1 < l.length && ('"' ===
                    l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + v : l + v : (l = 0 > T ? l.replace("+", "").replace("-", "") : l.replace("-", ""), v += l.replace(/[0]+/, function (a) { return W(T, a.length) })); x = ""; for (P = !1; 0 < L.length;)l = L.shift(), "#" === l || "0" === l ? 0 < h.length && 0 !== Number(h.join("")) ? (x += h.shift(), P = !0) : "0" === l && (x += "0", P = !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? x += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ?
                        x += l : (l = 0 > T ? l.replace("+", "").replace("-", "") : l.replace("-", ""), x += l.replace(/[0]+/, function (a) { return W(T, a.length) })); v += (P ? w : "") + x; return r ? "-" + v : v
    }, Qa = function (h) { var l = 0, r = 0; h = h || window.event; h.offsetX || 0 === h.offsetX ? (l = h.offsetX, r = h.offsetY) : h.layerX || 0 == h.layerX ? (l = h.layerX, r = h.layerY) : (l = h.pageX - h.target.offsetLeft, r = h.pageY - h.target.offsetTop); return { x: l, y: r } }, bb = !0, Ta = window.devicePixelRatio || 1, Pa = 1, ka = bb ? Ta / Pa : 1, ea = function (h, l, r, w, x, E, D, I, S, P, L, Y, K) {
        "undefined" === typeof K && (K = 1); D = D ||
            0; I = I || "black"; var J = 15 < w - l && 15 < x - r ? 8 : 0.35 * Math.min(w - l, x - r); h.beginPath(); h.moveTo(l, r); h.save(); h.fillStyle = E; h.globalAlpha = K; h.fillRect(l, r, w - l, x - r); h.globalAlpha = 1; 0 < D && (K = 0 === D % 2 ? 0 : 0.5, h.beginPath(), h.lineWidth = D, h.strokeStyle = I, h.moveTo(l, r), h.rect(l - K, r - K, w - l + 2 * K, x - r + 2 * K), h.stroke()); h.restore(); !0 === S && (h.save(), h.beginPath(), h.moveTo(l, r), h.lineTo(l + J, r + J), h.lineTo(w - J, r + J), h.lineTo(w, r), h.closePath(), D = h.createLinearGradient((w + l) / 2, r + J, (w + l) / 2, r), D.addColorStop(0, E), D.addColorStop(1, "rgba(255, 255, 255, .4)"),
                h.fillStyle = D, h.fill(), h.restore()); !0 === P && (h.save(), h.beginPath(), h.moveTo(l, x), h.lineTo(l + J, x - J), h.lineTo(w - J, x - J), h.lineTo(w, x), h.closePath(), D = h.createLinearGradient((w + l) / 2, x - J, (w + l) / 2, x), D.addColorStop(0, E), D.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = D, h.fill(), h.restore()); !0 === L && (h.save(), h.beginPath(), h.moveTo(l, r), h.lineTo(l + J, r + J), h.lineTo(l + J, x - J), h.lineTo(l, x), h.closePath(), D = h.createLinearGradient(l + J, (x + r) / 2, l, (x + r) / 2), D.addColorStop(0, E), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
                    h.fillStyle = D, h.fill(), h.restore()); !0 === Y && (h.save(), h.beginPath(), h.moveTo(w, r), h.lineTo(w - J, r + J), h.lineTo(w - J, x - J), h.lineTo(w, x), D = h.createLinearGradient(w - J, (x + r) / 2, w, (x + r) / 2), D.addColorStop(0, E), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = D, D.addColorStop(0, E), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = D, h.fill(), h.closePath(), h.restore())
    }, ia = function (h) { for (var l = "", r = 0; r < h.length; r++)l += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r)); return l }, eb = window &&
        window[ia("mnb`uhno")] && window[ia("mnb`uhno")].href && window[ia("mnb`uhno")].href.indexOf && (-1 !== window[ia("mnb`uhno")].href.indexOf(ia("b`ow`rkr/bnl")) || -1 !== window[ia("mnb`uhno")].href.indexOf(ia("gdonqhy/bnl")) || -1 !== window[ia("mnb`uhno")].href.indexOf(ia("gheemd"))), lb = eb && -1 === window[ia("mnb`uhno")].href.indexOf(ia("gheemd")), mb = {
    ...
    Z.prototype.setOptions = function (h, l) { if (pa[this._defaultsKey]) { var r = pa[this._defaultsKey], w; for (w in r) "publicProperties" !== w && r.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : l && w in l ? l[w] : r[w]) } else Ja && window.console && console.log("defaults not set") }; Z.prototype.get = function (h) {
        var l = pa[this._defaultsKey]; if ("options" === h) return this.options && this.options._isPlaceholder ? null : this.options; if (l.hasOwnProperty(h) || l.publicProperties && l.publicProperties.hasOwnProperty(h)) return this[h]; window.console &&
            window.console.log('Property "' + h + "\" doesn't exist. Please check for typo.")
    }; Z.prototype.set = function (h, l, r) {
        r = "undefined" === typeof r ? !0 : r; var w = pa[this._defaultsKey]; if ("options" === h) this.createUserOptions(l); else if (w.hasOwnProperty(h) || w.publicProperties && w.publicProperties.hasOwnProperty(h) && "readWrite" === w.publicProperties[h]) this.options._isPlaceholder && this.createUserOptions(), this.options[h] = l; else {
    ...
    }; Z.prototype.remove = function (h) { h = "undefined" === typeof h ? !0 : h; if (this.isOptionsInArray) { var l = this.parent.options[this.optionsName]; Fa(l); var r = l.indexOf(this.options); 0 <= r && l.splice(r, 1) } else delete this.parent.options[this.optionsName]; h && (this.stockChart || this.chart || this).render() }; Z.prototype.updateOption = function (h) {
        !pa[this._defaultsKey] && (Ja && window.console) && console.log("defaults not set"); var l = pa[this._defaultsKey], w = {}, x = this[h], E = this._themeOptionsKey,
        ...
        h && l && (this._eventListeners[h] =
            this._eventListeners[h] || [], this._eventListeners[h].push({ context: r || this, eventHandler: l }))
    }; Z.prototype.removeEventListener = function (h, l) { if (h && l && this._eventListeners[h]) for (var r = this._eventListeners[h], w = 0; w < r.length; w++)if (r[w].eventHandler === l) { r[w].splice(w, 1); break } }; Z.prototype.removeAllEventListeners = function () { this._eventListeners = [] }; Z.prototype.dispatchEvent = function (h, l, r) {
        if (h && this._eventListeners[h]) {
            l = l || {}; for (var w = this._eventListeners[h], x = 0; x < w.length; x++)w[x].eventHandler.call(w[x].context,
                l)
        } "function" === typeof this[h] && this[h].call(r || this.chart, l)
    }; Ga.prototype.registerSpace = function (h, l) { "top" === h ? this._topOccupied += l.height : "bottom" === h ? this._bottomOccupied += l.height : "left" === h ? this._leftOccupied += l.width : "right" === h && (this._rightOccupied += l.width) }; Ga.prototype.unRegisterSpace = function (h, l) { "top" === h ? this._topOccupied -= l.height : "bottom" === h ? this._bottomOccupied -= l.height : "left" === h ? this._leftOccupied -= l.width : "right" === h && (this._rightOccupied -= l.width) }; Ga.prototype.getFreeSpace =
        function () { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied } }; Ga.prototype.reset = function () { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding }; oa(ja, Z); ja.prototype._initialize = function () {
            ...
            if (0 !== this.fontSize) {
                h && this.ctx.save(); var l = this.ctx.font; this.ctx.textBaseline = this.textBaseline; var r = 0; this._isDirty &&
                    this.measureText(this.ctx); this.ctx.translate(this.x, this.y + r); "middle" === this.textBaseline && (r = -this._lineHeight / 2); this.ctx.font = this._getFontString(); this.ctx.rotate(Math.PI / 180 * this.angle); var w = 0, x = this.topPadding, E = null; this.ctx.roundRect || Ea(this.ctx); (0 < this.borderThickness && this.borderColor || this.backgroundColor) && this.ctx.roundRect(0, r, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor, this.borderColor); this.ctx.fillStyle = this.fontColor; for (r = 0; r < this._wrappedText.lines.length; r++) {
                        E =
                        this._wrappedText.lines[r]; if ("right" === this.horizontalAlign || "right" === this.textAlign) w = this.width - E.width - this.rightPadding; else if ("left" === this.horizontalAlign || "left" === this.textAlign) w = this.leftPadding; else if ("center" === this.horizontalAlign || "center" === this.textAlign) w = (this.width - (this.leftPadding + this.rightPadding)) / 2 - E.width / 2 + this.leftPadding; this.ctx.fillText(E.text, w, x); x += E.height
                    } this.ctx.font = l; h && this.ctx.restore()
            }
        }; ja.prototype.setText = function (h) {
            this.text = h; this._isDirty = !0; this._wrappedText =
                null
        }; ja.prototype.measureText = function () { this._lineHeight = Za(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock"; this._wrapText(this.ctx); this._isDirty = !1; return { width: this.width, height: this.height } }; ja.prototype._getLineWithWidth = function (h, l, r) {
            h = String(h); if (!h) return { text: "", width: 0 }; var w = r = 0, x = h.length - 1, E = Infinity; for (this.ctx.font = this._getFontString(); w <= x;) {
                var E = Math.floor((w + x) / 2), D = h.substr(0, E + 1); r = this.ctx.measureText(D).width;
                if (r < l) w = E + 1; else if (r > l) x = E - 1; else break
            } r > l && 1 < D.length && (D = D.substr(0, D.length - 1), r = this.ctx.measureText(D).width); l = !0; if (D.length === h.length || " " === h[D.length]) l = !1; l && (h = D.split(" "), 1 < h.length && h.pop(), D = h.join(" "), r = this.ctx.measureText(D).width); return { text: D, width: r }
        }; ja.prototype._wrapText = function () {
            var h = new String(Ia(String(this.text))), l = [], r = this.ctx.font, w = 0, x = 0; this.ctx.font = this._getFontString(); if (0 === this.frontSize) x = w = 0; else for (; 0 < h.length;) {
                var E = this.maxHeight - (this.topPadding +
                    this.bottomPadding), D = this._getLineWithWidth(h, this.maxWidth - (this.leftPadding + this.rightPadding), !1); D.height = this._lineHeight; l.push(D); var I = x, x = Math.max(x, D.width), w = w + D.height, h = Ia(h.slice(D.text.length, h.length)); E && w > E && (D = l.pop(), w -= D.height, x = I)
            } this._wrappedText = { lines: l, width: x, height: w }; this.width = x + (this.leftPadding + this.rightPadding); this.height = w + (this.topPadding + this.bottomPadding); this.ctx.font = r
        }; ja.prototype._getFontString = function () {
            var h; h = "" + (this.fontStyle ? this.fontStyle + " " :
                ""); h += this.fontWeight ? this.fontWeight + " " : ""; h += this.fontSize ? this.fontSize + "px " : ""; var l = this.fontFamily ? this.fontFamily + "" : ""; !w && l && (l = l.split(",")[0], "'" !== l[0] && '"' !== l[0] && (l = "'" + l + "'")); return h += l
        }; oa(Va, Z); oa(Ba, Z); Ba.prototype.setLayout = function () {
            if (this.text) {
                var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, l = h.layoutManager.getFreeSpace(), w = l.x1, x = l.y1, E = 0, I = 0, D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, J, K; "top" === this.verticalAlign ||
                    "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = l.width - 4 - D * ("center" === this.horizontalAlign ? 2 : 1)), I = 0.5 * l.height - this.margin - 2, E = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = l.height - 4), I = 0.5 * l.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = l.width - 4), I = 0.5 * l.height - 4)); var P; r(this.padding) || "number" !== typeof this.padding ? r(this.padding) || "object" !==
                        typeof this.padding || (P = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, P += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : P = 2 * this.padding; this.wrap || (I = Math.min(I, 1.5 * this.fontSize + P)); I = new ja(this.ctx, {
                            ...
                            borderThickness: this.borderThickness, backgroundColor: this.backgroundColor, maxWidth: this.maxWidth, maxHeight: I, cornerRadius: this.cornerRadius, text: this.text, padding: this.padding, textBaseline: "top"
                        }); P = I.measureText(); "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (x = l.y1 + 2, K = "top") : "bottom" === this.verticalAlign && (x = l.y2 - 2 - P.height, K = "bottom"), "left" === this.horizontalAlign ? w = l.x1 + 2 : "center" === this.horizontalAlign ? w = l.x1 + l.width / 2 - P.width / 2 : "right" === this.horizontalAlign &&
                            (w = l.x2 - 2 - P.width - D), J = this.horizontalAlign, this.width = P.width, this.height = P.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (w = l.x1 + 2, x = l.y2 - 2 - (this.maxWidth / 2 - P.width / 2), E = -90, K = "left", this.width = P.height, this.height = P.width) : "right" === this.horizontalAlign ? (w = l.x2 - 2, x = l.y1 + 2 + (this.maxWidth / 2 - P.width / 2), E = 90, K = "right", this.width = P.height, this.height = P.width) : "center" === this.horizontalAlign && (x = h.y1 + (h.height / 2 - P.height / 2), w = h.x1 + (h.width / 2 - P.width / 2), K = "center", this.width = P.width,
                                this.height = P.height), J = "center"); I.x = w; I.y = x; I.angle = E; I.horizontalAlign = J; this._textBlock = I; h.layoutManager.registerSpace(K, { width: this.width + ("left" === K || "right" === K ? this.margin + 2 : 0), height: this.height + ("top" === K || "bottom" === K ? this.margin + 2 : 0) }); this.bounds = { x1: w, y1: x, x2: w + this.width, y2: x + this.height }; this.ctx.textBaseline = "top"
            }
        }; Ba.prototype.render = function () { this._textBlock && this._textBlock.render(!0) }; oa(Ka, Z); Ka.prototype.setLayout = Ba.prototype.setLayout; Ka.prototype.render = Ba.prototype.render;
    Wa.prototype.get = function (h, l) { var r = null; 0 < this.pool.length ? (r = this.pool.pop(), Oa(r, h, l)) : r = ta(h, l); return r }; Wa.prototype.release = function (h) { this.pool.push(h) }; oa(La, Z); var Ra = {
        addTheme: function (h, l) { db[h] = l }, addColorSet: function (h, l) { Ca[h] = l }, addCultureInfo: function (h, l) { Ma[h] = l }, formatNumber: function (h, l, r) { r = r || "en"; if (Ma[r]) return da(h, l || "#,##0.##", new La(r)); throw "Unknown Culture Name"; }, formatDate: function (h, l, r) {
            r = r || "en"; if (Ma[r]) return Da(h, l || "DD MMM YYYY", new La(r)); throw "Unknown Culture Name";
        }
    }; "undefined" !== typeof module && "undefined" !== typeof module.exports ? module.exports = Ra : "function" === typeof define && define.amd ? define([], function () { return Ra }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Ra); x = Ra.Chart = function () {
        function h(a, d) { return a.x - d.x } function l(a, d, c) {
            d = d || {}; r(c) ?
                                    ...
                                    this.overlaidCanvasCtx.textBaseline = "top", Ea(this.overlaidCanvasCtx)), this._eventManager = new ha(this), this.windowResizeHandler = K(window, "resize", function () { b._updateSize() && b.render() }, this.allDOMEventHandlers), this._toolBar = document.createElement("div"), this._toolBar.setAttribute("class", "canvasjs-chart-toolbar"), T(this._toolBar, { position: "absolute", right: "1px", top: "1px" }), this._canvasJSContainer.appendChild(this._toolBar), this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }, K(this.overlaidCanvas,
                                        "click", function (a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, "mousemove", function (a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, "mouseup", function (a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, "mousedown", function (a) { b._mouseEventHandler(a); va(b._dropdownMenu) }, this.allDOMEventHandlers), K(this.overlaidCanvas, "mouseout", function (a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, window.navigator.msPointerEnabled ?
                                            "MSPointerDown" : "touchstart", function (a) { b._touchEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerMove" : "touchmove", function (a) { b._touchEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerUp" : "touchend", function (a) { b._touchEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerCancel" : "touchcancel", function (a) { b._touchEventHandler(a) },
                                                this.allDOMEventHandlers), this.toolTip = new W(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = { axisX: [], axisX2: [], axisY: [], axisY2: [] })) : window.console && window.console.log('CanvasJS Error: Chart Container with id "' + this._containerId + '" was not found')
        } function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)if (0 == e) c.push(a[0]); else {
                var f, m, u; u = e - 1; f = 0 === u ? 0 : u - 1; m = u === a.length - 1 ? u : u + 1; b = Math.abs((a[m].x - a[f].x) / (0 === a[m].x - a[u].x ? 0.01 :
                    a[m].x - a[u].x)) * (d - 1) / 2 + 1; var C = (a[m].x - a[f].x) / b; b = (a[m].y - a[f].y) / b; c[c.length] = a[u].x > a[f].x && 0 < C || a[u].x < a[f].x && 0 > C ? { x: a[u].x + C / 3, y: a[u].y + b / 3 } : { x: a[u].x, y: a[u].y + b / 9 }; u = e; f = 0 === u ? 0 : u - 1; m = u === a.length - 1 ? u : u + 1; b = Math.abs((a[m].x - a[f].x) / (0 === a[u].x - a[f].x ? 0.01 : a[u].x - a[f].x)) * (d - 1) / 2 + 1; C = (a[m].x - a[f].x) / b; b = (a[m].y - a[f].y) / b; c[c.length] = a[u].x > a[f].x && 0 < C || a[u].x < a[f].x && 0 > C ? { x: a[u].x - C / 3, y: a[u].y - b / 3 } : { x: a[u].x, y: a[u].y - b / 9 }; c[c.length] = a[e]
            } return c
        ...
        } function ha(a) { this.chart = a; this.lastObjectId = 0; this.objectMap = []; this.rectangularRegionEventSubscriptions = []; this.previousDataPointEventObject = null; this.ghostCanvas = ta(this.chart.width, this.chart.height, !0); this.ghostCtx = this.ghostCanvas.getContext("2d"); this.mouseoveredObjectMaps = [] } function X(a) {
            this.chart = a; this.ctx = this.chart.plotArea.ctx;
            this.animations = []; this.animationRequestId = null
        } oa(l, Z); l.prototype.destroy = function () {
            ...
            for (; this.container && this.container.hasChildNodes();)this.container.removeChild(this.container.lastChild); for (; this._dropdownMenu && this._dropdownMenu.hasChildNodes();)this._dropdownMenu.removeChild(this._dropdownMenu.lastChild); this.container = this._canvasJSContainer = null; this.toolTip.container = null; this.canvas && za(this.canvas); this.overlaidCanvas && za(this.overlaidCanvas); this._preRenderCanvas && za(this._preRenderCanvas); this._breaksCanvas && za(this._breaksCanvas); this._eventManager && this._eventManager.ghostCanvas &&
                za(this._eventManager.ghostCanvas); this._toolBar = this._dropdownMenu = this._menuButton = this._resetButton = this._zoomButton = null
            ...
            var a = this; this.updateOption("width"); this.updateOption("height"); this.updateOption("dataPointWidth"); this.updateOption("dataPointMinWidth"); this.updateOption("dataPointMaxWidth"); this.updateOption("interactivityEnabled"); this.updateOption("theme"); this.updateOption("colorSet") && (this.selectedColorSet = "undefined" !== typeof Ca[this.colorSet] ?
                Ca[this.colorSet] : Ca.colorSet1); this.updateOption("backgroundColor"); this.backgroundColor || (this.backgroundColor = "rgba(0,0,0,0)"); this.updateOption("culture"); this._cultureInfo = new La(this.options.culture); this.updateOption("animationEnabled"); this.animationEnabled = this.animationEnabled && w; this.updateOption("animationDuration"); this.updateOption("rangeChanging"); this.updateOption("rangeChanged"); this.updateOption("exportEnabled"); this.updateOption("exportFileName"); this.updateOption("zoomType"); this.toolbar =
                    new Va(this, this.options.toolbar); if (this.options.zoomEnabled || this.panEnabled) {
                        if (this._zoomButton) T(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), ra(this, this._zoomButton, "zoom"); else {
                            var d = !1; va(this._zoomButton = document.createElement("button")); ra(this, this._zoomButton, "pan"); this._toolBar.appendChild(this._zoomButton); this._zoomButton.style.borderRight = this.toolbar.buttonBorderThickness +
                                "px solid " + this.toolbar.buttonBorderColor; K(this._zoomButton, "touchstart", function (a) { d = !0 }, this.allDOMEventHandlers); K(this._zoomButton, "click", function () { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, ra(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, ra(a, a._zoomButton, "pan")); a.render() }, this.allDOMEventHandlers); K(this._zoomButton, "mousemove", function () {
                                    d ? d = !1 : (T(a._zoomButton, {
                                        backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s",
                                        WebkitTransition: "0.4s"
                                    }), 0 >= navigator.userAgent.search("MSIE") && T(a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }))
                                }, this.allDOMEventHandlers); K(this._zoomButton, "mouseout", function () { d || (T(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && T(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, this.allDOMEventHandlers)
                        } this._resetButton ?
                            (T(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), this._resetButton.title = this._cultureInfo.resetText) : (d = !1, va(this._resetButton = document.createElement("button")), ra(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton),
                                K(this._resetButton, "touchstart", function (a) { d = !0 }, this.allDOMEventHandlers), K(this._resetButton, "click", function () {
                                    a.toolTip.hide(); a.toolTip && a.toolTip.enabled && a.toolTip.dispatchEvent("hidden", { chart: a, toolTip: a.toolTip }, a.toolTip); a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, ra(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled = !1); if (a.sessionVariables.axisX) for (var b = 0; b < a.sessionVariables.axisX.length; b++)a.sessionVariables.axisX[b].newViewportMinimum =
                                    ...
                                    }), 0 >= navigator.userAgent.search("MSIE") && T(a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }))
                                }, this.allDOMEventHandlers), K(this._resetButton, "mouseout", function () { d || (T(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && T(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, this.allDOMEventHandlers),
                    ...
                    } else this.panEnabled = this.zoomEnabled = !1; jb(this); "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? ra(a, a._zoomButton, "zoom") : ra(a, a._zoomButton, "pan"),
                        a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && ra(a, a._resetButton, "reset")); this.options.toolTip && this.toolTip.options !== this.options.toolTip && (this.toolTip.options = this.options.toolTip); for (var c in this.toolTip.options) this.toolTip.options.hasOwnProperty(c) && this.toolTip.updateOption(c)
        }; l.prototype._updateSize = function () {
            var a; a = [this.canvas, this.overlaidCanvas, this._eventManager.ghostCanvas]; var d = 0, c = 0; this.options.width ? d = this.width : this.width = d = 0 < this.container.clientWidth ?
            ...
            this.isNavigator = r(this.parent) || r(this.parent._defaultsKey) || "Navigator" !== this.parent._defaultsKey ?
                !1 : !0; this._animator ? this._animator.cancelAllAnimations() : this._animator = new X(this); this.removeAllEventListeners(); this.disableToolTip = !1; this._axes = []; this.funnelPyramidClickHandler = this.pieDoughnutClickHandler = null; this._updateOptions(); this.animatedRender = w && this.animationEnabled && 0 === this.renderCount; this._updateSize(); this.clearCanvas(); this.ctx.beginPath(); this.axisX = []; this.axisX2 = []; this.axisY = []; this.axisY2 = []; this._indexLabels = []; this._dataInRenderedOrder = []; this._events = []; this._eventManager &&
                    this._eventManager.reset(); this.plotInfo = { axisPlacement: null, plotTypes: [] }; this.layoutManager = new Ga(0, 0, this.width, this.height, this.isNavigator ? 0 : 2); this.plotArea.layoutManager && this.plotArea.layoutManager.reset(); this.data = []; this.title = null; this.subtitles = []; var a = 0, d = null; if (this.options.data) {
        ...
        l.prototype.setLayout = function () {
            ...
            var a = this._plotAreaElements; this.title && !this.title.dockInsidePlotArea && this.title.render(); for (var d = 0; d < this.subtitles.length; d++)this.subtitles[d].dockInsidePlotArea || this.subtitles[d].render(); this.legend.dockInsidePlotArea ||
                this.legend.render(); if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) D.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return; for (d = 0; d < a.length; d++)a[d].setLayout(), a[d].render(); var c = []; if (this.animatedRender) { var b = ta(this.width, this.height); b.getContext("2d").drawImage(this.canvas, 0, 0, this.width, this.height) } kb(this); var a = this.ctx.miterLimit, e; this.ctx.miterLimit =
                    3; w && this._breaksCanvas && (this._preRenderCtx.drawImage(this.canvas, 0, 0, this.width, this.height), this._preRenderCtx.drawImage(this._breaksCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx.globalCompositeOperation = "source-atop", this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), this._preRenderCtx.clearRect(0, 0, this.width, this.height)); for (d = 0; d < this.plotInfo.plotTypes.length; d++)for (var f = this.plotInfo.plotTypes[d], m = 0; m < f.plotUnits.length; m++) {
                        var u = f.plotUnits[m],
                        C = null; u.targetCanvas && za(u.targetCanvas); u.targetCanvas = null; this.animatedRender && (u.targetCanvas = ta(this.width, this.height), u.targetCanvasCtx = u.targetCanvas.getContext("2d"), e = u.targetCanvasCtx.miterLimit, u.targetCanvasCtx.miterLimit = 3); "line" === u.type ? C = this.renderLine(u) : "stepLine" === u.type ? C = this.renderStepLine(u) : "spline" === u.type ? C = this.renderSpline(u) : "column" === u.type ? C = this.renderColumn(u) : "bar" === u.type ? C = this.renderBar(u) : "area" === u.type ? C = this.renderArea(u) : "stepArea" === u.type ? C = this.renderStepArea(u) :
                            "splineArea" === u.type ? C = this.renderSplineArea(u) : "stackedColumn" === u.type ? C = this.renderStackedColumn(u) : "stackedColumn100" === u.type ? C = this.renderStackedColumn100(u) : "stackedBar" === u.type ? C = this.renderStackedBar(u) : "stackedBar100" === u.type ? C = this.renderStackedBar100(u) : "stackedArea" === u.type ? C = this.renderStackedArea(u) : "stackedArea100" === u.type ? C = this.renderStackedArea100(u) : "bubble" === u.type ? C = C = this.renderBubble(u) : "scatter" === u.type ? C = this.renderScatter(u) : "pie" === u.type ? this.renderPie(u) : "doughnut" ===
                                u.type ? this.renderPie(u) : "funnel" === u.type ? C = this.renderFunnel(u) : "pyramid" === u.type ? C = this.renderFunnel(u) : "candlestick" === u.type ? C = this.renderCandlestick(u) : "ohlc" === u.type ? C = this.renderCandlestick(u) : "rangeColumn" === u.type ? C = this.renderRangeColumn(u) : "error" === u.type ? C = this.renderError(u) : "rangeBar" === u.type ? C = this.renderRangeBar(u) : "rangeArea" === u.type ? C = this.renderRangeArea(u) : "rangeSplineArea" === u.type ? C = this.renderRangeSplineArea(u) : "waterfall" === u.type ? C = this.renderWaterfall(u) : "boxAndWhisker" ===
                                    u.type && (C = this.renderBoxAndWhisker(u)); for (var k = 0; k < u.dataSeriesIndexes.length; k++)this._dataInRenderedOrder.push(this.data[u.dataSeriesIndexes[k]]); this.animatedRender && (u.targetCanvasCtx.miterLimit = e, C && c.push(C))
                    } this.ctx.miterLimit = a; this.animatedRender && this._breaksCanvasCtx && c.push({ source: this._breaksCanvasCtx, dest: this.plotArea.ctx, animationCallback: O.fadeInAnimation, easingFunction: O.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 }); this.animatedRender && 0 < this._indexLabels.length &&
                        (e = ta(this.width, this.height).getContext("2d"), c.push(this.renderIndexLabels(e))); var n = this; if (0 < c.length) n.disableToolTip = !0, n._animator.animate(200, n.animationDuration, function (a) {
                        ...
                        }, function () { c = []; for (var a = 0; a < n.plotInfo.plotTypes.length; a++)for (var e = n.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) { var f = e.plotUnits[d]; f.targetCanvas && za(f.targetCanvas); f.targetCanvas = null } b = null; n.disableToolTip = !1; n.dispatchEvent("dataAnimationEnd", { chart: n }) }); else {
            ...
            } this.attachPlotAreaEventHandlers(); this.zoomEnabled || (this.panEnabled || !this._zoomButton || "none" === this._zoomButton.style.display) || va(this._zoomButton, this._resetButton); this.toolTip._updateToolTip(); this.renderCount++; Ja && (n = this, setTimeout(function () {
                var a = document.getElementById("ghostCanvasCopy"); a && (Oa(a, n.width, n.height), a.getContext("2d").drawImage(n._eventManager.ghostCanvas,
                    0, 0))
            ...
            for (var a = "", d = 0; d < this.data.length; d++)if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= l._supportedChartTypes.indexOf(a.type)) {
                for (var c = null, b = !1, e = null, f = !1, m = 0; m < this.plotInfo.plotTypes.length; m++)if (this.plotInfo.plotTypes[m].type === a.type) { b = !0; c = this.plotInfo.plotTypes[m]; break } b || (c = {
                    type: a.type, totalDataSeries: 0,
                    plotUnits: []
                }, this.plotInfo.plotTypes.push(c)); for (m = 0; m < c.plotUnits.length; m++)if (c.plotUnits[m].axisYType === a.axisYType && c.plotUnits[m].axisXType === a.axisXType && c.plotUnits[m].axisYIndex === a.axisYIndex && c.plotUnits[m].axisXIndex === a.axisXIndex) { f = !0; e = c.plotUnits[m]; break } f || (e = {
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                C = 0, k = !1, n = !1, p; if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : a.axisX.logarithmic ? 0 : -Infinity, g = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : a.axisX.options && a.axisX.options.viewportMaximum ? a.axisX.options.viewportMaximum :
                    a.axisX.options && a.axisX.options.maximum ? a.axisX.options.maximum : Infinity; if (u.dataPoints[C].x && u.dataPoints[C].x.getTime || "dateTime" === u.xValueType) f = !0; for (C = 0; C < u.dataPoints.length; C++) {
                        "undefined" === typeof u.dataPoints[C].x && (u.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0)); u.dataPoints[C].x.getTime ? (f = !0, b = u.dataPoints[C].x.getTime()) : b = u.dataPoints[C].x; e = u.dataPoints[C].y; b < c.min && (c.min = b); b > c.max && (c.max = b); e < d.min && "number" === typeof e && (d.min = e); e > d.max && "number" === typeof e && (d.max = e); if (0 <
                            C) { if (a.axisX.logarithmic) { var s = b / u.dataPoints[C - 1].x; 1 > s && (s = 1 / s); c.minDiff > s && 1 !== s && (c.minDiff = s) } else s = b - u.dataPoints[C - 1].x, 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s); null !== e && null !== u.dataPoints[C - 1].y && (a.axisY.logarithmic ? (s = e / u.dataPoints[C - 1].y, 1 > s && (s = 1 / s), d.minDiff > s && 1 !== s && (d.minDiff = s)) : (s = e - u.dataPoints[C - 1].y, 0 > s && (s *= -1), d.minDiff > s && 0 !== s && (d.minDiff = s))) } if (b < q && !k) null !== e && (p = b); else {
                                if (!k && (k = !0, 0 < C)) { C -= 2; continue } if (b > g && !n) n = !0; else if (b > g && n) continue; u.dataPoints[C].label &&
                                    (a.axisX.labels[b] = u.dataPoints[C].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin === b && p < b && (c.viewPortMin = p) : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e), e > d.viewPortMax && "number" === typeof e && (d.viewPortMax = e))
                            }
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = [], u = [],
                    C = Infinity, k = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                        var p = this.data[a.dataSeriesIndexes[n]], q = 0, g = !1, s = !1, h; if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var Aa = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : -Infinity, t = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum :
                            a.axisX.options && a.axisX.options.viewportMaximum ? a.axisX.options.viewportMaximum : a.axisX.options && a.axisX.options.maximum ? a.axisX.options.maximum : Infinity; if (p.dataPoints[q].x && p.dataPoints[q].x.getTime || "dateTime" === p.xValueType) f = !0; for (q = 0; q < p.dataPoints.length; q++) {
                                "undefined" === typeof p.dataPoints[q].x && (p.dataPoints[q].x = q + (a.axisX.logarithmic ? 1 : 0)); p.dataPoints[q].x.getTime ? (f = !0, b = p.dataPoints[q].x.getTime()) : b = p.dataPoints[q].x; e = r(p.dataPoints[q].y) ? 0 : p.dataPoints[q].y; b < c.min && (c.min = b);
                                b > c.max && (c.max = b); if (0 < q) { if (a.axisX.logarithmic) { var l = b / p.dataPoints[q - 1].x; 1 > l && (l = 1 / l); c.minDiff > l && 1 !== l && (c.minDiff = l) } else l = b - p.dataPoints[q - 1].x, 0 > l && (l *= -1), c.minDiff > l && 0 !== l && (c.minDiff = l); null !== e && null !== p.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (l = e / p.dataPoints[q - 1].y, 1 > l && (l = 1 / l), d.minDiff > l && 1 !== l && (d.minDiff = l)) : (l = e - p.dataPoints[q - 1].y, 0 > l && (l *= -1), d.minDiff > l && 0 !== l && (d.minDiff = l))) } if (b < Aa && !g) null !== p.dataPoints[q].y && (h = b); else {
                                    if (!g && (g = !0, 0 < q)) { q -= 2; continue } if (b > t &&
                                        !s) s = !0; else if (b > t && s) continue; p.dataPoints[q].label && (a.axisX.labels[b] = p.dataPoints[q].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === p.dataPoints[q].y ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? m[b] ? m[b] += e : (m[b] = e, C = Math.min(e, C)) : u[b] ? u[b] += e : (u[b] = e, k = Math.max(e, k)))
                                }
                            } a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) &&
                                (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, m), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, u)) : (d.dataPointYPositiveSums = m, d.dataPointYNegativeSums = u)); p.axisX.valueType = p.xValueType = f ? "dateTime" : "number"
                } for (q in m) m.hasOwnProperty(q) && !isNaN(q) && (a = m[q], a < d.min && (d.min = Math.min(a, C)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, C)), a > d.viewPortMax && (d.viewPortMax = a))); for (q in u) u.hasOwnProperty(q) &&
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = !1, u = !1, C = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var n = this.data[a.dataSeriesIndexes[k]], p = 0, q = !1, g = !1, s; if ("normal" === n.axisPlacement || "xySwapped" ===
                        n.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : -Infinity, l = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : a.axisX.options && a.axisX.options.viewportMaximum ? a.axisX.options.viewportMaximum : a.axisX.options && a.axisX.options.maximum ? a.axisX.options.maximum :
                            Infinity; if (n.dataPoints[p].x && n.dataPoints[p].x.getTime || "dateTime" === n.xValueType) f = !0; for (p = 0; p < n.dataPoints.length; p++) {
                                "undefined" === typeof n.dataPoints[p].x && (n.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0)); n.dataPoints[p].x.getTime ? (f = !0, b = n.dataPoints[p].x.getTime()) : b = n.dataPoints[p].x; e = r(n.dataPoints[p].y) ? null : n.dataPoints[p].y; b < c.min && (c.min = b); b > c.max && (c.max = b); if (0 < p) {
                                    if (a.axisX.logarithmic) { var t = b / n.dataPoints[p - 1].x; 1 > t && (t = 1 / t); c.minDiff > t && 1 !== t && (c.minDiff = t) } else t = b - n.dataPoints[p -
                                        1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t); r(e) || null === n.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < e && (t = e / n.dataPoints[p - 1].y, 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - n.dataPoints[p - 1].y, 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)))
                                } if (b < h && !q) null !== e && (s = b); else {
                                    if (!q && (q = !0, 0 < p)) { p -= 2; continue } if (b > l && !g) g = !0; else if (b > l && g) continue; n.dataPoints[p].label && (a.axisX.labels[b] = n.dataPoints[p].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null ===
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo,
                c = a.axisX.dataInfo, b, e, f, m, u = !1, C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var k = this.data[a.dataSeriesIndexes[C]], n = 0, p = !1, q = !1, g, s, h; if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var l = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : a.axisX.logarithmic ? 0 : -Infinity, t = a.axisX.sessionVariables.newViewportMaximum ?
                        a.axisX.sessionVariables.newViewportMaximum : a.axisX.options && a.axisX.options.viewportMaximum ? a.axisX.options.viewportMaximum : a.axisX.options && a.axisX.options.maximum ? a.axisX.options.maximum : Infinity; if (k.dataPoints[n].x && k.dataPoints[n].x.getTime || "dateTime" === k.xValueType) u = !0; for (n = 0; n < k.dataPoints.length; n++) {
                            "undefined" === typeof k.dataPoints[n].x && (k.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0)); k.dataPoints[n].x.getTime ? (u = !0, b = k.dataPoints[n].x.getTime()) : b = k.dataPoints[n].x; if ((e = k.dataPoints[n].y) &&
                                e.length) { f = Math.min.apply(null, e); m = Math.max.apply(null, e); s = !0; for (var r = 0; r < e.length; r++)null === e.k && (s = !1); s && (p || (h = g), g = b) } b < c.min && (c.min = b); b > c.max && (c.max = b); f < d.min && (d.min = f); m > d.max && (d.max = m); 0 < n && (a.axisX.logarithmic ? (s = b / k.dataPoints[n - 1].x, 1 > s && (s = 1 / s), c.minDiff > s && 1 !== s && (c.minDiff = s)) : (s = b - k.dataPoints[n - 1].x, 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s)), e && (null !== e[0] && k.dataPoints[n - 1].y && null !== k.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (s = e[0] / k.dataPoints[n - 1].y[0], 1 >
                                    s && (s = 1 / s), d.minDiff > s && 1 !== s && (d.minDiff = s)) : (s = e[0] - k.dataPoints[n - 1].y[0], 0 > s && (s *= -1), d.minDiff > s && 0 !== s && (d.minDiff = s)))); if (!(b < l) || p) {
                                        if (!p && (p = !0, 0 < n)) { n -= 2; g = h; continue } if (b > t && !q) q = !0; else if (b > t && q) continue; k.dataPoints[n].label && (a.axisX.labels[b] = k.dataPoints[n].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); if (c.viewPortMin === b && e) for (r = 0; r < e.length; r++)if (null === e[r] && g < b) { c.viewPortMin = g; break } null === e ? c.viewPortMin === b && g < b && (c.viewPortMin = g) : (f < d.viewPortMin &&
            ...
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = 0; m < a.dataSeriesIndexes.length; m++) {
                var u = this.data[a.dataSeriesIndexes[m]], C = 0, k = !1, n = !1, p = b = 0; if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ?
                            ...
                            0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum, u.dataPoints[C].y = 0 === C ? 0 : b, p = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum, b = 0) : (e = "number" !== typeof u.dataPoints[C].y ? 0 : u.dataPoints[C].y, u.dataPointEOs[C].cumulativeSumYStartValue = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum, u.dataPointEOs[C].cumulativeSum = 0 === C ? e : u.dataPointEOs[C - 1].cumulativeSum + e, b += e); for (C = 0; C < u.dataPoints.length; C++)if ("undefined" === typeof u.dataPoints[C].x && (u.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0)), u.dataPoints[C].x.getTime ? (f = !0,
                                b = u.dataPoints[C].x.getTime()) : b = u.dataPoints[C].x, e = u.dataPoints[C].y, b < c.min && (c.min = b), b > c.max && (c.max = b), u.dataPointEOs[C].cumulativeSum < d.min && (d.min = u.dataPointEOs[C].cumulativeSum), u.dataPointEOs[C].cumulativeSum > d.max && (d.max = u.dataPointEOs[C].cumulativeSum), 0 < C && (a.axisX.logarithmic ? (p = b / u.dataPoints[C - 1].x, 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - u.dataPoints[C - 1].x, 0 > p && (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)), null !== e && null !== u.dataPoints[C - 1].y && (a.axisY.logarithmic ? (e =
                                    u.dataPointEOs[C].cumulativeSum / u.dataPointEOs[C - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = u.dataPointEOs[C].cumulativeSum - u.dataPointEOs[C - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || k) {
                                        if (!k && (k = !0, 0 < C)) { C -= 2; continue } if (b > g && !n) n = !0; else if (b > g && n) continue; u.dataPoints[C].label && (a.axisX.labels[b] = u.dataPoints[C].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); 0 < C && (u.dataPointEOs[C - 1].cumulativeSum < d.viewPortMin &&
                                            (d.viewPortMin = u.dataPointEOs[C - 1].cumulativeSum), u.dataPointEOs[C - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = u.dataPointEOs[C - 1].cumulativeSum)); u.dataPointEOs[C].cumulativeSum < d.viewPortMin && (d.viewPortMin = u.dataPointEOs[C].cumulativeSum); u.dataPointEOs[C].cumulativeSum > d.viewPortMax && (d.viewPortMax = u.dataPointEOs[C].cumulativeSum)
                            } u.axisX.valueType = u.xValueType = f ? "dateTime" : "number"
            }
        }; l.prototype.calculateAutoBreaks = function () {
            function a(a, b, c, e) {
                if (e) return c = Math.pow(Math.min(c * a / b, b / a),
                    0.2), 1 >= c && (c = Math.pow(1 > a ? 1 / a : Math.min(b / a, a), 0.25)), { startValue: a * c, endValue: b / c }; c = 0.2 * Math.min(c - b + a, b - a); 0 >= c && (c = 0.25 * Math.min(b - a, Math.abs(a))); return { startValue: a + c, endValue: b - c }
            } function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    var b = a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks, c = a.axisY.scaleBreaks && a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks; if (b || c) for (var d = a.axisY.dataInfo,
                        f = a.axisX.dataInfo, g, m = f.min, k = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, u = 0, C = 0; C < a.dataSeriesIndexes.length; C++) {
                            var h = e.data[a.dataSeriesIndexes[C]]; if (!(4 > h.dataPoints.length)) for (u = 0; u < h.dataPoints.length; u++)if (b && (q = (k + 1 - m) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[u].x.getTime ? h.dataPoints[u].x.getTime() : h.dataPoints[u].x, q = Math.floor((g - m) / q), g < f[q].min && (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                                var l = (p + 1 - n) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) ||
                                    10, 10) / 100; if ((g = "waterfall" === a.type ? h.dataPointEOs[u].cumulativeSum : h.dataPoints[u].y) && g.length) for (var w = 0; w < g.length; w++)q = Math.floor((g[w] - n) / l), g[w] < d[q].min && (d[q].min = g[w]), g[w] > d[q].max && (d[q].max = g[w]); else r(g) || (q = Math.floor((g - n) / l), g < d[q].min && (d[q].min = g), g > d[q].max && (d[q].max = g))
                            }
                    }
                }
            } function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c =
                    b.min, d = b.max, f = b._dataRanges, g, m = 0, k = 0; k < a.dataSeriesIndexes.length; k++) { var n = e.data[a.dataSeriesIndexes[k]]; if (!(4 > n.dataPoints.length)) for (m = 0; m < n.dataPoints.length; m++)g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = n.dataPoints[m].x.getTime ? n.dataPoints[m].x.getTime() : n.dataPoints[m].x, g = Math.floor((b - c) / g), b < f[g].min && (f[g].min = b), b > f[g].max && (f[g].max = b) }
            } for (var b, e = this, f = !1, m = 0; m < this._axes.length; m++)if (this._axes[m].scaleBreaks && this._axes[m].scaleBreaks.autoCalculate &&
                1 <= this._axes[m].scaleBreaks.maxNumberOfAutoBreaks) { f = !0; this._axes[m].dataInfo._dataRanges = []; for (var u = 0; u < 100 / Math.max(parseFloat(this._axes[m].scaleBreaks.collapsibleThreshold) || 10, 10); u++)this._axes[m].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity }) } if (f) {
                    for (m = 0; m < this.plotInfo.plotTypes.length; m++)for (f = this.plotInfo.plotTypes[m], u = 0; u < f.plotUnits.length; u++)b = f.plotUnits[u], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type ||
                        "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b); for (m = 0; m < this._axes.length; m++)if (this._axes[m].dataInfo._dataRanges) {
                            var C = this._axes[m].dataInfo.min; b = (this._axes[m].dataInfo.max + 1 - C) * Math.max(parseFloat(this._axes[m].scaleBreaks.collapsibleThreshold) ||
                                10, 10) / 100; var k = this._axes[m].dataInfo._dataRanges, n, p, f = []; if (this._axes[m].dataInfo.dataPointYPositiveSums) { var q = this._axes[m].dataInfo.dataPointYPositiveSums; n = k; for (u in q) if (q.hasOwnProperty(u) && !isNaN(u) && (p = q[u], !r(p))) { var g = Math.floor((p - C) / b); p < n[g].min && (n[g].min = p); p > n[g].max && (n[g].max = p) } delete this._axes[m].dataInfo.dataPointYPositiveSums } if (this._axes[m].dataInfo.dataPointYNegativeSums) {
                                    q = this._axes[m].dataInfo.dataPointYNegativeSums; n = k; for (u in q) q.hasOwnProperty(u) && !isNaN(u) &&
                                        (p = -1 * q[u], r(p) || (g = Math.floor((p - C) / b), p < n[g].min && (n[g].min = p), p > n[g].max && (n[g].max = p))); delete this._axes[m].dataInfo.dataPointYNegativeSums
                                } for (u = 0; u < k.length - 1; u++)if (n = k[u].max, isFinite(n)) for (; u < k.length - 1;)if (C = k[u + 1].min, isFinite(C)) { p = C - n; p > b && f.push({ diff: p, start: n, end: C }); break } else u++; if (this._axes[m].scaleBreaks.customBreaks) for (u = 0; u < this._axes[m].scaleBreaks.customBreaks.length; u++)for (b = 0; b < f.length; b++)if (this._axes[m].scaleBreaks.customBreaks[u].startValue <= f[b].start && f[b].start <=
                                    this._axes[m].scaleBreaks.customBreaks[u].endValue || this._axes[m].scaleBreaks.customBreaks[u].startValue <= f[b].start && f[b].start <= this._axes[m].scaleBreaks.customBreaks[u].endValue || f[b].start <= this._axes[m].scaleBreaks.customBreaks[u].startValue && this._axes[m].scaleBreaks.customBreaks[u].startValue <= f[b].end || f[b].start <= this._axes[m].scaleBreaks.customBreaks[u].endValue && this._axes[m].scaleBreaks.customBreaks[u].endValue <= f[b].end) f.splice(b, 1), b--; f.sort(function (a, b) { return b.diff - a.diff }); for (u =
                                        0; u < Math.min(f.length, this._axes[m].scaleBreaks.maxNumberOfAutoBreaks); u++)b = a(f[u].start, f[u].end, this._axes[m].logarithmic ? this._axes[m].dataInfo.max / this._axes[m].dataInfo.min : this._axes[m].dataInfo.max - this._axes[m].dataInfo.min, this._axes[m].logarithmic), this._axes[m].scaleBreaks.autoBreaks.push(new V(this, "autoBreaks", b, u, ++this._eventManager.lastObjectId, this._axes[m].scaleBreaks)), this._axes[m].scaleBreaks._appliedBreaks.push(this._axes[m].scaleBreaks.autoBreaks[this._axes[m].scaleBreaks.autoBreaks.length -
                                            1]); this._axes[m].scaleBreaks._appliedBreaks.sort(function (a, b) { return a.startValue - b.startValue })
                        }
                }
            ...
            }; l.prototype.getObjectAtXY = function (a, d, c) { var b = null; if (c = this.getDataPointAtXY(a, d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (w) b = ab(a, d, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) { var e = this.legend.items[c]; a >= e.x1 && (a <= e.x2 && d >= e.y1 && d <= e.y2) && (b = e.id) } return b }; l.prototype.getAutoFontSize = ob; l.prototype.resetOverlayedCanvas =
                function () { this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height) }; l.prototype.clearCanvas = nb; l.prototype.attachEvent = function (a) { this._events.push(a) }; l.prototype._touchEventHandler = function (a) {
                    if (a.changedTouches && this.interactivityEnabled) {
                        var d = [], c = a.changedTouches, b = c ? c[0] : a, e = null; switch (a.type) {
                            case "touchstart": case "MSPointerDown": d = ["mousemove", "mousedown"]; this._lastTouchData = Qa(b); this._lastTouchData.time = new Date; break; case "touchmove": case "MSPointerMove": d = ["mousemove"]; break;
                            ...
                            e = Qa(b); e.time = new Date; try { var m = e.y - this._lastTouchData.y, f = e.time - this._lastTouchData.time; if (1 < Math.abs(m) && this._lastTouchData.scroll || 5 < Math.abs(m) && 250 > f) this._lastTouchData.scroll = !0 } catch (u) { } this._lastTouchEventType =
        ...
        l.prototype._dispatchRangeEvent = function (a, d) {
            ...
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                var c = d - this.dragStartPoint.y, b = a - this.dragStartPoint.x, e = 0 <= this.zoomType.indexOf("x"), f = 0 <= this.zoomType.indexOf("y"), m = !1; this.resetOverlayedCanvas(); if ("xySwapped" === this.plotInfo.axisPlacement) var u = f, f = e, e = u; if (this.panEnabled || this.zoomEnabled) {
                ...
                this.resetOverlayedCanvas(); if (this.axisX && 0 < this.axisX.length) for (m = 0; m < this.axisX.length; m++)this.axisX[m].crosshair && this.axisX[m].crosshair.enabled && this.axisX[m].renderCrosshair(a, d); if (this.axisX2 && 0 < this.axisX2.length) for (m = 0; m < this.axisX2.length; m++)this.axisX2[m].crosshair && this.axisX2[m].crosshair.enabled && this.axisX2[m].renderCrosshair(a, d); if (this.axisY && 0 < this.axisY.length) for (m = 0; m < this.axisY.length; m++)this.axisY[m].crosshair &&
                    this.axisY[m].crosshair.enabled && this.axisY[m].renderCrosshair(a, d); if (this.axisY2 && 0 < this.axisY2.length) for (m = 0; m < this.axisY2.length; m++)this.axisY2[m].crosshair && this.axisY2[m].crosshair.enabled && this.axisY2[m].renderCrosshair(a, d); if (this.axisX && 0 < this.axisX.length) for (m = 0; m < this.axisX.length; m++)this.axisX[m].crosshair && this.axisX[m].crosshair.enabled && this.axisX[m].crosshair.renderLabel(); if (this.axisX2 && 0 < this.axisX2.length) for (m = 0; m < this.axisX2.length; m++)this.axisX2[m].crosshair && this.axisX2[m].crosshair.enabled &&
                        this.axisX2[m].crosshair.renderLabel(); if (this.axisY && 0 < this.axisY.length) for (m = 0; m < this.axisY.length; m++)this.axisY[m].crosshair && this.axisY[m].crosshair.enabled && this.axisY[m].crosshair.renderLabel(); if (this.axisY2 && 0 < this.axisY2.length) for (m = 0; m < this.axisY2.length; m++)this.axisY2[m].crosshair && this.axisY2[m].crosshair.enabled && this.axisY2[m].crosshair.renderLabel()
            }
        }; l.prototype._plotAreaMouseMove = function (a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                var c = 0, b = 0, e = c = null, e = 0 <= this.zoomType.indexOf("x"),
                f = 0 <= this.zoomType.indexOf("y"), m = this; "xySwapped" === this.plotInfo.axisPlacement && (c = f, f = e, e = c); c = this.dragStartPoint.x - a; b = this.dragStartPoint.y - d; if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                    this.toolTip.hide(); this.toolTip && this.toolTip.enabled && this.toolTip.dispatchEvent("hidden", { chart: this, toolTip: this.toolTip }, this.toolTip); for (var u = 0; u < this.axisX.length; u++)this.axisX[u].crosshair && this.axisX[u].crosshair.enabled && (this.axisX[u].crosshair.hide(), this.axisX[u].crosshair.dispatchEvent("hidden",
                        { chart: this, axis: this.axisX[u].options }, this.axisX[u].crosshair)); for (u = 0; u < this.axisX2.length; u++)this.axisX2[u].crosshair && this.axisX2[u].crosshair.enabled && (this.axisX2[u].crosshair.hide(), this.axisX2[u].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisX2[u].options }, this.axisX2[u].crosshair)); for (u = 0; u < this.axisY.length; u++)this.axisY[u].crosshair && this.axisY[u].crosshair.enabled && (this.axisY[u].crosshair.hide(), this.axisY[u].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisY[u].options },
                            this.axisY[u].crosshair)); for (u = 0; u < this.axisY2.length; u++)this.axisY2[u].crosshair && this.axisY2[u].crosshair.enabled && (this.axisY2[u].crosshair.hide(), this.axisY2[u].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisY2[u].options }, this.axisY2[u].crosshair))
            ...
            e = e || !1; for (var f = 0 <= this.zoomType.indexOf("x"), m = 0 <= this.zoomType.indexOf("y"), u = !1, C = [], k = [], n = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type &&
                f || "axisY" === this._axes[p].type && m) && k.push(this._axes[p]); for (m = 0; m < k.length; m++) {
                    var p = k[m], f = !1, q = p.convertPixelToValue({ x: a, y: d }), g = p.convertPixelToValue({ x: c, y: b }); if (q > g) var s = g, g = q, q = s; if (p.scaleBreaks) for (s = 0; !f && s < p.scaleBreaks._appliedBreaks.length; s++)f = p.scaleBreaks._appliedBreaks[s].startValue <= q && p.scaleBreaks._appliedBreaks[s].endValue >= g; if (isFinite(p.dataInfo.minDiff)) if (s = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                        (p.logarithmic && s < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && s < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) C.push(p), n.push({ val1: q, val2: g }), u = !0; else if (!e) { u = !1; break }
            ...
            } else d = this.layoutManager.getFreeSpace(), a.x1 = d.x1, a.x2 = d.x2, a.y1 = d.y1, a.y2 = d.y2, a.width = d.width, a.height = d.height; w || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left = a.x1 + "px", a.canvas.style.top = a.y1 + "px", (0 < a.x1 || 0 < a.y1) && a.ctx.translate(-a.x1, -a.y1)); a.layoutManager = new Ga(a.x1, a.y1, a.x2, a.y2, 2)
        }; l.prototype.renderIndexLabels = function (a) {
            var d = a || this.plotArea.ctx, c = this.plotArea,
            b = 0, e = 0, f = 0, m = f = e = 0, u = 0, C = b = 0, k = 0; for (a = 0; a < this._indexLabels.length; a++) {
                var n = this._indexLabels[a], p = n.chartType.toLowerCase(), q, g, m = la("indexLabelFontColor", n.dataPoint, n.dataSeries), s = la("indexLabelFontSize", n.dataPoint, n.dataSeries), u = la("indexLabelFontFamily", n.dataPoint, n.dataSeries), C = la("indexLabelFontStyle", n.dataPoint, n.dataSeries), k = la("indexLabelFontWeight", n.dataPoint, n.dataSeries), h = la("indexLabelBackgroundColor", n.dataPoint, n.dataSeries); q = la("indexLabelMaxWidth", n.dataPoint, n.dataSeries);
                g = la("indexLabelWrap", n.dataPoint, n.dataSeries); var l = la("indexLabelLineDashType", n.dataPoint, n.dataSeries), t = la("indexLabelLineColor", n.dataPoint, n.dataSeries), A = r(n.dataPoint.indexLabelLineThickness) ? r(n.dataSeries.options.indexLabelLineThickness) ? 0 : n.dataSeries.options.indexLabelLineThickness : n.dataPoint.indexLabelLineThickness, b = 0 < A ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, y = { percent: null, total: null }, z = null; if (0 <= n.dataSeries.type.indexOf("stacked") ||
                    "pie" === n.dataSeries.type || "doughnut" === n.dataSeries.type) y = this.getPercentAndTotal(n.dataSeries, n.dataPoint); if (n.dataSeries.indexLabelFormatter || n.dataPoint.indexLabelFormatter) z = { chart: this, dataSeries: n.dataSeries, dataPoint: n.dataPoint, index: n.indexKeyword, total: y.total, percent: y.percent }; var F = n.dataPoint.indexLabelFormatter ? n.dataPoint.indexLabelFormatter(z) : n.dataPoint.indexLabel ? this.replaceKeywordsWithValue(n.dataPoint.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : n.dataSeries.indexLabelFormatter ?
                        n.dataSeries.indexLabelFormatter(z) : n.dataSeries.indexLabel ? this.replaceKeywordsWithValue(n.dataSeries.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : null; if (null !== F && "" !== F) {
                            var y = la("indexLabelPlacement", n.dataPoint, n.dataSeries), z = la("indexLabelOrientation", n.dataPoint, n.dataSeries), B = la("indexLabelTextAlign", n.dataPoint, n.dataSeries), v = n.direction, e = n.dataSeries.axisX, f = n.dataSeries.axisY, x = !1, h = new ja(d, {
                                x: 0, y: 0, maxWidth: q ? q : 0.5 * this.width, maxHeight: g ? 5 * s : 1.5 * s, angle: "horizontal" ===
                                    z ? 0 : -90, text: F, padding: 0, backgroundColor: h, textAlign: B, fontSize: s, fontFamily: u, fontWeight: k, fontColor: m, fontStyle: C, textBaseline: "middle"
            ...
            } d = { source: d, dest: this.plotArea.ctx, animationCallback: O.fadeInAnimation, easingFunction: O.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 }; for (a = 0; a < this._indexLabels.length; a++)n = this._indexLabels[a], h = la("indexLabelBackgroundColor", n.dataPoint, n.dataSeries), n.dataSeries.indexLabelBackgroundColor = r(h) ? w ? "transparent" : null : h; return d
        }; l.prototype.renderLine = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx :
                d; if (!(0 >= a.dataSeriesIndexes.length)) {
                    var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], m, u = 0; u < a.dataSeriesIndexes.length; u++) {
                        var C = a.dataSeriesIndexes[u], k = this.data[C]; c.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (c.setLineDash) { var q = I(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType, g = I(p, k.lineThickness); c.setLineDash(g) } var s = k.id; this._eventManager.objectMap[s] = {
                            objectType: "dataSeries",
                            dataSeriesIndex: C
                        }; s = S(s); b.strokeStyle = s; b.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0; var s = k._colorSet, h = s = k.lineColor = k.options.lineColor ? k.options.lineColor : s[0]; c.strokeStyle = s; var l = !0, t = 0, r, y; c.beginPath(); if (0 < n.length) {
                            for (var z = !1, t = 0; t < n.length; t++)if (r = n[t].x.getTime ? n[t].x.getTime() : n[t].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z))) if ("number" !== typeof n[t].y) 0 < t && !(k.connectNullData || z || l) && (c.stroke(), w && b.stroke()), z =
                                !0; else {
                                    r = a.axisX.convertValueToPixel(r); y = a.axisY.convertValueToPixel(n[t].y); var F = k.dataPointIds[t]; this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: t, x1: r, y1: y }; l || z ? (!l && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(m.x, m.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(r, y), w && b.lineTo(r, y)) : (c.beginPath(), c.moveTo(r, y), w && (b.beginPath(),
                                        b.moveTo(r, y))), z = l = !1) : (c.lineTo(r, y), w && b.lineTo(r, y), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(r, y), w && (b.stroke(), b.beginPath(), b.moveTo(r, y)))); m = { x: r, y: y }; t < n.length - 1 && (h !== (n[t].lineColor || s) || p !== (n[t].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(r, y), h = n[t].lineColor || s, c.strokeStyle = h, c.setLineDash && (n[t].lineDashType ? (p = n[t].lineDashType, c.setLineDash(I(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g)))); if (0 !== n[t].markerSize && (0 < n[t].markerSize || 0 < k.markerSize)) {
                                            var B =
                                                k.getMarkerProperties(t, r, y, c); f.push(B); F = S(F); w && f.push({ x: r, y: y, ctx: b, type: B.type, size: B.size, color: F, borderColor: F, borderThickness: B.borderThickness })
                                        } (n[t].indexLabel || k.indexLabel || n[t].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: n[t], dataSeries: k, point: { x: r, y: y }, direction: 0 > n[t].y === a.axisY.reversed ? 1 : -1, color: s })
                            } c.stroke(); w && b.stroke()
                        }
                    } $.drawMarkers(f); w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation =
            ...
            function (a) {
                var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                    var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], m, u = 0; u < a.dataSeriesIndexes.length; u++) {
                        var C = a.dataSeriesIndexes[u], k = this.data[C]; c.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (c.setLineDash) { var q = I(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType, g = I(p, k.lineThickness); c.setLineDash(g) } var s =
                            k.id; this._eventManager.objectMap[s] = { objectType: "dataSeries", dataSeriesIndex: C }; s = S(s); b.strokeStyle = s; b.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0; var s = k._colorSet, h = s = k.lineColor = k.options.lineColor ? k.options.lineColor : s[0]; c.strokeStyle = s; var l = !0, t = 0, r, y; c.beginPath(); if (0 < n.length) {
                                for (var z = !1, t = 0; t < n.length; t++)if (r = n[t].getTime ? n[t].x.getTime() : n[t].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z))) if ("number" !== typeof n[t].y) 0 <
                                    t && !(k.connectNullData || z || l) && (c.stroke(), w && b.stroke()), z = !0; else {
                                        var F = y; r = a.axisX.convertValueToPixel(r); y = a.axisY.convertValueToPixel(n[t].y); var B = k.dataPointIds[t]; this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: t, x1: r, y1: y }; l || z ? (!l && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(m.x, m.y), p = k.nullDataLineDashType, c.setLineDash(q)),
                ...
                function d(a) {
                    a = v(a, 2); if (0 < a.length) {
                        b.beginPath(); w && e.beginPath(); b.moveTo(a[0].x, a[0].y); a[0].newStrokeStyle && (b.strokeStyle = a[0].newStrokeStyle); a[0].newLineDashArray && b.setLineDash(a[0].newLineDashArray); w && e.moveTo(a[0].x, a[0].y); for (var c = 0; c < a.length - 3; c += 3)if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
                    ...
                    var e =
                        this._eventManager.ghostCtx; b.save(); var f = this.plotArea; b.beginPath(); b.rect(f.x1, f.y1, f.width, f.height); b.clip(); for (var m = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
                            var C = a.dataSeriesIndexes[u], k = this.data[C]; b.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (b.setLineDash) { var q = I(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType, g = I(p, k.lineThickness); b.setLineDash(g) } var s = k.id; this._eventManager.objectMap[s] = { objectType: "dataSeries", dataSeriesIndex: C }; s = S(s); e.strokeStyle = s; e.lineWidth =
                                0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0; var s = k._colorSet, h = s = k.lineColor = k.options.lineColor ? k.options.lineColor : s[0]; b.strokeStyle = s; var l = 0, t, r, y = []; b.beginPath(); if (0 < n.length) for (r = !1, l = 0; l < n.length; l++)if (t = n[l].getTime ? n[l].x.getTime() : n[l].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !r))) if ("number" !== typeof n[l].y) 0 < l && !r && (k.connectNullData ? b.setLineDash && (0 < y.length && (k.options.nullDataLineDashType || !n[l - 1].lineDashType)) && (y[y.length -
                                    1].newLineDashArray = q, p = k.nullDataLineDashType) : (d(y), y = [])), r = !0; else {
                                        t = a.axisX.convertValueToPixel(t); r = a.axisY.convertValueToPixel(n[l].y); var z = k.dataPointIds[l]; this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: l, x1: t, y1: r }; y[y.length] = { x: t, y: r }; l < n.length - 1 && (h !== (n[l].lineColor || s) || p !== (n[l].lineDashType || k.lineDashType)) && (h = n[l].lineColor || s, y[y.length - 1].newStrokeStyle = h, b.setLineDash && (n[l].lineDashType ? (p = n[l].lineDashType, y[y.length - 1].newLineDashArray =
                                            I(p, k.lineThickness)) : (p = k.lineDashType, y[y.length - 1].newLineDashArray = g))); if (0 !== n[l].markerSize && (0 < n[l].markerSize || 0 < k.markerSize)) { var F = k.getMarkerProperties(l, t, r, b); m.push(F); z = S(z); w && m.push({ x: t, y: r, ctx: e, type: F.type, size: F.size, color: z, borderColor: z, borderThickness: F.borderThickness }) } (n[l].indexLabel || k.indexLabel || n[l].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                                chartType: "spline", dataPoint: n[l], dataSeries: k, point: { x: t, y: r }, direction: 0 > n[l].y === a.axisY.reversed ?
                                                    1 : -1, color: s
                                            }); r = !1
                                } d(y)
                            ...
                            source: c,
                            dest: this.plotArea.ctx, animationCallback: O.xClipAnimation, easingFunction: O.easing.linear, animationBase: 0
                        }
                }
            }; l.prototype.renderColumn = function (a) {
                var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                    var b = null, e = this.plotArea, f = 0, m, u, C, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, n = this.options.dataPointMaxWidth ?
                        this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff; isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range)); p = this.dataPointWidth = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > n && (f = Math.min(this.options.dataPointWidth ?
                            this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < f) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); p < f && (p = f); p > n && (p = n); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                                ...
                                g = this.data[q], s = g.dataPoints; if (0 < s.length) for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)if (s[f].getTime ? C = s[f].x.getTime() : C = s[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y) {
                                    m = a.axisX.convertValueToPixel(C); u = a.axisY.convertValueToPixel(s[f].y); m = a.axisX.reversed ? m + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : m - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + n) * p << 0; var l = a.axisX.reversed ? m - p << 0 : m + p << 0, t;
                                    0 <= s[f].y ? t = k : (t = u, u = k); u > t && (b = u, u = t, t = b); b = s[f].color ? s[f].color : g._colorSet[f % g._colorSet.length]; ea(c, a.axisX.reversed ? l : m, u, a.axisX.reversed ? m : l, t, b, 0, null, h && (a.axisY.reversed ? 0 > s[f].y : 0 <= s[f].y), (a.axisY.reversed ? 0 <= s[f].y : 0 > s[f].y) && h, !1, !1, g.fillOpacity); b = g.dataPointIds[f]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: m, y1: u, x2: l, y2: t }; b = S(b); w && ea(this._eventManager.ghostCtx, a.axisX.reversed ? l : m, u, a.axisX.reversed ? m : l, t, b, 0, null, !1, !1,
                                        !1, !1); (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "column", dataPoint: s[f], dataSeries: g, point: { x: m + (l - m) / 2, y: 0 > s[f].y === a.axisY.reversed ? u : t }, direction: 0 > s[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: m, y1: Math.min(u, t), x2: l, y2: Math.max(u, t) }, color: b })
                                }
                ...
                function (a) {
                    var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                            var h = a.dataSeriesIndexes[g], l = this.data[h], t = l.dataPoints; if (0 < t.length) {
                                var r = 5 < s && l.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (k = 0; k < t.length; k++)if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                    "number" === typeof t[k].y) {
                                        n = a.axisX.convertValueToPixel(b); n = n - a.plotType.plotUnits.length * s / 2 + a.index * s << 0; var y = n + s << 0, z; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) u[b] = t[k].y + (u[b] ? u[b] : 0), 0 < u[b] && (p = a.axisY.convertValueToPixel(u[b]), z = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) C[b] = t[k].y + (C[b] ? C[b] : 0), z = a.axisY.convertValueToPixel(C[b]), p = "undefined" !== typeof m[b] ?
                                            m[b] : q, m[b] = z; else if (p = a.axisY.convertValueToPixel(t[k].y), 0 <= t[k].y) { var F = "undefined" !== typeof f[b] ? f[b] : 0; p -= F; z = q - F; f[b] = F + (z - p) } else F = m[b] ? m[b] : 0, z = p + F, p = q + F, m[b] = F + (z - p); b = t[k].color ? t[k].color : l._colorSet[k % l._colorSet.length]; ea(c, n, a.axisY.reversed ? z : p, y, a.axisY.reversed ? p : z, b, 0, null, r && (a.axisY.reversed ? 0 > t[k].y : 0 <= t[k].y), (a.axisY.reversed ? 0 <= t[k].y : 0 > t[k].y) && r, !1, !1, l.fillOpacity); b = l.dataPointIds[k]; this._eventManager.objectMap[b] = {
                                                id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k,
                                                x1: n, y1: p, x2: y, y2: z
                                            }; b = S(b); w && ea(this._eventManager.ghostCtx, n, p, y, z, b, 0, null, !1, !1, !1, !1); (t[k].indexLabel || l.indexLabel || t[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: t[k], dataSeries: l, point: { x: n + (y - n) / 2, y: 0 <= t[k].y ? p : z }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: n, y1: Math.min(p, z), x2: y, y2: Math.max(p, z) }, color: b })
                                }
                            }
                            ...
                            a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return {
                                source: d, dest: this.plotArea.ctx, animationCallback: O.yScaleAnimation, easingFunction: O.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 :
                    ...
                    var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                        var b = null, e = this.plotArea, f = [], m = [], u = [], C = [], k = 0, n, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, g = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ?
                            this.dataPointWidth : 0.15 * this.width << 0, s = a.axisX.dataInfo.minDiff; isFinite(s) || (s = 0.3 * Math.abs(a.axisX.range)); s = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(s) / Math.log(a.axisX.range) : Math.abs(s) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && k > g && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, g)); !this.dataPointMaxWidth && (this.dataPointMinWidth && g < k) && (g = Math.max(this.options.dataPointWidth ? this.dataPointWidth :
                                -Infinity, k)); s < k && (s = k); s > g && (s = g); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                                    var h = a.dataSeriesIndexes[g], l = this.data[h], t = l.dataPoints; if (0 < t.length) for (var r = 5 < s && l.bevelEnabled ? !0 : !1, k = 0; k < t.length; k++)if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                        b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                            n = a.axisX.convertValueToPixel(b); p = 0 !== a.dataPointYSums[b] ? 100 * (t[k].y / a.dataPointYSums[b]) : 0; n = n - a.plotType.plotUnits.length * s / 2 + a.index * s << 0; var y = n + s << 0, z; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) { u[b] = p + ("undefined" !== typeof u[b] ? u[b] : 0); if (0 >= u[b]) continue; p = a.axisY.convertValueToPixel(u[b]); z = f[b] ? f[b] : q; f[b] = p } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                                                0 >= t[k].y) C[b] = p + ("undefined" !== typeof C[b] ? C[b] : 0), z = a.axisY.convertValueToPixel(C[b]), p = m[b] ? m[b] : q, m[b] = z; else if (p = a.axisY.convertValueToPixel(p), 0 <= t[k].y) { var F = "undefined" !== typeof f[b] ? f[b] : 0; p -= F; z = q - F; a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y1 - p) && (p = e.y1); f[b] = F + (z - p) } else F = "undefined" !== typeof m[b] ? m[b] : 0, z = p + F, p = q + F, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y2 - z) && (z = e.y2), m[b] = F + (z - p); b = t[k].color ? t[k].color : l._colorSet[k % l._colorSet.length]; ea(c, n, a.axisY.reversed ? z :
                                                    p, y, a.axisY.reversed ? p : z, b, 0, null, r && (a.axisY.reversed ? 0 > t[k].y : 0 <= t[k].y), (a.axisY.reversed ? 0 <= t[k].y : 0 > t[k].y) && r, !1, !1, l.fillOpacity); b = l.dataPointIds[k]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: n, y1: p, x2: y, y2: z }; b = S(b); w && ea(this._eventManager.ghostCtx, n, p, y, z, b, 0, null, !1, !1, !1, !1); (t[k].indexLabel || l.indexLabel || t[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                                        chartType: "stackedColumn100", dataPoint: t[k], dataSeries: l,
                                                        point: { x: n + (y - n) / 2, y: 0 <= t[k].y ? p : z }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: n, y1: Math.min(p, z), x2: y, y2: Math.max(p, z) }, color: b
                                                    })
                                    }
                                } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
                                    c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: O.yScaleAnimation, easingFunction: O.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q }
                    }
                            ...
                            a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff; isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range)); p = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) :
                                Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > n && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < f) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); p < f && (p = f); p > n && (p = n); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1,
                                    e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                                        var q = a.dataSeriesIndexes[n], g = this.data[q], s = g.dataPoints; if (0 < s.length) {
                                            var h = 5 < p && g.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (f = 0; f < s.length; f++)if (s[f].getTime ? C = s[f].x.getTime() : C = s[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y) {
                                                u = a.axisX.convertValueToPixel(C); m = a.axisY.convertValueToPixel(s[f].y); u = a.axisX.reversed ? u + a.plotType.totalDataSeries *
                                        ...
                                        0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return {
                                            source: d, dest: this.plotArea.ctx, animationCallback: O.xScaleAnimation, easingFunction: O.easing.easeOutQuart, animationBase: k < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : k > a.axisY.bounds.x2 ? a.axisY.bounds.x2 :
                                                k
                                        }
                    }
                    ...
                    var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                        var b = null, e = this.plotArea, f = [], m = [], u = [], C = [], k = 0, n, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, g = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.height <<
                            0, s = a.axisX.dataInfo.minDiff; isFinite(s) || (s = 0.3 * Math.abs(a.axisX.range)); s = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(s) / Math.log(a.axisX.range) : Math.abs(s) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && k > g && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, g)); !this.dataPointMaxWidth && (this.dataPointMinWidth && g < k) && (g = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k)); s < k &&
                                (s = k); s > g && (s = g); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                                    var h = a.dataSeriesIndexes[g], l = this.data[h], t = l.dataPoints; if (0 < t.length) {
                                        var r = 5 < s && l.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (k = 0; k < t.length; k++)if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x,
                                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                                p = a.axisX.convertValueToPixel(b); p = p - a.plotType.plotUnits.length * s / 2 + a.index * s << 0; var y = p + s << 0, z; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) u[b] = t[k].y + (u[b] ? u[b] : 0), 0 < u[b] && (z = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(u[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) C[b] = t[k].y + (C[b] ? C[b] : 0), n = m[b] ? m[b] :
                                                    q, m[b] = z = a.axisY.convertValueToPixel(C[b]); else if (n = a.axisY.convertValueToPixel(t[k].y), 0 <= t[k].y) { var F = f[b] ? f[b] : 0; z = q + F; n += F; f[b] = F + (n - z) } else F = m[b] ? m[b] : 0, z = n - F, n = q - F, m[b] = F + (n - z); b = t[k].color ? t[k].color : l._colorSet[k % l._colorSet.length]; ea(c, a.axisY.reversed ? n : z, p, a.axisY.reversed ? z : n, y, b, 0, null, r, !1, !1, !1, l.fillOpacity); b = l.dataPointIds[k]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: z, y1: p, x2: n, y2: y }; b = S(b); w && ea(this._eventManager.ghostCtx,
                                                        z, p, n, y, b, 0, null, !1, !1, !1, !1); (t[k].indexLabel || l.indexLabel || t[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: t[k], dataSeries: l, point: { x: 0 <= t[k].y ? n : z, y: p + (y - p) / 2 }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(z, n), y1: p, x2: Math.max(z, n), y2: y }, color: b })
                                        }
                                    }
                    ...
                    function (a) {
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            ...
                            isFinite(s) || (s = 0.3 * Math.abs(a.axisX.range)); s = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(s) / Math.log(a.axisX.range) : Math.abs(s) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && k > g && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, g)); !this.dataPointMaxWidth && (this.dataPointMinWidth && g < k) && (g = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k)); s < k && (s = k); s > g && (s = g); c.save(); w &&
                                this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                                    var h = a.dataSeriesIndexes[g], l = this.data[h], t = l.dataPoints; if (0 < t.length) {
                                        var r = 5 < s && l.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (k = 0; k < t.length; k++)if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                            b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                                p = a.axisX.convertValueToPixel(b); var y; y = 0 !== a.dataPointYSums[b] ? 100 * (t[k].y / a.dataPointYSums[b]) : 0; p = p - a.plotType.plotUnits.length * s / 2 + a.index * s << 0; var z = p + s << 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) { u[b] = y + (u[b] ? u[b] : 0); if (0 >= u[b]) continue; y = f[b] ? f[b] : q; f[b] = n = a.axisY.convertValueToPixel(u[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) C[b] =
                                            ...
                                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: y, y1: p, x2: n, y2: z }; b = S(b); w && ea(this._eventManager.ghostCtx, y, p, n, z, b, 0, null, !1, !1, !1, !1); (t[k].indexLabel || l.indexLabel || t[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: t[k], dataSeries: l, point: { x: 0 <= t[k].y ? n : y, y: p + (z - p) / 2 }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(y, n), y1: p, x2: Math.max(y, n), y2: z }, color: b })
                                        }
                                    }
                                } w && (d.drawImage(this._preRenderCanvas,
                                    0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return {
                                        source: d, dest: this.plotArea.ctx, animationCallback: O.xScaleAnimation, easingFunction: O.easing.easeOutQuart,
                        ...
                        var d, c; function b() {
                            F && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = y : 0 > a.axisY.viewportMaximum ? z = u.y1 : 0 < a.axisY.viewportMinimum && (z = y), f.lineTo(l, z), f.lineTo(F.x, z), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (m.lineTo(l, z), m.lineTo(F.x, z), m.closePath(), m.fill()), f.beginPath(), f.moveTo(l,
                                t), m.beginPath(), m.moveTo(l, t), F = { x: l, y: t })
                        } var e = a.targetCanvasCtx || this.plotArea.ctx, f = w ? this._preRenderCtx : e; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var m = this._eventManager.ghostCtx, u = a.axisY.lineCoordinates, C = [], k = this.plotArea, n; f.save(); w && m.save(); f.beginPath(); f.rect(k.x1, k.y1, k.width, k.height); f.clip(); w && (m.beginPath(), m.rect(k.x1, k.y1, k.width, k.height), m.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                                var q = a.dataSeriesIndexes[p], g = this.data[q], s = g.dataPoints, C = g.id; this._eventManager.objectMap[C] =
                                    { objectType: "dataSeries", dataSeriesIndex: q }; C = S(C); m.fillStyle = C; C = []; d = !0; var h = 0, l, t, r, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z, F = null; if (0 < s.length) {
                                        var B = g._colorSet[h % g._colorSet.length], v = g.lineColor = g.options.lineColor || B, x = v; f.fillStyle = B; f.strokeStyle = v; f.lineWidth = g.lineThickness; c = "solid"; if (f.setLineDash) { var N = I(g.nullDataLineDashType, g.lineThickness); c = g.lineDashType; var Q = I(c, g.lineThickness); f.setLineDash(Q) } for (var fa = !0; h < s.length; h++)if (r = s[h].x.getTime ?
                                            s[h].x.getTime() : s[h].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !fa))) if ("number" !== typeof s[h].y) g.connectNullData || (fa || d) || b(), fa = !0; else {
                                                l = a.axisX.convertValueToPixel(r); t = a.axisY.convertValueToPixel(s[h].y); d || fa ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = l, c = t, l = n.x, t = n.y, b(), f.moveTo(n.x, n.y), l = d, t = c, F = n, c = g.nullDataLineDashType, f.setLineDash(N)), f.lineTo(l,
                                                    t), w && m.lineTo(l, t)) : (f.beginPath(), f.moveTo(l, t), w && (m.beginPath(), m.moveTo(l, t)), F = { x: l, y: t }), fa = d = !1) : (f.lineTo(l, t), w && m.lineTo(l, t), 0 == h % 250 && b()); n = { x: l, y: t }; h < s.length - 1 && (x !== (s[h].lineColor || v) || c !== (s[h].lineDashType || g.lineDashType)) && (b(), x = s[h].lineColor || v, f.strokeStyle = x, f.setLineDash && (s[h].lineDashType ? (c = s[h].lineDashType, f.setLineDash(I(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(Q)))); var aa = g.dataPointIds[h]; this._eventManager.objectMap[aa] = {
                                                        id: aa, objectType: "dataPoint",
                                                        dataSeriesIndex: q, dataPointIndex: h, x1: l, y1: t
                                                    }; 0 !== s[h].markerSize && (0 < s[h].markerSize || 0 < g.markerSize) && (r = g.getMarkerProperties(h, l, t, f), C.push(r), aa = S(aa), w && C.push({ x: l, y: t, ctx: m, type: r.type, size: r.size, color: aa, borderColor: aa, borderThickness: r.borderThickness })); (s[h].indexLabel || g.indexLabel || s[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: s[h], dataSeries: g, point: { x: l, y: t }, direction: 0 > s[h].y === a.axisY.reversed ? 1 : -1, color: B })
                                            } b(); $.drawMarkers(C)
                                    }
                            } w &&
                                (e.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), f.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && f.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && f.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), f.clearRect(k.x1, k.y1, k.width, k.height), this._eventManager.ghostCtx.restore()); f.restore(); return {
                                    source: e, dest: this.plotArea.ctx, animationCallback: O.xClipAnimation,
                                    easingFunction: O.easing.linear, animationBase: 0
                                }
                        }
                    }; l.prototype.renderSplineArea = function (a) {
                        function d() {
                            var c = v(A, 2); if (0 < c.length) {
                                if (0 < n.lineThickness) {
                                    b.beginPath(); b.moveTo(c[0].x, c[0].y); c[0].newStrokeStyle && (b.strokeStyle = c[0].newStrokeStyle); c[0].newLineDashArray && b.setLineDash(c[0].newLineDashArray); for (var d = 0; d < c.length - 3; d += 3)if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), w && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle ||
                                        c[d + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle && (b.strokeStyle = c[d + 3].newStrokeStyle), c[d + 3].newLineDashArray && b.setLineDash(c[d + 3].newLineDashArray); b.stroke()
                                } b.beginPath(); b.moveTo(c[0].x, c[0].y); w && (e.beginPath(), e.moveTo(c[0].x, c[0].y)); for (d = 0; d < c.length - 3; d += 3)b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), w && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y); a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum &&
                                    0 <= a.axisY.viewportMaximum ? r = l : 0 > a.axisY.viewportMaximum ? r = f.y1 : 0 < a.axisY.viewportMinimum && (r = l); t = { x: c[0].x, y: c[0].y }; b.lineTo(c[c.length - 1].x, r); b.lineTo(t.x, r); b.closePath(); b.globalAlpha = n.fillOpacity; b.fill(); b.globalAlpha = 1; w && (e.lineTo(c[c.length - 1].x, r), e.lineTo(t.x, r), e.closePath(), e.fill())
                            }
                        } var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var e = this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, m = [], u = this.plotArea; b.save(); w &&
                                e.save(); b.beginPath(); b.rect(u.x1, u.y1, u.width, u.height); b.clip(); w && (e.beginPath(), e.rect(u.x1, u.y1, u.width, u.height), e.clip()); for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                                    var k = a.dataSeriesIndexes[h], n = this.data[k], p = n.dataPoints, m = n.id; this._eventManager.objectMap[m] = { objectType: "dataSeries", dataSeriesIndex: k }; m = S(m); e.fillStyle = m; var m = [], q = 0, g, s, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), r, t = null, A = []; if (0 < p.length) {
                                        ...
                                        z = n.lineColor = n.options.lineColor || y, F = z; b.fillStyle = y; b.strokeStyle = z; b.lineWidth = n.lineThickness; var B = "solid"; if (b.setLineDash) { var x = I(n.nullDataLineDashType, n.lineThickness), B = n.lineDashType, D = I(B, n.lineThickness); b.setLineDash(D) } for (s = !1; q < p.length; q++)if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !s))) if ("number" !== typeof p[q].y) 0 < q && !s && (n.connectNullData ? b.setLineDash && (0 < A.length && (n.options.nullDataLineDashType ||
                                            !p[q - 1].lineDashType)) && (A[A.length - 1].newLineDashArray = x, B = n.nullDataLineDashType) : (d(), A = [])), s = !0; else {
                                                g = a.axisX.convertValueToPixel(g); s = a.axisY.convertValueToPixel(p[q].y); var N = n.dataPointIds[q]; this._eventManager.objectMap[N] = { id: N, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: q, x1: g, y1: s }; A[A.length] = { x: g, y: s }; q < p.length - 1 && (F !== (p[q].lineColor || z) || B !== (p[q].lineDashType || n.lineDashType)) && (F = p[q].lineColor || z, A[A.length - 1].newStrokeStyle = F, b.setLineDash && (p[q].lineDashType ? (B =
                                                    p[q].lineDashType, A[A.length - 1].newLineDashArray = I(B, n.lineThickness)) : (B = n.lineDashType, A[A.length - 1].newLineDashArray = D))); if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < n.markerSize)) { var Q = n.getMarkerProperties(q, g, s, b); m.push(Q); N = S(N); w && m.push({ x: g, y: s, ctx: e, type: Q.type, size: Q.size, color: N, borderColor: N, borderThickness: Q.borderThickness }) } (p[q].indexLabel || n.indexLabel || p[q].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
                                                        chartType: "splineArea", dataPoint: p[q], dataSeries: n,
                                                        point: { x: g, y: s }, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: y
                                                    }); s = !1
                                        } d(); $.drawMarkers(m)
                                    }
                                } w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(u.x1, u.y1, u.width, u.height),
                                    this._eventManager.ghostCtx.restore()); b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: O.xClipAnimation, easingFunction: O.easing.linear, animationBase: 0 }
                        }
                        ...
                        var d, c; function b() {
                            F && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = y : 0 > a.axisY.viewportMaximum ? z = u.y1 : 0 < a.axisY.viewportMinimum && (z = y), f.lineTo(r, z), f.lineTo(F.x, z), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha =
                                1, w && (m.lineTo(r, z), m.lineTo(F.x, z), m.closePath(), m.fill()), f.beginPath(), f.moveTo(r, t), m.beginPath(), m.moveTo(r, t), F = { x: r, y: t })
                        } var e = a.targetCanvasCtx || this.plotArea.ctx, f = w ? this._preRenderCtx : e; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var m = this._eventManager.ghostCtx, u = a.axisY.lineCoordinates, h = [], k = this.plotArea, n; f.save(); w && m.save(); f.beginPath(); f.rect(k.x1, k.y1, k.width, k.height); f.clip(); w && (m.beginPath(), m.rect(k.x1, k.y1, k.width, k.height), m.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                                var q =
                                    a.dataSeriesIndexes[p], g = this.data[q], s = g.dataPoints, h = g.id; this._eventManager.objectMap[h] = { objectType: "dataSeries", dataSeriesIndex: q }; h = S(h); m.fillStyle = h; h = []; d = !0; var l = 0, r, t, A, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z, F = null; c = !1; if (0 < s.length) {
                                        var B = g._colorSet[l % g._colorSet.length], v = g.lineColor = g.options.lineColor || B, x = v; f.fillStyle = B; f.strokeStyle = v; f.lineWidth = g.lineThickness; var N = "solid"; if (f.setLineDash) {
                                            var Q = I(g.nullDataLineDashType, g.lineThickness),
                                            N = g.lineDashType, D = I(N, g.lineThickness); f.setLineDash(D)
                                        } for (; l < s.length; l++)if (A = s[l].x.getTime ? s[l].x.getTime() : s[l].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                            var aa = t; "number" !== typeof s[l].y ? (g.connectNullData || (c || d) || b(), c = !0) : (r = a.axisX.convertValueToPixel(A), t = a.axisY.convertValueToPixel(s[l].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || N === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = r,
                                                ...
                                                this._indexLabels.push({ chartType: "stepArea", dataPoint: s[l], dataSeries: g, point: { x: r, y: t }, direction: 0 > s[l].y === a.axisY.reversed ? 1 : -1, color: B }))
                                        } b(); $.drawMarkers(h)
                                    }
                            } w && (e.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), f.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && f.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && f.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                                0, 0, this.width, this.height), f.clearRect(k.x1, k.y1, k.width, k.height), this._eventManager.ghostCtx.restore()); f.restore(); return { source: e, dest: this.plotArea.ctx, animationCallback: O.xClipAnimation, easingFunction: O.easing.linear, animationBase: 0 }
                        }
                    }; l.prototype.renderStackedArea = function (a) {
                        function d() {
                            if (!(1 > k.length)) {
                                for (0 < B.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop(); b.lineTo(a.x, a.y); w && r.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = B.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); w && (r.closePath(),
                                    r.fill(), r.beginPath()); k = []
                            }
                        } var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var e = null, f = null, m = [], u = this.plotArea, h = [], k = [], n = [], p = [], q = 0, g, s, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), r = this._eventManager.ghostCtx, t, A, y; w && r.beginPath(); b.save(); w && r.save(); b.beginPath(); b.rect(u.x1, u.y1, u.width, u.height); b.clip(); w && (r.beginPath(), r.rect(u.x1, u.y1, u.width, u.height), r.clip()); for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
                                var F =
                                    a.dataSeriesIndexes[z], B = this.data[F], v = B.dataPoints; B.dataPointIndexes = []; for (q = 0; q < v.length; q++)F = v[q].x.getTime ? v[q].x.getTime() : v[q].x, B.dataPointIndexes[F] = q, e[F] || (n.push(F), e[F] = !0); n.sort(Sa)
                            } for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                                F = a.dataSeriesIndexes[z]; B = this.data[F]; v = B.dataPoints; A = !0; k = []; q = B.id; this._eventManager.objectMap[q] = { objectType: "dataSeries", dataSeriesIndex: F }; q = S(q); r.fillStyle = q; if (0 < n.length) {
                                    var e = B._colorSet[0], x = B.lineColor = B.options.lineColor || e, N = x; b.fillStyle = e;
                                    b.strokeStyle = x; b.lineWidth = B.lineThickness; y = "solid"; if (b.setLineDash) { var Q = I(B.nullDataLineDashType, B.lineThickness); y = B.lineDashType; var D = I(y, B.lineThickness); b.setLineDash(D) } for (var aa = !0, q = 0; q < n.length; q++) {
                                        var f = n[q], ga = null, ga = 0 <= B.dataPointIndexes[f] ? v[B.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa))) if ("number" !== typeof ga.y) B.connectNullData || (aa || A) || d(), aa = !0; else {
                                                ...
                                                h[f] ? h[f] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = ga.y + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue; s = a.axisY.convertValueToPixel(p[f]) } else s = a.axisY.convertValueToPixel(ga.y), s -= ma; k.push({ x: g, y: l - ma }); h[f] = l - s; A || aa ? (!A && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || y === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (A = k.pop(), y = k[k.length - 1], d(), b.moveTo(t.x, t.y), k.push(y), k.push(A), y = B.nullDataLineDashType,
                                                    b.setLineDash(Q)), b.lineTo(g, s), w && r.lineTo(g, s)) : (b.beginPath(), b.moveTo(g, s), w && (r.beginPath(), r.moveTo(g, s))), aa = A = !1) : (b.lineTo(g, s), w && r.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && r.moveTo(g, s), k.push({ x: g, y: l - ma }))); t = { x: g, y: s }; q < v.length - 1 && (N !== (v[q].lineColor || x) || y !== (v[q].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, s), k.push({ x: g, y: l - ma }), N = v[q].lineColor || x, b.strokeStyle = N, b.setLineDash && (v[q].lineDashType ? (y = v[q].lineDashType, b.setLineDash(I(y, B.lineThickness))) : (y =
                                                        B.lineDashType, b.setLineDash(D)))); if (0 <= B.dataPointIndexes[f]) { var E = B.dataPointIds[B.dataPointIndexes[f]]; this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: F, dataPointIndex: B.dataPointIndexes[f], x1: g, y1: s } } 0 <= B.dataPointIndexes[f] && 0 !== ga.markerSize && (0 < ga.markerSize || 0 < B.markerSize) && (ma = B.getMarkerProperties(B.dataPointIndexes[f], g, s, b), m.push(ma), f = S(E), w && m.push({ x: g, y: s, ctx: r, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness })); (ga.indexLabel ||
                                                            B.indexLabel || ga.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: ga, dataSeries: B, point: { x: g, y: s }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                        }
                                    } d(); b.moveTo(g, s); w && r.moveTo(g, s)
                                } delete B.dataPointIndexes
                            } $.drawMarkers(m); w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas,
                        ...
                        function d() {
                            for (0 < B.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop(); b.lineTo(a.x, a.y); w && y.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha =
                                B.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); w && (y.closePath(), y.fill(), y.beginPath()); k = []
                        } var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var e = null, f = null, m = this.plotArea, u = [], h = [], k = [], n = [], p = [], q = 0, g, s, l, r, t, A = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y = this._eventManager.ghostCtx; b.save(); w && y.save(); b.beginPath(); b.rect(m.x1, m.y1, m.width, m.height); b.clip(); w && (y.beginPath(), y.rect(m.x1, m.y1, m.width,
                                m.height), y.clip()); for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) { var v = a.dataSeriesIndexes[z], B = this.data[v], x = B.dataPoints; B.dataPointIndexes = []; for (q = 0; q < x.length; q++)v = x[q].x.getTime ? x[q].x.getTime() : x[q].x, B.dataPointIndexes[v] = q, e[v] || (n.push(v), e[v] = !0); n.sort(Sa) } for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                                    v = a.dataSeriesIndexes[z]; B = this.data[v]; x = B.dataPoints; r = !0; e = B.id; this._eventManager.objectMap[e] = { objectType: "dataSeries", dataSeriesIndex: v }; e = S(e); y.fillStyle = e; k = []; if (0 < n.length) {
                                        var e =
                                            B._colorSet[q % B._colorSet.length], D = B.lineColor = B.options.lineColor || e, N = D; b.fillStyle = e; b.strokeStyle = D; b.lineWidth = B.lineThickness; t = "solid"; if (b.setLineDash) { var Q = I(B.nullDataLineDashType, B.lineThickness); t = B.lineDashType; var E = I(t, B.lineThickness); b.setLineDash(E) } for (var aa = !0, q = 0; q < n.length; q++) {
                                                var f = n[q], ga = null, ga = 0 <= B.dataPointIndexes[f] ? x[B.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa))) if ("number" !== typeof ga.y) B.connectNullData ||
                                                    (aa || r) || d(), aa = !0; else {
                                                        var ma; ma = 0 !== a.dataPointYSums[f] ? 100 * (ga.y / a.dataPointYSums[f]) : 0; g = a.axisX.convertValueToPixel(f); var ba = h[f] ? h[f] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = ma + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue; s = a.axisY.convertValueToPixel(p[f]) } else s = a.axisY.convertValueToPixel(ma), s -= ba; k.push({ x: g, y: A - ba }); h[f] = A - s; r || aa ? (!r && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || t === B.lineDashType &&
                                                            B.lineDashType !== B.nullDataLineDashType) && (r = k.pop(), t = k[k.length - 1], d(), b.moveTo(l.x, l.y), k.push(t), k.push(r), t = B.nullDataLineDashType, b.setLineDash(Q)), b.lineTo(g, s), w && y.lineTo(g, s)) : (b.beginPath(), b.moveTo(g, s), w && (y.beginPath(), y.moveTo(g, s))), aa = r = !1) : (b.lineTo(g, s), w && y.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && y.moveTo(g, s), k.push({ x: g, y: A - ba }))); l = { x: g, y: s }; q < x.length - 1 && (N !== (x[q].lineColor || D) || t !== (x[q].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, s), k.push({
                                                                x: g, y: A -
                                                                    ba
                                                            }), N = x[q].lineColor || D, b.strokeStyle = N, b.setLineDash && (x[q].lineDashType ? (t = x[q].lineDashType, b.setLineDash(I(t, B.lineThickness))) : (t = B.lineDashType, b.setLineDash(E)))); if (0 <= B.dataPointIndexes[f]) { var G = B.dataPointIds[B.dataPointIndexes[f]]; this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: B.dataPointIndexes[f], x1: g, y1: s } } 0 <= B.dataPointIndexes[f] && 0 !== ga.markerSize && (0 < ga.markerSize || 0 < B.markerSize) && (ba = B.getMarkerProperties(q, g, s, b), u.push(ba), f = S(G),
                                                                w && u.push({ x: g, y: s, ctx: y, type: ba.type, size: ba.size, color: f, borderColor: f, borderThickness: ba.borderThickness })); (ga.indexLabel || B.indexLabel || ga.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: ga, dataSeries: B, point: { x: g, y: s }, direction: 0 > x[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                                }
                                            } d(); b.moveTo(g, s); w && y.moveTo(g, s)
                                    } delete B.dataPointIndexes
                                } $.drawMarkers(u); w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation =
                                ...
                                var b = this.plotArea, e = 0, f, m; c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var u = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)for (var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints,
                                    g = 0, e = 0; e < q.length; e++)f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (g = q[e].z, g > u && (u = g), g < h && (h = g)); for (var s = 25 * Math.PI, l = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, s), k = 0; k < a.dataSeriesIndexes.length; k++)if (n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, 0 < q.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                        f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                                            f = a.axisX.convertValueToPixel(f); m = a.axisY.convertValueToPixel(q[e].y); var g = q[e].z, r = 2 * Math.max(Math.sqrt((u === h ? l / 2 : s + (l - s) / (u - h) * (g - h)) / Math.PI) << 0, 1), g = p.getMarkerProperties(e, c); g.size = r; c.globalAlpha = p.fillOpacity; $.drawMarker(f, m, c, g.type, g.size, g.color, g.borderColor, g.borderThickness); c.globalAlpha = 1; var t = p.dataPointIds[e]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: e, x1: f, y1: m, size: r };
                                        r = S(t); w && $.drawMarker(f, m, this._eventManager.ghostCtx, g.type, g.size, r, r, g.borderThickness); (q[e].indexLabel || p.indexLabel || q[e].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: q[e], dataSeries: p, point: { x: f, y: m }, direction: 1, bounds: { x1: f - g.size / 2, y1: m - g.size / 2, x2: f + g.size / 2, y2: m + g.size / 2 }, color: null })
                                    } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas,
                        ...
                        c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var b = this.plotArea, e = 0, f, m; c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                                var h = a.dataSeriesIndexes[u], k = this.data[h], n = k.dataPoints; if (0 < n.length) {
                                    c.strokeStyle = "#4572A7 "; Math.pow(0.3 * Math.min(b.height,
                                        b.width) / 2, 2); for (var p = 0, q = 0, e = 0; e < n.length; e++)if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                                            f = a.axisX.convertValueToPixel(f); m = a.axisY.convertValueToPixel(n[e].y); var g = k.getMarkerProperties(e, f, m, c); c.globalAlpha = k.fillOpacity; $.drawMarker(g.x, g.y, g.ctx, g.type, g.size, g.color, g.borderColor, g.borderThickness); c.globalAlpha = 1; Math.sqrt((p - f) * (p - f) + (q - m) * (q - m)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width,
                                ...
                                animationCallback: O.fadeInAnimation, easingFunction: O.easing.easeInQuad, animationBase: 0
                            }
                        }
                        ...
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var e = null, f = null, m = this.plotArea, u = 0, h, k, n, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ?
                                this.dataPointWidth : 0.015 * this.width, s = a.axisX.dataInfo.minDiff; isFinite(s) || (s = 0.3 * Math.abs(a.axisX.range)); s = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * m.width * (a.axisX.logarithmic ? Math.log(s) / Math.log(a.axisX.range) : Math.abs(s) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e > f && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, f)); !this.dataPointMaxWidth && (this.dataPointMinWidth && f < e) && (f = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); s <
                                    e && (s = e); s > f && (s = f); c.save(); w && b.save(); c.beginPath(); c.rect(m.x1, m.y1, m.width, m.height); c.clip(); w && (b.beginPath(), b.rect(m.x1, m.y1, m.width, m.height), b.clip()); for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                                        var Aa = a.dataSeriesIndexes[l], t = this.data[Aa], A = t.dataPoints; if (0 < A.length) for (var y = 5 < s && t.bevelEnabled ? !0 : !1, u = 0; u < A.length; u++)if (A[u].getTime ? g = A[u].x.getTime() : g = A[u].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(A[u].y) && A[u].y.length && "number" === typeof A[u].y[0] &&
                                            "number" === typeof A[u].y[1] && "number" === typeof A[u].y[2] && "number" === typeof A[u].y[3]) {
                                                h = a.axisX.convertValueToPixel(g); k = a.axisY.convertValueToPixel(A[u].y[0]); n = a.axisY.convertValueToPixel(A[u].y[1]); p = a.axisY.convertValueToPixel(A[u].y[2]); q = a.axisY.convertValueToPixel(A[u].y[3]); var z = h - s / 2 << 0, v = z + s << 0, f = t.options.fallingColor ? t.fallingColor : t._colorSet[0], e = A[u].color ? A[u].color : t._colorSet[0], B = Math.round(Math.max(1, 0.15 * s)), x = 0 === B % 2 ? 0 : 0.5, D = t.dataPointIds[u]; this._eventManager.objectMap[D] =
                                                    { id: D, objectType: "dataPoint", dataSeriesIndex: Aa, dataPointIndex: u, x1: z, y1: k, x2: v, y2: n, x3: h, y3: p, x4: h, y4: q, borderThickness: B, color: e }; c.strokeStyle = e; c.beginPath(); c.lineWidth = B; b.lineWidth = Math.max(B, 4); "candlestick" === t.type ? (c.moveTo(h - x, n), c.lineTo(h - x, Math.min(k, q)), c.stroke(), c.moveTo(h - x, Math.max(k, q)), c.lineTo(h - x, p), c.stroke(), ea(c, z, Math.min(k, q), v, Math.max(k, q), A[u].y[0] <= A[u].y[3] ? t.risingColor : f, B, e, y, y, !1, !1, t.fillOpacity), w && (e = S(D), b.strokeStyle = e, b.moveTo(h - x, n), b.lineTo(h - x, Math.min(k,
                                                        q)), b.stroke(), b.moveTo(h - x, Math.max(k, q)), b.lineTo(h - x, p), b.stroke(), ea(b, z, Math.min(k, q), v, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === t.type && (c.moveTo(h - x, n), c.lineTo(h - x, p), c.stroke(), c.beginPath(), c.moveTo(h, k), c.lineTo(z, k), c.stroke(), c.beginPath(), c.moveTo(h, q), c.lineTo(v, q), c.stroke(), w && (e = S(D), b.strokeStyle = e, b.moveTo(h - x, n), b.lineTo(h - x, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(z, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(v, q), b.stroke())); (A[u].indexLabel || t.indexLabel ||
                                                            A[u].indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({ chartType: t.type, dataPoint: A[u], dataSeries: t, point: { x: z + (v - z) / 2, y: a.axisY.reversed ? p : n }, direction: 1, bounds: { x1: z, y1: Math.min(n, p), x2: v, y2: Math.max(n, p) }, color: e })
                                        }
                                        ...
                                        this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(m.x1, m.y1, m.width, m.height), b.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: O.fadeInAnimation, easingFunction: O.easing.easeInQuad, animationBase: 0 }
                        }
                        ...
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
                            ...
                            m = 0, u, h, k, n, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, s = a.axisX.dataInfo.minDiff; isFinite(s) || (s = 0.3 * Math.abs(a.axisX.range)); s = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * f.width * (a.axisX.logarithmic ? Math.log(s) / Math.log(a.axisX.range) : Math.abs(s) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e >
                                m && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m)); !this.dataPointMaxWidth && (this.dataPointMinWidth && m < e) && (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); s < e && (s = e); s > m && (s = m); c.save(); w && b.save(); c.beginPath(); c.rect(f.x1, f.y1, f.width, f.height); c.clip(); w && (b.beginPath(), b.rect(f.x1, f.y1, f.width, f.height), b.clip()); for (var l = !1, l = !!a.axisY.reversed, Aa = 0; Aa < a.dataSeriesIndexes.length; Aa++) {
                                    var t = a.dataSeriesIndexes[Aa], A = this.data[t], y = A.dataPoints;
                                    if (0 < y.length) for (var z = 5 < s && A.bevelEnabled ? !0 : !1, m = 0; m < y.length; m++)if (y[m].getTime ? g = y[m].x.getTime() : g = y[m].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[m].y) && y[m].y.length && "number" === typeof y[m].y[0] && "number" === typeof y[m].y[1] && "number" === typeof y[m].y[2] && "number" === typeof y[m].y[3] && "number" === typeof y[m].y[4] && 5 === y[m].y.length) {
                                        u = a.axisX.convertValueToPixel(g); h = a.axisY.convertValueToPixel(y[m].y[0]); k = a.axisY.convertValueToPixel(y[m].y[1]); n = a.axisY.convertValueToPixel(y[m].y[2]);
                                        p = a.axisY.convertValueToPixel(y[m].y[3]); q = a.axisY.convertValueToPixel(y[m].y[4]); var v = u - s / 2 << 0, B = u + s / 2 << 0, e = y[m].color ? y[m].color : A._colorSet[0], x = Math.round(Math.max(1, 0.15 * s)), D = 0 === x % 2 ? 0 : 0.5, N = y[m].whiskerColor ? y[m].whiskerColor : y[m].color ? A.whiskerColor ? A.whiskerColor : y[m].color : A.whiskerColor ? A.whiskerColor : e, Q = "number" === typeof y[m].whiskerThickness ? y[m].whiskerThickness : "number" === typeof A.options.whiskerThickness ? A.whiskerThickness : x, E = y[m].whiskerDashType ? y[m].whiskerDashType : A.whiskerDashType,
                                            aa = r(y[m].whiskerLength) ? r(A.options.whiskerLength) ? s : A.whiskerLength : y[m].whiskerLength, aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= s ? s : aa : "string" === typeof aa ? parseInt(aa) * s / 100 > s ? s : parseInt(aa) * s / 100 : s, ga = 1 === Math.round(Q) % 2 ? 0.5 : 0, ma = y[m].stemColor ? y[m].stemColor : y[m].color ? A.stemColor ? A.stemColor : y[m].color : A.stemColor ? A.stemColor : e, ba = "number" === typeof y[m].stemThickness ? y[m].stemThickness : "number" === typeof A.options.stemThickness ? A.stemThickness : x, G = 1 === Math.round(ba) % 2 ? 0.5 : 0, J = y[m].stemDashType ? y[m].stemDashType :
                                                A.stemDashType, K = y[m].lineColor ? y[m].lineColor : y[m].color ? A.lineColor ? A.lineColor : y[m].color : A.lineColor ? A.lineColor : e, L = "number" === typeof y[m].lineThickness ? y[m].lineThickness : "number" === typeof A.options.lineThickness ? A.lineThickness : x, P = y[m].lineDashType ? y[m].lineDashType : A.lineDashType, M = 1 === Math.round(L) % 2 ? 0.5 : 0, Y = A.upperBoxColor, ya = A.lowerBoxColor, sa = r(A.options.fillOpacity) ? 1 : A.fillOpacity, R = A.dataPointIds[m]; this._eventManager.objectMap[R] = {
                                                    id: R, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: m,
                                                    x1: v, y1: h, x2: B, y2: k, x3: u, y3: n, x4: u, y4: p, y5: q, borderThickness: x, color: e, stemThickness: ba, stemColor: ma, whiskerThickness: Q, whiskerLength: aa, whiskerColor: N, lineThickness: L, lineColor: K
                                                }; c.save(); 0 < ba && (c.beginPath(), c.strokeStyle = ma, c.lineWidth = ba, c.setLineDash && c.setLineDash(I(J, ba)), c.moveTo(u - G, k), c.lineTo(u - G, h), c.stroke(), c.moveTo(u - G, p), c.lineTo(u - G, n), c.stroke()); c.restore(); b.lineWidth = Math.max(x, 4); c.beginPath(); ea(c, v, Math.min(q, k), B, Math.max(k, q), ya, 0, e, l ? z : !1, l ? !1 : z, !1, !1, sa); c.beginPath();
                                        ea(c, v, Math.min(n, q), B, Math.max(q, n), Y, 0, e, l ? !1 : z, l ? z : !1, !1, !1, sa); c.beginPath(); c.lineWidth = x; c.strokeStyle = e; c.rect(v - D, Math.min(k, n) - D, B - v + 2 * D, Math.max(k, n) - Math.min(k, n) + 2 * D); c.stroke(); c.save(); 0 < L && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(I(P, L)), c.strokeStyle = K, c.lineWidth = L, c.moveTo(v, q - M), c.lineTo(B, q - M), c.stroke()); c.restore(); c.save(); 0 < Q && (c.beginPath(), c.setLineDash && c.setLineDash(I(E, Q)), c.strokeStyle = N, c.lineWidth = Q, c.moveTo(u - aa / 2 << 0, p - ga), c.lineTo(u + aa / 2 << 0, p - ga),
                                            c.stroke(), c.moveTo(u - aa / 2 << 0, h + ga), c.lineTo(u + aa / 2 << 0, h + ga), c.stroke()); c.restore(); w && (e = S(R), b.strokeStyle = e, b.lineWidth = ba, 0 < ba && (b.moveTo(u - D - G, k), b.lineTo(u - D - G, Math.max(h, p)), b.stroke(), b.moveTo(u - D - G, Math.min(h, p)), b.lineTo(u - D - G, n), b.stroke()), ea(b, v, Math.max(k, n), B, Math.min(k, n), e, 0, null, !1, !1, !1, !1), 0 < Q && (b.beginPath(), b.lineWidth = Q, b.moveTo(u + aa / 2, p - ga), b.lineTo(u - aa / 2, p - ga), b.stroke(), b.moveTo(u + aa / 2, h + ga), b.lineTo(u - aa / 2, h + ga), b.stroke())); (y[m].indexLabel || A.indexLabel || y[m].indexLabelFormatter ||
                                                A.indexLabelFormatter) && this._indexLabels.push({ chartType: A.type, dataPoint: y[m], dataSeries: A, point: { x: v + (B - v) / 2, y: a.axisY.reversed ? h : p }, direction: 1, bounds: { x1: v, y1: Math.min(h, p), x2: B, y2: Math.max(h, p) }, color: e })
                                    }
                                } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                                    0, 0, this.width, this.height), c.clearRect(f.x1, f.y1, f.width, f.height), b.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: O.fadeInAnimation, easingFunction: O.easing.easeInQuad, animationBase: 0 }
                        }
                    }; l.prototype.renderRangeColumn = function (a) {
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var b = null, e = this.plotArea, f = 0, m, u, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                                1; m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.03 * this.width; var k = a.axisX.dataInfo.minDiff; isFinite(k) || (k = 0.3 * Math.abs(a.axisX.range)); k = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(k) / Math.log(a.axisX.range) : Math.abs(k) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > m && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m)); !this.dataPointMaxWidth &&
                                    (this.dataPointMinWidth && m < f) && (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); k < f && (k = f); k > m && (k = m); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                                        var p = a.dataSeriesIndexes[n], q = this.data[p], g = q.dataPoints; if (0 < g.length) for (var s =
                                            5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                                                b = a.axisX.convertValueToPixel(h); m = a.axisY.convertValueToPixel(g[f].y[0]); u = a.axisY.convertValueToPixel(g[f].y[1]); var l = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + n) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                                                    n) * k << 0, v = a.axisX.reversed ? l - k << 0 : l + k << 0, b = g[f].color ? g[f].color : q._colorSet[f % q._colorSet.length]; if (m > u) { var t = m; m = u; u = t } t = q.dataPointIds[f]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: l, y1: m, x2: v, y2: u }; ea(c, a.axisX.reversed ? v : l, m, a.axisX.reversed ? l : v, u, b, 0, b, s, s, !1, !1, q.fillOpacity); b = S(t); w && ea(this._eventManager.ghostCtx, a.axisX.reversed ? v : l, m, a.axisX.reversed ? l : v, u, b, 0, null, !1, !1, !1, !1); if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter ||
                                                        q.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 0, point: { x: l + (v - l) / 2, y: g[f].y[1] >= g[f].y[0] ? u : m }, direction: g[f].y[1] >= g[f].y[0] ? -1 : 1, bounds: { x1: l, y1: Math.min(m, u), x2: v, y2: Math.max(m, u) }, color: b }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 1, point: { x: l + (v - l) / 2, y: g[f].y[1] >= g[f].y[0] ? m : u }, direction: g[f].y[1] >= g[f].y[0] ? 1 : -1, bounds: { x1: l, y1: Math.min(m, u), x2: v, y2: Math.max(m, u) }, color: b })
                                            }
                                    } w && (d.drawImage(this._preRenderCanvas,
                                        0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return {
                                            source: d, dest: this.plotArea.ctx, animationCallback: O.fadeInAnimation, easingFunction: O.easing.easeInQuad,
                                            animationBase: 0
                                        }
                        }
                        ...
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d, b = a.axisY._position ? "left" === a.axisY._position || "right" === a.axisY._position ? !1 : !0 : !1; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var e = null, f = !1, m = this.plotArea, u = 0, h, k, n, p, q, g, s, l = a.axisX.dataInfo.minDiff; isFinite(l) || (l = 0.3 * Math.abs(a.axisX.range)); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(m.x1, m.y1, m.width, m.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(),
                                this._eventManager.ghostCtx.rect(m.x1, m.y1, m.width, m.height), this._eventManager.ghostCtx.clip()); for (var v = 0, t = 0; t < this.data.length; t++)!this.data[t].type.match(/(bar|column)/ig) || !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) && v || v++; for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                                    var y = a.dataSeriesIndexes[A], z = this.data[y], F = z.dataPoints, B = r(z._linkedSeries) ? !1 : z._linkedSeries.type.match(/(bar|column)/ig) && z._linkedSeries.visible ? !0 : !1, D = 0; if (B) for (e = z._linkedSeries.id, t = 0; t < e; t++)!this.data[t].type.match(/(bar|column)/ig) ||
                                        !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) && D || (this.data[t].type.match(/(range)/ig) && (f = !0), D++); e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; u = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? v : 1))) << 0 : 0.3 * this.width; f && (u = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                                            b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? v : 1))) << 0 : 0.03 * this.width); t = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? m.height : m.width) * (a.axisX.logarithmic ? Math.log(l) / Math.log(a.axisX.range) : Math.abs(l) / Math.abs(a.axisX.range)) / (B ? v : 1)) << 0; this.dataPointMaxWidth && e > u && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, u)); !this.dataPointMaxWidth && (this.dataPointMinWidth && u < e) && (u = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); t < e &&
                                                (t = e); t > u && (t = u); if (0 < F.length) for (var E = z._colorSet, u = 0; u < F.length; u++) {
                                                    var e = z.lineColor = z.options.color ? z.options.color : E[0], N = {
                                                        color: F[u].whiskerColor ? F[u].whiskerColor : F[u].color ? z.whiskerColor ? z.whiskerColor : F[u].color : z.whiskerColor ? z.whiskerColor : e, thickness: r(F[u].whiskerThickness) ? z.whiskerThickness : F[u].whiskerThickness, dashType: F[u].whiskerDashType ? F[u].whiskerDashType : z.whiskerDashType, length: r(F[u].whiskerLength) ? r(z.options.whiskerLength) ? t : z.options.whiskerLength : F[u].whiskerLength,
                                                        trimLength: r(F[u].whiskerLength) ? r(z.options.whiskerLength) ? 50 : 0 : 0
                                                    }; N.length = "number" === typeof N.length ? 0 >= N.length ? 0 : N.length >= t ? t : N.length : "string" === typeof N.length ? parseInt(N.length) * t / 100 > t ? t : parseInt(N.length) * t / 100 > t : t; N.thickness = "number" === typeof N.thickness ? 0 > N.thickness ? 0 : Math.round(N.thickness) : 2; var Q = {
                                                        color: F[u].stemColor ? F[u].stemColor : F[u].color ? z.stemColor ? z.stemColor : F[u].color : z.stemColor ? z.stemColor : e, thickness: F[u].stemThickness ? F[u].stemThickness : z.stemThickness, dashType: F[u].stemDashType ?
                                                            F[u].stemDashType : z.stemDashType
                                                    }; Q.thickness = "number" === typeof Q.thickness ? 0 > Q.thickness ? 0 : Math.round(Q.thickness) : 2; F[u].getTime ? s = F[u].x.getTime() : s = F[u].x; if (!(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax) && !r(F[u].y) && F[u].y.length && "number" === typeof F[u].y[0] && "number" === typeof F[u].y[1]) {
                                                        var fa = a.axisX.convertValueToPixel(s); b ? k = fa : h = fa; fa = a.axisY.convertValueToPixel(F[u].y[0]); b ? n = fa : q = fa; fa = a.axisY.convertValueToPixel(F[u].y[1]); b ? p = fa : g = fa; b ? (q = a.axisX.reversed ? k + (B ? v :
                                                            1) * t / 2 - (B ? D - 1 : 0) * t << 0 : k - (B ? v : 1) * t / 2 + (B ? D - 1 : 0) * t << 0, g = a.axisX.reversed ? q - t << 0 : q + t << 0) : (n = a.axisX.reversed ? h + (B ? v : 1) * t / 2 - (B ? D - 1 : 0) * t << 0 : h - (B ? v : 1) * t / 2 + (B ? D - 1 : 0) * t << 0, p = a.axisX.reversed ? n - t << 0 : n + t << 0); !b && q > g && (fa = q, q = g, g = fa); b && n > p && (fa = n, n = p, p = fa); fa = z.dataPointIds[u]; this._eventManager.objectMap[fa] = { id: fa, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: u, x1: Math.min(n, p), y1: Math.min(q, g), x2: Math.max(p, n), y2: Math.max(g, q), isXYSwapped: b, stemProperties: Q, whiskerProperties: N }; x(c, Math.min(n, p),
                                                                Math.min(q, g), Math.max(p, n), Math.max(g, q), e, N, Q, b); w && x(this._eventManager.ghostCtx, n, q, p, g, e, N, Q, b); if (F[u].indexLabel || z.indexLabel || F[u].indexLabelFormatter || z.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: F[u], dataSeries: z, indexKeyword: 0, point: { x: b ? F[u].y[1] >= F[u].y[0] ? n : p : n + (p - n) / 2, y: b ? q + (g - q) / 2 : F[u].y[1] >= F[u].y[0] ? g : q }, direction: F[u].y[1] >= F[u].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(n, p) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, p) : p, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b }),
                                                                    this._indexLabels.push({ chartType: "error", dataPoint: F[u], dataSeries: z, indexKeyword: 1, point: { x: b ? F[u].y[1] >= F[u].y[0] ? p : n : n + (p - n) / 2, y: b ? q + (g - q) / 2 : F[u].y[1] >= F[u].y[0] ? q : g }, direction: F[u].y[1] >= F[u].y[0] ? 1 : -1, bounds: { x1: b ? Math.min(n, p) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, p) : p, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b })
                                                    }
                                                }
                                } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height),
                                ...
                                var b = null, e = this.plotArea, f = 0, m, u, h, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0; var n = a.axisX.dataInfo.minDiff; isFinite(n) || (n = 0.3 * Math.abs(a.axisX.range)); n = this.options.dataPointWidth ? this.dataPointWidth : 0.9 *
                                    (e.height * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > m && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m)); !this.dataPointMaxWidth && (this.dataPointMinWidth && m < f) && (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); n < f && (n = f); n > m && (n = m); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(),
                                        this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                                            var q = a.dataSeriesIndexes[p], g = this.data[q], s = g.dataPoints; if (0 < s.length) {
                                                var l = 5 < n && g.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (f = 0; f < s.length; f++)if (s[f].getTime ? k = s[f].x.getTime() : k = s[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(s[f].y) && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1]) {
                                                    m = a.axisY.convertValueToPixel(s[f].y[0]);
                                                    u = a.axisY.convertValueToPixel(s[f].y[1]); h = a.axisX.convertValueToPixel(k); h = a.axisX.reversed ? h + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + p) * n << 0 : h - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + p) * n << 0; var v = a.axisX.reversed ? h - n << 0 : h + n << 0; m > u && (b = m, m = u, u = b); b = s[f].color ? s[f].color : g._colorSet[f % g._colorSet.length]; ea(c, m, a.axisX.reversed ? v : h, u, a.axisX.reversed ? h : v, b, 0, null, l, !1, !1, !1, g.fillOpacity); b = g.dataPointIds[f]; this._eventManager.objectMap[b] = {
                                                        id: b, objectType: "dataPoint",
                                                        dataSeriesIndex: q, dataPointIndex: f, x1: m, y1: h, x2: u, y2: v
                                                        ...
                                                        chartType: "rangeBar",
                                                        dataPoint: s[f], dataSeries: g, indexKeyword: 1, point: { x: s[f].y[1] >= s[f].y[0] ? u : m, y: h + (v - h) / 2 }, direction: s[f].y[1] >= s[f].y[0] ? 1 : -1, bounds: { x1: Math.min(m, u), y1: h, x2: Math.max(m, u), y2: v }, color: b
                                                    })
                                                }
                                            }
                                        } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                                            0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: O.fadeInAnimation, easingFunction: O.easing.easeInQuad, animationBase: 0 }
                            }
                        ...
                        function d() {
                            if (A) {
                                ...
                                } b.beginPath(); b.moveTo(s, l); e.beginPath(); e.moveTo(s, l); A = { x: s, y: l }; h = []; h.push({ x: s, y1: l, y2: r })
                            }
                        } var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var e = this._eventManager.ghostCtx, f = [], m = this.plotArea; b.save(); w && e.save(); b.beginPath(); b.rect(m.x1, m.y1, m.width, m.height); b.clip(); w && (e.beginPath(),
                                e.rect(m.x1, m.y1, m.width, m.height), e.clip()); for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                                    var h = [], k = a.dataSeriesIndexes[u], n = this.data[k], p = n.dataPoints, f = n.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: k }; f = S(f); e.fillStyle = f; var f = [], q = !0, g = 0, s, l, r, t, A = null; if (0 < p.length) {
                                        var y = n._colorSet[g % n._colorSet.length], v = n.lineColor = n.options.lineColor || y, x = v; b.fillStyle = y; b.strokeStyle = v; b.lineWidth = n.lineThickness; var B = "solid"; if (b.setLineDash) {
                                            var D = I(n.nullDataLineDashType,
                                                n.lineThickness), B = n.lineDashType, E = I(B, n.lineThickness); b.setLineDash(E)
                                        } for (var N = !0; g < p.length; g++)if (t = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !N))) if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                            s = a.axisX.convertValueToPixel(t); l = a.axisY.convertValueToPixel(p[g].y[0]); r = a.axisY.convertValueToPixel(p[g].y[1]); q || N ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType ||
                                                B === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E, B = n.nullDataLineDashType, b.setLineDash(D)), b.lineTo(s, l), w && e.lineTo(s, l), h.push({ x: s, y1: l, y2: r })) : (b.beginPath(), b.moveTo(s, l), A = { x: s, y: l }, h = [], h.push({ x: s, y1: l, y2: r }), w && (e.beginPath(), e.moveTo(s, l))), N = q = !1) : (b.lineTo(s, l), h.push({ x: s, y1: l, y2: r }), w && e.lineTo(s, l), 0 == g % 250 && d()); t = n.dataPointIds[g]; this._eventManager.objectMap[t] = {
                                                    id: t, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: s, y1: l,
                                                    y2: r
                                                }; g < p.length - 1 && (x !== (p[g].lineColor || v) || B !== (p[g].lineDashType || n.lineDashType)) && (d(), x = p[g].lineColor || v, h[h.length - 1].newStrokeStyle = x, b.strokeStyle = x, b.setLineDash && (p[g].lineDashType ? (B = p[g].lineDashType, h[h.length - 1].newLineDashArray = I(B, n.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (B = n.lineDashType, h[h.length - 1].newLineDashArray = E, b.setLineDash(E)))); if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < n.markerSize)) {
                                                    var Q = n.getMarkerProperties(g, s, r, b); f.push(Q); var fa = S(t);
                                                    w && f.push({ x: s, y: r, ctx: e, type: Q.type, size: Q.size, color: fa, borderColor: fa, borderThickness: Q.borderThickness }); Q = n.getMarkerProperties(g, s, l, b); f.push(Q); fa = S(t); w && f.push({ x: s, y: l, ctx: e, type: Q.type, size: Q.size, color: fa, borderColor: fa, borderThickness: Q.borderThickness })
                                                } if (p[g].indexLabel || n.indexLabel || p[g].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({
                                                    chartType: "rangeArea", dataPoint: p[g], dataSeries: n, indexKeyword: 0, point: { x: s, y: l }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ?
                                                        -1 : 1, color: y
                                        ...
                                        } else N || q || d(), N = !0; d(); $.drawMarkers(f)
                                    }
                                    ...
                                    this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(m.x1, m.y1, m.width, m.height), this._eventManager.ghostCtx.restore()); b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: O.xClipAnimation, easingFunction: O.easing.linear, animationBase: 0 }
                        }
                        ...
                        function d(a, c) {
                            var d = v(r, 2); if (0 < d.length) {
                                if (0 < k.lineThickness) {
                                    ...
                                    1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y); d = v(x, 2); b.lineTo(x[x.length - 1].x, x[x.length - 1].y); for (f = d.length - 1; 2 < f; f -= 3)b.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y), w && e.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y); b.closePath(); b.globalAlpha = k.fillOpacity; b.fill(); w && (e.closePath(), e.fill()); b.globalAlpha = 1; if (0 < k.lineThickness) {
                            ...
                            var e = this._eventManager.ghostCtx, f = [], m = this.plotArea; b.save(); w && e.save(); b.beginPath(); b.rect(m.x1, m.y1, m.width, m.height); b.clip(); w && (e.beginPath(), e.rect(m.x1, m.y1, m.width, m.height), e.clip()); for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                                var l =
                                    a.dataSeriesIndexes[h], k = this.data[l], n = k.dataPoints, f = k.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: l }; f = S(f); e.fillStyle = f; var f = [], p = 0, q, g, s, r = [], x = []; if (0 < n.length) {
                                        var t = k._colorSet[p % k._colorSet.length], A = k.lineColor = k.options.lineColor || t, y = A; b.fillStyle = t; b.lineWidth = k.lineThickness; var z = "solid", F; if (b.setLineDash) { var B = I(k.nullDataLineDashType, k.lineThickness), z = k.lineDashType; F = I(z, k.lineThickness) } for (g = !1; p < n.length; p++)if (q = n[p].x.getTime ? n[p].x.getTime() :
                                            n[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g))) if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                                                q = a.axisX.convertValueToPixel(q); g = a.axisY.convertValueToPixel(n[p].y[0]); s = a.axisY.convertValueToPixel(n[p].y[1]); var D = k.dataPointIds[p]; this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: p, x1: q, y1: g, y2: s }; r[r.length] = { x: q, y: g }; x[x.length] = { x: q, y: s }; p < n.length - 1 && (y !==
                                                    (n[p].lineColor || A) || z !== (n[p].lineDashType || k.lineDashType)) && (y = n[p].lineColor || A, r[r.length - 1].newStrokeStyle = y, b.setLineDash && (n[p].lineDashType ? (z = n[p].lineDashType, r[r.length - 1].newLineDashArray = I(z, k.lineThickness)) : (z = k.lineDashType, r[r.length - 1].newLineDashArray = F))); if (0 !== n[p].markerSize && (0 < n[p].markerSize || 0 < k.markerSize)) {
                                                        var E = k.getMarkerProperties(p, q, g, b); f.push(E); var N = S(D); w && f.push({ x: q, y: g, ctx: e, type: E.type, size: E.size, color: N, borderColor: N, borderThickness: E.borderThickness });
                                                        E = k.getMarkerProperties(p, q, s, b); f.push(E); N = S(D); w && f.push({ x: q, y: s, ctx: e, type: E.type, size: E.size, color: N, borderColor: N, borderThickness: E.borderThickness })
                                                    } if (n[p].indexLabel || k.indexLabel || n[p].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: k, indexKeyword: 0, point: { x: q, y: g }, direction: n[p].y[0] <= n[p].y[1] ? -1 : 1, color: t }), this._indexLabels.push({
                                                        chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: k, indexKeyword: 1, point: {
                                                            x: q,
                                                            y: s
                                                        }, direction: n[p].y[0] <= n[p].y[1] ? 1 : -1, color: t
                                                    }); g = !1
                                            } else 0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < r.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = B, z = k.nullDataLineDashType) : (d(F, A), r = [], x = [])), g = !0; d(F, A); $.drawMarkers(f)
                                    }
                        ...
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            ...
                            c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(f.x1, f.y1, f.width, f.height), this._eventManager.ghostCtx.clip()); for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                                var s = a.dataSeriesIndexes[g], r = this.data[s], v = r.dataPoints, e = r._colorSet[0]; r.risingColor = r.options.risingColor ? r.options.risingColor : e; r.fallingColor = r.options.fallingColor ? r.options.fallingColor : "#e40a0a"; var t = "number" === typeof r.options.lineThickness ? Math.round(r.lineThickness) : 1, A = 1 === Math.round(t) %
                                    2 ? -0.5 : 0; if (0 < v.length) for (var y = 5 < q && r.bevelEnabled ? !0 : !1, z = !1, x = null, B = null, m = 0; m < v.length; m++)if (v[m].getTime ? n = v[m].x.getTime() : n = v[m].x, "number" !== typeof v[m].y) { if (0 < m && !z && r.connectNullData) var D = r.options.nullDataLineDashType || !v[m - 1].lineDashType ? r.nullDataLineDashType : v[m - 1].lineDashType; z = !0 } else {
                                        h = a.axisX.convertValueToPixel(n); l = 0 === r.dataPointEOs[m].cumulativeSum ? p : a.axisY.convertValueToPixel(r.dataPointEOs[m].cumulativeSum); k = 0 === r.dataPointEOs[m].cumulativeSumYStartValue ? p : a.axisY.convertValueToPixel(r.dataPointEOs[m].cumulativeSumYStartValue);
                                        h = a.axisX.reversed ? h + a.plotType.totalDataSeries * q / 2 - (a.previousDataSeriesCount + g) * q << 0 : h - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount + g) * q << 0; var E = a.axisX.reversed ? h - q << 0 : h + q << 0; l > k && (e = l, l = k, k = e); a.axisY.reversed && (e = l, l = k, k = e); e = r.dataPointIds[m]; this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: s, dataPointIndex: m, x1: h, y1: l, x2: E, y2: k }; var N = v[m].color ? v[m].color : 0 < v[m].y ? r.risingColor : r.fallingColor; ea(c, a.axisX.reversed ? E : h, a.axisY.reversed ? k : l, a.axisX.reversed ?
                                            h : E, a.axisY.reversed ? l : k, N, 0, N, y, y, !1, !1, r.fillOpacity); e = S(e); w && ea(this._eventManager.ghostCtx, a.axisX.reversed ? E : h, l, a.axisX.reversed ? h : E, k, e, 0, null, !1, !1, !1, !1); var Q, N = h; Q = "undefined" !== typeof v[m].isIntermediateSum && !0 === v[m].isIntermediateSum || "undefined" !== typeof v[m].isCumulativeSum && !0 === v[m].isCumulativeSum ? 0 < v[m].y ? l : k : 0 < v[m].y ? k : l; 0 < m && x && (!z || r.connectNullData) && (z && c.setLineDash && c.setLineDash(I(D, t)), c.beginPath(), c.moveTo(x, B - A), c.lineTo(N, Q - A), 0 < t && c.stroke(), w && (b.beginPath(), b.moveTo(x,
                                                B - A), b.lineTo(N, Q - A), 0 < t && b.stroke())); z = !1; x = E; B = 0 < v[m].y ? l : k; N = v[m].lineDashType ? v[m].lineDashType : r.options.lineDashType ? r.options.lineDashType : "shortDash"; c.strokeStyle = v[m].lineColor ? v[m].lineColor : r.options.lineColor ? r.options.lineColor : "#9e9e9e"; c.lineWidth = t; c.setLineDash && (N = I(N, t), c.setLineDash(N)); (v[m].indexLabel || r.indexLabel || v[m].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                                    chartType: "waterfall", dataPoint: v[m], dataSeries: r, point: { x: h + (E - h) / 2, y: 0 <= v[m].y ? l : k },
                                                    direction: 0 > v[m].y === a.axisY.reversed ? 1 : -1, bounds: { x1: h, y1: Math.min(l, k), x2: E, y2: Math.max(l, k) }, color: e
                                                })
                                    }
                            } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(f.x1, f.y1, f.width,
                                f.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: O.fadeInAnimation, easingFunction: O.easing.easeInQuad, animationBase: 0 }
                        }
                    }; var ia = function (a, d, c, b, e, f, m, h, l) {
                        if (!(0 > c)) {
                            "undefined" === typeof h && (h = 1); if (!w) { var k = Number((m % (2 * Math.PI)).toFixed(8)); Number((f % (2 * Math.PI)).toFixed(8)) === k && (m -= 1E-4) } a.save(); a.globalAlpha = h; "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, m, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth =
                        ...
                        function d() {
                            if (k && n) {
                                for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                                    var f = n[e], m = k.dataPointIds[e]; g[e].id = m; g[e].objectType = "dataPoint"; g[e].dataPointIndex = e; g[e].dataSeriesIndex = 0; var h = g[e], p = { percent: null, total: null }, u = null, p = l.getPercentAndTotal(k,
                                    ...
                                    h.indexLabelLineColor = f.indexLabelLineColor ? f.indexLabelLineColor : k.options.indexLabelLineColor ? k.options.indexLabelLineColor : f.color ? f.color : k._colorSet[e % k._colorSet.length]; h.indexLabelLineThickness = r(f.indexLabelLineThickness) ? k.indexLabelLineThickness : f.indexLabelLineThickness; h.indexLabelLineDashType = f.indexLabelLineDashType ? f.indexLabelLineDashType : k.indexLabelLineDashType; h.indexLabelFontColor = f.indexLabelFontColor ? f.indexLabelFontColor : k.indexLabelFontColor; h.indexLabelFontStyle = f.indexLabelFontStyle ?
                                        f.indexLabelFontStyle : k.indexLabelFontStyle; h.indexLabelFontWeight = f.indexLabelFontWeight ? f.indexLabelFontWeight : k.indexLabelFontWeight; h.indexLabelFontSize = r(f.indexLabelFontSize) ? k.indexLabelFontSize : f.indexLabelFontSize; h.indexLabelFontFamily = f.indexLabelFontFamily ? f.indexLabelFontFamily : k.indexLabelFontFamily; h.indexLabelBackgroundColor = f.indexLabelBackgroundColor ? f.indexLabelBackgroundColor : k.options.indexLabelBackgroundColor ? k.options.indexLabelBackgroundColor : k.indexLabelBackgroundColor; h.indexLabelMaxWidth =
                                            f.indexLabelMaxWidth ? f.indexLabelMaxWidth : k.indexLabelMaxWidth ? k.indexLabelMaxWidth : 0.33 * q.width; h.indexLabelWrap = "undefined" !== typeof f.indexLabelWrap ? f.indexLabelWrap : k.indexLabelWrap; h.indexLabelTextAlign = f.indexLabelTextAlign ? f.indexLabelTextAlign : k.indexLabelTextAlign ? k.indexLabelTextAlign : "left"; h.startAngle = 0 === e ? k.startAngle ? k.startAngle / 180 * Math.PI : 0 : g[e - 1].endAngle; h.startAngle = (h.startAngle + 2 * Math.PI) % (2 * Math.PI); h.endAngle = h.startAngle + 2 * Math.PI / z * Math.abs(f.y); f = (h.endAngle + h.startAngle) /
                                                2; f = (f + 2 * Math.PI) % (2 * Math.PI); h.midAngle = f; if (h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t) { if (0 === a || g[c].midAngle > h.midAngle) c = e; a++ } else if (h.midAngle > 3 * Math.PI / 2 - t && h.midAngle < 3 * Math.PI / 2 + t) { if (0 === b || g[d].midAngle > h.midAngle) d = e; b++ } h.hemisphere = f > Math.PI / 2 && f <= 3 * Math.PI / 2 ? "left" : "right"; h.indexLabelTextBlock = new ja(l.plotArea.ctx, {
                                ...
                                } m = f = 0; p = !1; for (e = 0; e < n.length; e++)h = g[(c + e) % n.length], 1 < a && (h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !p ? (h.hemisphere = "right", f++) : (h.hemisphere = "left", p = !0)); p = !1; for (e = 0; e < n.length; e++)h = g[(d + e) % n.length], 1 < b && (h.midAngle >
                            ...
                            var b = l.plotArea.ctx; b.clearRect(q.x1, q.y1, q.width, q.height); b.fillStyle = l.backgroundColor; b.fillRect(q.x1, q.y1, q.width, q.height); for (b = 0; b < n.length; b++) {
                                var c = g[b].startAngle, d = g[b].endAngle; if (d > c) {
                                    var e = 0.07 * B * Math.cos(g[b].midAngle), f = 0.07 * B * Math.sin(g[b].midAngle), m = !1; if (n[b].exploded) {
                                        if (1E-9 < Math.abs(g[b].center.x - (y.x + e)) || 1E-9 < Math.abs(g[b].center.y - (y.y + f))) g[b].center.x =
                                            y.x + e * a, g[b].center.y = y.y + f * a, m = !0
                                    } else if (0 < Math.abs(g[b].center.x - y.x) || 0 < Math.abs(g[b].center.y - y.y)) g[b].center.x = y.x + e * (1 - a), g[b].center.y = y.y + f * (1 - a), m = !0; m && (e = {}, e.dataSeries = k, e.dataPoint = k.dataPoints[b], e.index = b, l.toolTip.highlightObjects([e])); ia(l.plotArea.ctx, g[b].center, g[b].radius, n[b].color ? n[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius)
                                }
                            } a = l.plotArea.ctx; a.save(); a.fillStyle = "black"; a.strokeStyle = "grey"; a.textBaseline = "middle"; a.lineJoin =
                            ...
                            d = (d || 0) + 1; if (1E3 < d) return 0; c = c || 0; var m = 0, k = y.y - 1 * w, h = y.y + 1 * w; if (0 <= a && a < n.length) {
                            ...
                            var a = l.plotArea.ctx; a.fillStyle = "grey"; a.strokeStyle = "grey"; a.font = "16px Arial"; a.textBaseline = "middle"; for (var c = a = 0, d = 0, m = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                                if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius &&
                                    B - d <= D) m = !1; m && (B -= d); d = 0; if ("inside" !== k.indexLabelPlacement) {
                                        w = B * v; for (a = 0; a < n.length; a++) { var h = g[a]; h.indexLabelTextBlock.x = y.x + w * Math.cos(h.midAngle); h.indexLabelTextBlock.y = y.y + w * Math.sin(h.midAngle); h.indexLabelAngle = h.midAngle; h.radius = B; h.percentInnerRadius = E } for (var u, r, a = 0; a < n.length; a++) {
                                            var h = g[a], t = e(a); if (null !== t) {
                                                u = g[a]; r = g[t]; var z = 0, z = b(u, r) - s; if (0 > z) {
                                                    for (var x = r = 0, F = 0; F < n.length; F++)F !== a && g[F].hemisphere === h.hemisphere && (g[F].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? r++ :
                                                        x++); r = z / (r + x || 1) * x; var x = -1 * (z - r), I = F = 0; "right" === h.hemisphere ? (F = f(a, r), x = -1 * (z - F), I = f(t, x), +I.toFixed(A) < +x.toFixed(A) && +F.toFixed(A) <= +r.toFixed(A) && f(a, -(x - I))) : (F = f(t, r), x = -1 * (z - F), I = f(a, x), +I.toFixed(A) < +x.toFixed(A) && +F.toFixed(A) <= +r.toFixed(A) && f(t, -(x - I)))
                                                }
                                            }
                                        }
                                    } else for (a = 0; a < n.length; a++)h = g[a], w = "pie" === k.type ? 0.7 * B : 0.8 * B, t = y.x + w * Math.cos(h.midAngle), r = y.y + w * Math.sin(h.midAngle), h.indexLabelTextBlock.x = t, h.indexLabelTextBlock.y = r; for (a = 0; a < n.length; a++)if (h = g[a], t = h.indexLabelTextBlock.measureText(),
                            ...
                            var k = this.data[a.dataSeriesIndexes[0]], n = k.dataPoints, p = 10, q = this.plotArea, g = k.dataPointEOs, s = 2, w, v = 1.3, t = 20 / 180 * Math.PI, A = 6, y = { x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2 }, z = 0; a = !1; for (var x = 0; x < n.length; x++)z += Math.abs(n[x].y), !a && ("undefined" !== typeof n[x].indexLabel && null !== n[x].indexLabel && 0 < n[x].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof n[x].label && null !== n[x].label &&
                                0 < n[x].label.toString().length) && (a = !0); if (0 !== z) {
                                    a = a || "undefined" !== typeof k.indexLabel && null !== k.indexLabel && 0 < k.indexLabel.toString().length; var B = "inside" !== k.indexLabelPlacement && a ? 0.75 * Math.min(q.width, q.height) / 2 : 0.92 * Math.min(q.width, q.height) / 2; k.radius && (B = Ua(k.radius, B)); var D = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ua(k.innerRadius, B) : 0.7 * B; k.radius = B; "doughnut" === k.type && (k.innerRadius = D); var E = Math.min(D / B, (B - 1) / B); this.pieDoughnutClickHandler = function (a) {
                                        l.isAnimating ||
                                        !r(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && l._animator.animate(0, 500, function (a) { c(a); h(); l.dispatchEvent("dataAnimationIterationEnd", { chart: l }); l.dispatchEvent("dataAnimationEnd", { chart: l }) }))
                                    }; d(); m(); m(); m(); m(); this.disableToolTip = !0; this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                                        var b = l.plotArea.ctx; b.clearRect(q.x1, q.y1, q.width, q.height); b.fillStyle = l.backgroundColor; b.fillRect(q.x1,
                                            q.y1, q.width, q.height); for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < n.length; c++) { var d = 0 === c ? g[c].startAngle : e, e = d + (g[c].endAngle - g[c].startAngle), f = !1; e > b && (e = b, f = !0); var m = n[c].color ? n[c].color : k._colorSet[c % k._colorSet.length]; e > d && ia(l.plotArea.ctx, g[c].center, g[c].radius, m, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius); if (f) break } h(); l.dispatchEvent("dataAnimationIterationEnd", { chart: l }); 1 <= a && l.dispatchEvent("dataAnimationEnd", { chart: l })
                                    }, function () {
                                        l.disableToolTip = !1; l._animator.animate(0,
                                            l.animatedRender ? 500 : 0, function (a) { c(a); h(); l.dispatchEvent("dataAnimationIterationEnd", { chart: l }) }); l.dispatchEvent("dataAnimationEnd", { chart: l })
                                    })
                                }
                        }
                        ...
                        function d() { for (var a = 0, b = [], c = 0; c < A.length; c++) { if ("undefined" === typeof A[c].y) return -1; A[c].y = "number" === typeof A[c].y ? A[c].y : 0; a += Math.abs(A[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < A.length; c++)b.push(Math.abs(A[c].y) * E / a); return b } function c() {
                            var a = W, b = U, c = M, d = $, e, f; e = L; f = P - ba; d = Math.abs((f - e) * (b - a + (d - c)) / 2); c = $ - M; e = f - e; f = c * (f - P); f = Math.abs(f);
                            ...
                            if (t && A) {
                                for (var a, b, c, d, e, f, k, m, h, n, p, q, l, u, s, C = [], y = [], v = { percent: null, total: null }, z = null, B = 0; B < A.length; B++)s = R[B], s = "undefined" !== typeof s.x5 ? (s.y2 + s.y4) / 2 : (s.y2 + s.y3) / 2, s = g(s).x2 + 1, C[B] = K - s - T; s = 0.5 * T; for (var B = 0, D = A.length - 1; B < A.length || 0 <= D; B++, D--) {
                                    b = t.reversed ? A[D] : A[B]; a = b.color ? b.color : t.reversed ? t._colorSet[(A.length - 1 - B) % t._colorSet.length] : t._colorSet[B % t._colorSet.length]; c = b.indexLabelPlacement || t.indexLabelPlacement || "outside"; u = b.indexLabelTextAlign ||
                            ...
                            function a(b, c) { var d; if (0 > b || b >= H.length) return 0; var e, f = H[b].textBlock; if (0 > c) { c *= -1; e = p(b); d = h(e, b); if (d >= c) return f.y -= c, c; if (0 == b) return 0 < d && (f.y -= d), d; d += a(e, -(c - d)); 0 < d && (f.y -= d); return d } e = q(b); d = h(b, e); if (d >= c) return f.y += c, c; if (b == R.length - 1) return 0 < d && (f.y += d), d; d += a(e, c - d); 0 < d && (f.y += d); return d } function b() {
                                var a, d, e, f, g = 0, m; f = (P - L + 2 * z) / n; m = n; for (var k, h = 1; h < m; h++) {
                                    e = h * f; for (var l = H.length - 1; 0 <= l; l--)!H[l].isDirty && (H[l].textBlock.y <
                                    ...
                                    e = p(k); if (0 > e && (e = 0, H[e].isDirty)) break; if (H[k].textBlock.y < H[e].textBlock.y + H[e].height) {
                                        d = d || k; f = k; for (m = 0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + da;) {
                                            a = a || H[f].textBlock.y + H[f].height; m += H[f].height; m += da; f = e; if (0 >= f) { f = 0; m += H[f].height; break } e = p(f);
                                            if (0 > e) { f = 0; m += H[f].height; break }
                                        } if (f != k) { g = H[f].textBlock.y; a -= g; a = m - a; g = c(a, d, f); break }
                                    }
                                } return g
                            } function c(a, b, d) { var e = [], f = 0, g = 0; for (a = Math.abs(a); d <= b; d++)e.push(R[d]); e.sort(function (a, b) { return a.height - b.height }); for (d = 0; d < e.length; d++)if (b = e[d], f < a) g++, f += H[b.id].height + da, H[b.id].textBlock.text = "", H[b.id].indexLabelText = "", H[b.id].isDirty = !0, H[b.id].textBlock.measureText(); else break; return g } for (var d, e, f, g, m, k, n = 1, l = 0; l < 2 * n; l++) {
                                for (var s = H.length - 1; 0 <= s && !(0 <= p(s) && p(s), f = H[s], g = f.textBlock,
                                    k = (m = q(s) < R.length ? H[q(s)] : null) ? m.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (m && e + d + da > +k.y.toFixed(6)) && (d = g.y + d + da - k.y, e = a(s, -d), e < d && (0 < e && (d -= e), e = a(q(s), d), e != d))); s--); b()
                            }
                        } function h(a, b) { return (b < R.length ? H[b].textBlock.y : t.reversed ? na + z : sa + z) - (0 > a ? t.reversed ? sa - z : na - z : H[a].textBlock.y + H[a].height + da) } function l(a, b, c) {
                            var d, e, g, m = [], h = z, p = []; -1 !== b && (0 <= X.indexOf(b) ? (e = X.indexOf(b), X.splice(e, 1)) : (X.push(b), X = X.sort(function (a, b) { return a - b }))); if (0 === X.length) m =
                                ia; else { e = z * (1 != X.length || 0 != X[0] && X[0] != R.length - 1 ? 2 : 1) / k(); for (var q = 0; q < R.length; q++) { if (1 == X.length && 0 == X[0]) { if (0 === q) { m.push(ia[q]); d = h; continue } } else 0 === q && (d = -1 * h); m.push(ia[q] + d); if (0 <= X.indexOf(q) || q < R.length && 0 <= X.indexOf(q + 1)) d += e } } g = function () { for (var a = [], b = 0; b < R.length; b++)a.push(m[b] - R[b].y1); return a }(); var u = {
                                    ...
                                    for (e = 0; e < R.length; e++)pa(d, R[e], t.fillOpacity); v(d); N && ("inside" !== t.indexLabelPlacement ? n(d) : f(), s(d)); 1 <= c && (ha = !1)
                                }, null, O.easing.easeOutQuart)
                        } function k() { for (var a = 0, b = 0; b < R.length - 1; b++)(0 <= X.indexOf(b) || 0 <= X.indexOf(b + 1)) && a++; return a } function n(a) {
                            ...
                            for (var b, c = 0; c < A.length; c++)if (R[c].y1 < a && R[c].y4 > a) { b = R[c]; break } return b ? (a = b.y6 ? a > b.y6 ? b.x3 + (b.x4 - b.x3) / (b.y4 - b.y3) * (a - b.y3) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2),
                                { x1: a, x2: a }) : -1
                        } function s(a) { for (var b = 0; b < R.length; b++)H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.render(!0)) } function v(a) {
                            x.plotArea.layoutManager.reset(); a.roundRect || Ea(a); x.title && (x.title.dockInsidePlotArea || "center" === x.title.horizontalAlign && "center" === x.title.verticalAlign) && (x.title.ctx = a, x.title.render()); if (x.subtitles) for (var b = 0; b < x.subtitles.length; b++) {
                                var c = x.subtitles[b]; if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) x.subtitles.ctx =
                                    a, c.render()
                            } x.legend && (x.legend.dockInsidePlotArea || "center" === x.legend.horizontalAlign && "center" === x.legend.verticalAlign) && (x.legend.ctx = a, x.legend.setLayout(), x.legend.render()); Y.fNg && Y.fNg(x)
                        } var x = this; if (!(0 >= a.dataSeriesIndexes.length)) {
                            for (var t = this.data[a.dataSeriesIndexes[0]], A = t.dataPoints, y = this.plotArea, z = 0.025 * y.width, D = 0.01 * y.width, B = 0, E = y.height - 2 * z, J = Math.min(y.width - 2 * D, 2.8 * y.height), N = !1, Q = 0; Q < A.length; Q++)if (!N && ("undefined" !== typeof A[Q].indexLabel && null !== A[Q].indexLabel &&
                                0 < A[Q].indexLabel.toString().length) && (N = !0), !N && ("undefined" !== typeof A[Q].label && null !== A[Q].label && 0 < A[Q].label.toString().length) && (N = !0), !N && "function" === typeof t.indexLabelFormatter || "function" === typeof A[Q].indexLabelFormatter) N = !0; N = N || "undefined" !== typeof t.indexLabel && null !== t.indexLabel && 0 < t.indexLabel.toString().length; "inside" !== t.indexLabelPlacement && N || (D = (y.width - 0.75 * J) / 2); var Q = y.x1 + D, K = y.x2 - D, L = y.y1 + z, P = y.y2 - z, S = a.targetCanvasCtx || this.plotArea.ctx || this.ctx; if (0 != t.length && (t.dataPoints &&
                                    t.visible) && 0 !== A.length) {
                                        var ba, G; a = 75 * J / 100; var T = 30 * (K - a) / 100; "funnel" === t.type ? (ba = r(t.options.neckHeight) ? 0.35 * E : t.neckHeight, G = r(t.options.neckWidth) ? 0.25 * a : t.neckWidth, "string" === typeof ba && ba.match(/%$/) ? (ba = parseInt(ba), ba = ba * E / 100) : ba = parseInt(ba), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G = parseInt(G), ba > E ? ba = E : 0 >= ba && (ba = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === t.type && (G = ba = 0, t.reversed = t.reversed ? !1 : !0); var D = Q + a / 2, W = Q, U = Q + a, na = t.reversed ? P : L, M = D - G / 2, $ = D + G / 2, ya = t.reversed ?
                                            L + ba : P - ba, sa = t.reversed ? L : P; a = []; var D = [], R = [], J = [], Z = L, ca, V = (ya - na) / (M - W), ea = -V, Q = "area" === (t.valueRepresents ? t.valueRepresents : "height") ? c() : d(); if (-1 !== Q) {
                                                if (t.reversed) for (J.push(Z), G = Q.length - 1; 0 < G; G--)Z += Q[G], J.push(Z); else for (G = 0; G < Q.length; G++)Z += Q[G], J.push(Z); if (t.reversed) for (G = 0; G < Q.length; G++)J[G] < ya ? (a.push(M), D.push($), ca = G) : (a.push((J[G] - na + V * W) / V), D.push((J[G] - na + ea * U) / ea)); else for (G = 0; G < Q.length; G++)J[G] < ya ? (a.push((J[G] - na + V * W) / V), D.push((J[G] - na + ea * U) / ea), ca = G) : (a.push(M), D.push($));
                                                for (G = 0; G < Q.length - 1; G++)Z = t.reversed ? A[A.length - 1 - G].color ? A[A.length - 1 - G].color : t._colorSet[(A.length - 1 - G) % t._colorSet.length] : A[G].color ? A[G].color : t._colorSet[G % t._colorSet.length], G === ca ? R.push({ x1: a[G], y1: J[G], x2: D[G], y2: J[G], x3: $, y3: ya, x4: D[G + 1], y4: J[G + 1], x5: a[G + 1], y5: J[G + 1], x6: M, y6: ya, id: G, height: J[G + 1] - J[G], color: Z }) : R.push({ x1: a[G], y1: J[G], x2: D[G], y2: J[G], x3: D[G + 1], y3: J[G + 1], x4: a[G + 1], y4: J[G + 1], id: G, height: J[G + 1] - J[G], color: Z }); var da = 2, H = [], ha = !1, X = [], ia = [], Q = !1; a = a = 0; Fa(X); for (G = 0; G < A.length; G++)A[G].exploded &&
                                                    (Q = !0, t.reversed ? X.push(A.length - 1 - G) : X.push(G)); S.clearRect(y.x1, y.y1, y.width, y.height); S.fillStyle = x.backgroundColor; S.fillRect(y.x1, y.y1, y.width, y.height); if (N && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) { m(); for (G = 0; G < A.length; G++)H[G].isDirty || (a = H[G].textBlock.x + H[G].width, a = (K - a) / 2, 0 == G && (B = a), B > a && (B = a)); for (G = 0; G < R.length; G++)R[G].x1 += B, R[G].x2 += B, R[G].x3 += B, R[G].x4 += B, R[G].x5 && (R[G].x5 += B, R[G].x6 += B), H[G].textBlock.x += B } for (G = 0; G < R.length; G++)B = R[G], pa(S, B, t.fillOpacity),
                                                        ia.push(B.y1); v(S); N && t.visible && ("inside" === t.indexLabelPlacement || x.animationEnabled || n(S), x.animationEnabled || s()); if (!N) for (G = 0; G < A.length; G++)B = t.dataPointIds[G], a = { id: B, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: R[t.reversed ? A.length - 1 - G : G] }, x._eventManager.objectMap[B] = a; !x.animationEnabled && Q ? l(x, -1, 0) : x.animationEnabled && !x.animatedRender && l(x, -1, 0); this.funnelPyramidClickHandler = function (a) {
                                                            var b = -1; if (!ha && !x.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) &&
                                                                (b = t.reversed ? A.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) { a = b; if ("funnel" === t.type || "pyramid" === t.type) t.reversed ? A[A.length - 1 - a].exploded = A[A.length - 1 - a].exploded ? !1 : !0 : A[a].exploded = A[a].exploded ? !1 : !0; l(x, b, 500) }
                                                        }; return { source: S, dest: this.plotArea.ctx, animationCallback: function (a, b) { O.fadeInAnimation(a, b); 1 <= a && (l(x, -1, 500), v(x.plotArea.ctx || x.ctx)) }, easingFunction: O.easing.easeInQuad, animationBase: 0 }
                                            }
                            }
                        }
                        ...
                        a = "undefined" === typeof a ? {} : a; var d = a.format ? a.format : "png", c = a.fileName ? a.fileName : this.exportFileName; if (a.toDataURL) return this.canvas.toDataURL("image/" + d); var b = this.canvas; if (b && d && c) {
                            c = c + "." + d; a = "image/" + d; var b = b.toDataURL(a), e = !1, f = document.createElement("a"); f.download = c; f.href = b; if ("undefined" !== typeof Blob && new Blob) {
                                for (var m = b.replace(/^data:[a-z\/]*;base64,/, ""), m = atob(m), h = new ArrayBuffer(m.length), h = new Uint8Array(h), l = 0; l < m.length; l++)h[l] =
                                    m.charCodeAt(l); d = new Blob([h.buffer], { type: "image/" + d }); try { window.navigator.msSaveBlob(d, c), e = !0 } catch (k) { f.dataset.downloadurl = [a, f.download, f.href].join(":"), f.href = window.URL.createObjectURL(d) }
                    ...
                    }; oa(E, Z); E.prototype.setLayout = function () {
                        var a = this.dockInsidePlotArea ? this.chart.plotArea :
                            this.chart, d = a.layoutManager.getFreeSpace(), c = null, b = 0, e = 0, f = 0, m = 0, h = this.markerMargin = this.chart.options.legend && !r(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize; this.height = 0; var l = [], k = []; if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, m = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height; else if ("center" === this.verticalAlign) {
                                this.orientation =
                                "vertical"; if ("left" === this.horizontalAlign || "center" === this.horizontalAlign || "right" === this.horizontalAlign) c = this.horizontalAlign; f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * d.width; m = this.maxHeight = null !== this.maxHeight ? this.maxHeight : d.height
                                    ...
                                    var q = p.legendMarkerType = p.legendMarkerType ?
                                        p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : L.getDefaultLegendMarker(p._linkedSeries.type) : L.getDefaultLegendMarker(p.type) : p.markerType, g = p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: p, dataPoint: null }) : p.name, s = p.legendMarkerColor = p.legendMarkerColor ?
                                            p.legendMarkerColor : p.markerColor ? p.markerColor : "error" === p.type ? r(p.whiskerColor) ? p._colorSet[0] : p.whiskerColor : p._colorSet[0], w = p.markerSize || "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type ? 0.75 * this.lineHeight : 0, v = p.legendMarkerBorderColor ? p.legendMarkerBorderColor : p.markerBorderColor, t = p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : p.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0; "error" === p.type && this.errorMarkerColor.push(s); g = this.chart.replaceKeywordsWithValue(g,
                                                p.dataPoints[0], p, n); q = { markerType: q, markerColor: s, text: g, textBlock: null, chartType: p.type, markerSize: w, lineColor: p._colorSet[0], dataSeriesIndex: p.index, dataPointIndex: null, markerBorderColor: v, markerBorderThickness: t }; l.push(q)
                                } else for (var A = 0; A < p.dataPoints.length; A++) {
                                    var y = p.dataPoints[A], q = y.legendMarkerType ? y.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : L.getDefaultLegendMarker(p.type), g = y.legendText ? y.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                                        chart: this.chart,
                                        legend: this.options, dataSeries: p, dataPoint: y
                                    }) : y.name ? y.name : "DataPoint: " + (A + 1), s = y.legendMarkerColor ? y.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : y.color ? y.color : p.color ? p.color : p._colorSet[A % p._colorSet.length], w = 0.75 * this.lineHeight, v = y.legendMarkerBorderColor ? y.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : y.markerBorderColor ? y.markerBorderColor : p.markerBorderColor, t = y.legendMarkerBorderThickness ? y.legendMarkerBorderThickness : p.legendMarkerBorderThickness ?
                                        p.legendMarkerBorderThickness : y.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0, g = this.chart.replaceKeywordsWithValue(g, y, p, A), q = { markerType: q, markerColor: s, text: g, textBlock: null, chartType: p.type, markerSize: w, dataSeriesIndex: n, dataPointIndex: A, markerBorderColor: v, markerBorderThickness: t }; (y.showInLegend || p.showInLegend && !1 !== y.showInLegend) && l.push(q)
                                }
                            } !0 === this.reversed && l.reverse(); if (0 < l.length) {
                                p = null; s = g = y = A = 0; y = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth,
                                    this.itemMaxWidth, f) : this.itemMaxWidth = Math.min(this.itemWidth, f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : this.itemMaxWidth = f; w = 0 === w ? 0.75 * this.lineHeight : w; y -= w + h; for (n = 0; n < l.length; n++) {
                                        q = l[n]; v = y; if ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType) v -= 2 * 0.1 * this.lineHeight; if (!(0 >= m || "undefined" === typeof m || 0 >= v || "undefined" === typeof v)) {
                                            if ("horizontal" === this.orientation) {
                                                q.textBlock = new ja(this.ctx, {
                                                    x: 0, y: 0, maxWidth: v, maxHeight: this.itemWrap ? m : this.lineHeight,
                                                    angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle"
                                                }); q.textBlock.measureText(); null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))); if (!p || p.width + Math.round(q.textBlock.width + w + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" ===
                                                    q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) p = { items: [], width: 0 }, k.push(p), this.height += g, g = 0; g = Math.max(g, q.textBlock.height)
                                            } else q.textBlock = new ja(this.ctx, { x: 0, y: 0, maxWidth: y, maxHeight: !0 === this.itemWrap ? m : 1.5 * this.fontSize, angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" }), q.textBlock.measureText(), null !== this.itemWidth && (q.textBlock.width =
                                                this.itemWidth - (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < m - this.lineHeight ? (p = { items: [], width: 0 }, k.push(p)) : (p = k[A], A = (A + 1) % k.length), this.height += q.textBlock.height; q.textBlock.x = p.width; q.textBlock.y = 0; p.width += Math.round(q.textBlock.width + w + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)); p.items.push(q); this.width = Math.max(p.width,
                                                    this.width); s = q.textBlock.width + (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))
                                        }
                                    } this.itemWidth = s; this.height = !1 === this.itemWrap ? k.length * this.lineHeight : this.height + g; this.height = Math.min(m, this.height); this.width = Math.min(f, this.width)
                        ...
                        this.markerSize = w; this.rows = k; 0 < l.length && a.layoutManager.registerSpace(c, { width: this.width + 2 + 2, height: this.height + 5 + 5 }); this.bounds = { x1: e, y1: b, x2: e + this.width, y2: b + this.height }
                    }; E.prototype.render = function () {
                        var a = this.bounds.x1, d = this.bounds.y1, c = this.markerMargin, b = this.maxWidth, e = this.maxHeight, f = this.markerSize, m = this.rows; (0 < this.borderThickness && this.borderColor || this.backgroundColor) && this.ctx.roundRect(a, d, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor,
                            this.borderColor); for (var h = 0, l = 0; l < m.length; l++) {
                                for (var k = m[l], n = 0, p = 0; p < k.items.length; p++) {
                                    var q = k.items[p], g = q.textBlock.x + a + (0 === p ? 0.2 * f : this.horizontalSpacing), s = d + h, r = g; this.chart.data[q.dataSeriesIndex].visible || (this.ctx.globalAlpha = 0.5); this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(a, d, b, Math.max(e - e % this.lineHeight, 0)); this.ctx.clip(); if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight /
                                        8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, s + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, s + this.lineHeight / 2), this.ctx.stroke(), r -= 0.1 * this.lineHeight; if ("error" === q.chartType) {
                                            this.ctx.strokeStyle = this.errorMarkerColor[0]; this.ctx.lineWidth = f / 8; this.ctx.beginPath(); var w = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight, t = s + 0.15 * this.lineHeight, v = 0.7 * this.lineHeight, y = v + 0.02 * this.lineHeight; this.ctx.moveTo(w, t); this.ctx.lineTo(w + v, t); this.ctx.stroke(); this.ctx.beginPath();
                                            this.ctx.moveTo(w + v / 2, t); this.ctx.lineTo(w + v / 2, t + y); this.ctx.stroke(); this.ctx.beginPath(); this.ctx.moveTo(w, t + y); this.ctx.lineTo(w + v, t + y); this.ctx.stroke(); this.errorMarkerColor.shift()
                                        } $.drawMarker(g + f / 2, s + this.lineHeight / 2, this.ctx, q.markerType, "error" === q.chartType || "line" === q.chartType || "spline" === q.chartType ? q.markerSize / 2 : q.markerSize, q.markerColor, q.markerBorderColor, q.markerBorderThickness); q.textBlock.x = g + c + f; if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) q.textBlock.x +=
                    ...
                    }; oa(L, Z); L.prototype.getDefaultAxisPlacement = function () {
                        ...
                        if (!this.dataPoints || 0 === this.dataPoints.length) return null; var c = { dataPoint: null, distance: Infinity, index: NaN }, b = null, e = 0, f = 0, m = 1, h = Infinity, l = 0, k = 0, n = 0; "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ? (n = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), n = 1 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * Math.log(a / this.dataPoints[0].x) >>
                            0, 0), this.dataPoints.length) : 0) : (n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, n = 0 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0)); for (; ;) {
                                f = 0 < m ? n + e : n - e; if (0 <= f && f < this.dataPoints.length) { var b = this.dataPoints[f], p = this.axisX.logarithmic ? b.x > a ? b.x / a : a / b.x : Math.abs(b.x - a); p < c.distance && (c.dataPoint = b, c.distance = p, c.index = f); b = p; b <= h ? h = b : 0 < m ? l++ : k++; if (1E3 < l && 1E3 < k) break } else if (0 > n - e && n + e >= this.dataPoints.length) break;
                                -1 === m ? (e++, m = 1) : m = -1
                        ...
                        if (!this.dataPoints || 0 === this.dataPoints.length || a < this.chart.plotArea.x1 || a > this.chart.plotArea.x2 || d < this.chart.plotArea.y1 || d > this.chart.plotArea.y2) return null; c = c || !1; var b = [], e = 0, f = 0, m = 1, h = !1, l = Infinity, k = 0, n = 0, p = 0; if ("none" !== this.chart.plotInfo.axisPlacement) if (p = (this.chart.axisX[0] ? this.chart.axisX[0] :
                            this.chart.axisX2[0]).getXValueAt({ x: a, y: d }), this.axisX.logarithmic) var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), p = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(p / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, p = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (p - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; for (; ;) {
                                f = 0 < m ? p + e : p - e; if (0 <= f && f < this.dataPoints.length) {
                                    var q =
                                        this.chart._eventManager.objectMap[this.dataPointIds[f]], g = this.dataPoints[f], s = null; if (q) {
                                            switch (this.type) {
                        ...
                        a = (a || 0) + 1; if (!(5 < a)) {
                            var d = this.logLabelValues[0] || this.intervalStartPosition; if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
                                for (var c = D.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < d; b += c)b < this.viewportMinimum || this.logLabelValues.push(b); this.logLabelValues.sort(Sa);
                                this.createExtraLabelsForLog(a)
                            }
                        }
                    }; D.prototype.createLabels = function () {
                        var a, d, c = 0, b = 0, e, f = 0, m = 0, b = 0, b = this.interval, h = 0, l, k = 0.6 * this.chart.height, n; a = !1; var p = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], q = p.length ? r(this.scaleBreaks.firstBreakIndex) ? 0 : this.scaleBreaks.firstBreakIndex : 0; if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                            e = this.viewportMaximum; if (this.labels) {
                                a = Math.ceil(b); for (var b = Math.ceil(this.intervalStartPosition), g = !1, c = b; c < this.viewportMaximum; c +=
                                    a)if (this.labels[c]) g = !0; else { g = !1; break } g && (this.interval = a, this.intervalStartPosition = b)
                                ...
                                for (; g < p.length && c > p[g].endValue; g++); a = g < p.length && c >= p[g].startValue && c <= p[g].endValue; n = c; a || (a = this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart, axis: this.options, value: n,
                                ...
                                for (; g < p.length && c > p[g].endValue; g++); a = g < p.length && c >= p[g].startValue &&
                                    c <= p[g].endValue; n = c; a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: n, label: this.labels[n] ? this.labels[n] : null }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : da(n, this.valueFormatString, this.chart._cultureInfo), a = new ja(this.ctx, {
                                        x: 0, y: 0, maxWidth: f, maxHeight: m, angle: this.labelAngle, text: this.prefix + a + this.suffix, textAlign: this.labelTextAlign, backgroundColor: this.labelBackgroundColor, borderColor: this.labelBorderColor, borderThickness: this.labelBorderThickness,
                        ...
                        } else for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Ya(new Date(this.viewportMaximum), this.interval, this.intervalType), g = q, c = this.intervalStartPosition; c <
                            e; Ya(c, b, this.intervalType)) {
                                for (a = c.getTime(); g < p.length && a > p[g].endValue; g++); n = a; a = g < p.length && a >= p[g].startValue && a <= p[g].endValue; a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: new Date(n), label: this.labels[n] ? this.labels[n] : null }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : Da(n, this.valueFormatString, this.chart._cultureInfo), a = new ja(this.ctx, {
                                    x: 0, y: 0, maxWidth: f, backgroundColor: this.labelBackgroundColor, borderColor: this.labelBorderColor, borderThickness: this.labelBorderThickness,
                            ...
                            (m = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize); else if ("left" === this._position || "right" === this._position) h = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ?
                                Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * J[this.intervalType + "Duration"] * this.interval, this.chart.panEnabled || (f = "undefined" === typeof this.options.labelMaxWidth ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth), m = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize; for (b = 0; b < this._labels.length; b++) { a = this._labels[b].textBlock; a.maxWidth = f; a.maxHeight = m; var s = a.measureText(); l = s.height } e = []; q = p = 0; if (this.labelAutoFit ||
                                    this.options.labelAutoFit) if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                                        this.sessionVariables.labelFontSize = this.labelFontSize; this.sessionVariables.labelMaxWidth = f; this.sessionVariables.labelMaxHeight = m; this.sessionVariables.labelAngle =
                                                ...
                                                s = a.measureText(); for (g = c + 1; g < this._labels.length; g++)if (!this._labels[g].breaksLabelType) { d = this._labels[g].textBlock; d = d.measureText(); break } e.push(a.height); this.sessionVariables.labelMaxHeight = Math.max.apply(Math, e); Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)); Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)); b = f * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (m - a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)); if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) if (this.sessionVariables.labelMaxHeight =
                                                    0 === this.labelAngle ? m : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), n = (k - (l + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !r(this.options.labelWrap)) this.labelWrap ? r(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), n), this.sessionVariables.labelWrap = this.labelWrap, d && s.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap =
                                                        this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle) : r(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = m, this.sessionVariables.labelMaxWidth = f, d && s.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = n)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth >
                                                            f ? -25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = m, this.sessionVariables.labelWrap = this.labelWrap); else {
                                                                if (r(this.options.labelWrap)) if (!r(this.options.labelMaxWidth)) this.options.labelMaxWidth < f ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight =
                                    ...
                                    } else for (c = 0; c < this._labels.length; c++)a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = r(this.options.labelMaxWidth) ? r(this.sessionVariables.labelMaxWidth) ?
                                        ...
                                        a.wrap = this.labelWrap = r(this.options.labelWrap) ? r(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = r(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = m : this.sessionVariables.labelMaxHeight, a.measureText(); else if ("left" === this._position || "right" === this._position) if (f = r(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, m = "undefined" === typeof this.options.labelWrap ||
                                            this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                                                this.sessionVariables.labelFontSize = this.labelFontSize; this.sessionVariables.labelMaxWidth = f; this.sessionVariables.labelMaxHeight = m; this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle; this.sessionVariables.labelWrap = this.labelWrap; for (c = 0; c < this._labels.length; c++)if (!this._labels[c].breaksLabelType) {
                                                    a = this._labels[c].textBlock; s = a.measureText();
                                            ...
                                            this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = r(this.options.labelMaxWidth) ? r(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = f : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = r(this.options.labelFontSize) ? r(this.sessionVariables.labelFontSize) ? this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = r(this.options.labelAngle) ? r(this.sessionVariables.labelAngle) ?
                                                this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = r(this.options.labelWrap) ? r(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = r(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = m : this.sessionVariables.labelMaxHeight, a.measureText(); for (c = 0; c < this.stripLines.length; c++) {
                                                    var f = this.stripLines[c], x; if ("outside" ===
                                                        f.labelPlacement) {
                                                            m = this.sessionVariables.labelMaxWidth; if ("bottom" === this._position || "top" === this._position) r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight) ? x = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = x = f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize; if ("left" === this._position || "right" === this._position) r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight) ? x = this.sessionVariables.stripLineLabelMaxHeight :
                                                                this.sessionVariables.stripLineLabelMaxHeight = x = f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize; r(f.labelBackgroundColor) && (f.labelBackgroundColor = "#EEEEEE")
                                                        ...
                                                        w ? "transparent" : null : f.labelBackgroundColor = "#EEEEEE"); a = new ja(this.ctx, {
                        ...
                        var m, h, l, k, n = a[0] ? a[0].chart : d[0].chart, p = n.isNavigator ?
                            0 : 10, q = n._axes; if (a && 0 < a.length) for (var g = 0; g < a.length; g++)a[g] && a[g].calculateAxisParameters(); if (d && 0 < d.length) for (g = 0; g < d.length; g++)d[g].calculateAxisParameters(); if (c && 0 < c.length) for (g = 0; g < c.length; g++)c[g].calculateAxisParameters(); if (b && 0 < b.length) for (g = 0; g < b.length; g++)b[g].calculateAxisParameters(); for (g = 0; g < q.length; g++)if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length) for (var s = q[g].scaleBreaks._appliedBreaks, w = 0; w < s.length && !(s[w].startValue > q[g].viewportMaximum); w++)s[w].endValue <
                                q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), s[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w)); for (var v = w = 0, t = 0, x = 0, y = 0, z = 0, D = 0, B, E, I = h = 0, J, Q, K, s = J = Q = K = !1, g = 0; g < q.length; g++)q[g] && q[g].title && (q[g]._titleTextBlock = new ja(q[g].ctx, {
                                    ...
                                    for (var x = [], y = [], z = [], D = [], L = [], O = [], P = [], S = []; 4 > w;) {
                                        var G = 0, Y = 0, T = 0, X = 0, W = e = 0, M = 0, Z = 0, U = 0, V = 0, R = 0, $ = 0; if (c && 0 < c.length) for (z = [], g = R = 0; g < c.length; g++)z.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), R += z[g],
                                                                                                ...
                                                                                                (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (B = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, m = a[g]._labels[a[g]._labels.length - ("dateTime" === a[g].valueType ? 2 : 1)].position, m = a[g].getApparentDifference(a[g].viewportMinimum, m), E = a[g].logarithmic ?
                                                                                                    (1 < m ? Math.log(m) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < m ? m * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1)); if (d && 0 < d.length) for (g = 0; g < d.length; g++)d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (B = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position -
                                                                                                        d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1, m = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position, m = d[g].getApparentDifference(d[g].viewportMinimum, m), E = d[g].logarithmic ? (1 < m ? Math.log(m) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < m ? m * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1); for (g = 0; g < q.length; g++)"axisY" === q[g].type &&
                                                                                                            (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues()); if (0 < w) { if (a && 0 < a.length) for (g = 0; g < a.length; g++)s = L[w - 1][g] === L[w][g] ? !0 : !1; else s = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)J = O[w - 1][g] === O[w][g] ? !0 : !1; else J = !0; if (c && 0 < c.length) for (g = 0; g < c.length; g++)Q = P[w - 1][g] === P[w][g] ? !0 : !1; else Q = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)K = S[w - 1][g] === S[w][g] ? !0 : !1; else K = !0 } if (s && J && Q && K) break; w++
                                    } if (a && 0 < a.length) for (g = 0; g < a.length; g++)a[g].calculateStripLinesThicknessInValues(),
                                        a[g].calculateBreaksInPixels(); if (d && 0 < d.length) for (g = 0; g < d.length; g++)d[g].calculateStripLinesThicknessInValues(), d[g].calculateBreaksInPixels(); if (c && 0 < c.length) for (g = 0; g < c.length; g++)c[g].calculateStripLinesThicknessInValues(), c[g].calculateBreaksInPixels(); if (b && 0 < b.length) for (g = 0; g < b.length; g++)b[g].calculateStripLinesThicknessInValues(), b[g].calculateBreaksInPixels()
                                } else {
                                    p = []; B = []; I = []; v = []; E = []; t = []; L = []; for (O = []; 4 > w;) {
                                        U = X = T = Z = M = W = e = S = P = G = V = 0; if (a && 0 < a.length) for (I = [], g = X = 0; g < a.length; g++)I.push(Math.ceil(a[g] ?
                                                            ...
                                                            1], x = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), y = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))); if (b && 0 < b.length) for (g = 0; g < b.length; g++)b[g] && 0 < b[g]._labels.length && (k = b[g]._labels[0], h = b[g]._labels[b[g]._labels.length - 1], z = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) +
                                                                (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), D = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))); if (n.panEnabled) for (g = 0; g < c.length; g++)p[g] = r(n.sessionVariables.axisY.height) ? n.sessionVariables.axisY.height = p[g] : n.sessionVariables.axisY.height; else for (g = 0; g < c.length; g++)n.sessionVariables.axisY.height = p[g]; if (c && 0 < c.length) for (g = c.length -
                                                                    1; 0 <= g; g--)h = Math.round(f.y2), k = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = h - (p[g] + c[g].margin + V), c[g].lineCoordinates.y2 = h - (p[g] + c[g].margin + V), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" === c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = {
                                                                        x1: m, y1: h - (p[g] + V + c[g].margin), x2: l, y2: k -
                                                                            (V + c[g].margin), width: l - m, height: p[g]
                                                                        ...
                                                                        b[g].bounds = { x1: m, y1: h + (b[g].margin + G), x2: l, y2: k, width: l - m }, b[g].bounds.height = b[g].bounds.y2 - b[g].bounds.y1, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width), G += B[g] + b[g].margin); if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
                                                                            M = a[g]._labels && 0 < a[g]._labels.length ? a[g]._labels[0].textBlock.fontSize / 2 : 0; m = Math.round(f.x1 + e); h = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(M, 10) ?
                                                                                Math.max(M, 10) : f.y1) : f.y1 < Math.max(M, 10) ? Math.max(M, 10) : f.y1; l = Math.round(f.x1 + X + e); k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2 - T) : f.y2 > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2; if (c && 0 < c.length) for (M = 0; M < c.length; M++)c[M] && c[M].labelAutoFit && (l = 0 > c[M].labelAngle ? Math.max(l, x) : 0 === c[M].labelAngle ? Math.max(l, x / 2) : l, m = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? l - X : m); if (b && 0 < b.length) for (M = 0; M < b.length; M++)b[M] && b[M].labelAutoFit &&
                                                                                    (l = b[M].lineCoordinates.x1, m = l - X); a[g].lineCoordinates = { x1: l - P, y1: h, x2: l - P, y2: k, height: Math.abs(k - h) }; "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.x1 = a[g].lineCoordinates.x1 - (I[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) + ("outside" === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.x2 = a[g].lineCoordinates.x1 + a[g].lineThickness / 2); a[g].bounds = { x1: l - (I[g] + P), y1: h, x2: l - P, y2: k, height: k - h }; a[g].bounds.width = a[g].bounds.x2 - a[g].bounds.x1; a[g].title && (a[g]._titleTextBlock.maxWidth =
                                                                                        0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.height ? a[g].titleMaxWidth : a[g].lineCoordinates.height); a[g].calculateValueToPixelConversionParameters(); a[g].calculateBreaksSizeInValues(); P += I[g] + a[g].margin
                                                                        } if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
                                                                            M = d[g]._labels && 0 < d[g]._labels.length ? d[g]._labels[0].textBlock.fontSize / 2 : 0; m = Math.round(f.x1 - e); h = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(M, 10) ? Math.max(M, 10) : f.y1) : f.y1 < Math.max(M, 10) ? Math.max(M, 10) : f.y1; l = Math.round(f.x2 -
                                                                                U - W); k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2 - T) : f.y2 > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2; if (c && 0 < c.length) for (M = 0; M < c.length; M++)c[M] && c[M].labelAutoFit && (l = 0 > c[M].labelAngle ? Math.max(l, x) : 0 === c[M].labelAngle ? Math.max(l, x / 2) : l, m = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? l - U : m); if (b && 0 < b.length) for (M = 0; M < b.length; M++)b[M] && b[M].labelAutoFit && (l = b[M].lineCoordinates.x2, m = l - U); d[g].lineCoordinates = {
                                                                                    x1: l + S, y1: h,
                                                                                    ...
                                                                                    d[g].lineCoordinates.height ? d[g].titleMaxWidth : d[g].lineCoordinates.height); d[g].calculateValueToPixelConversionParameters(); d[g].calculateBreaksSizeInValues(); S += v[g] + d[g].margin
                                                                        } for (g = 0; g < q.length; g++)"axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues()); if (0 < w) {
                                                                            if (a && 0 < a.length) for (g = 0; g < a.length; g++)s = L[w - 1][g] === L[w][g] ? !0 : !1; else s = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)J = O[w - 1][g] === O[w][g] ? !0 : !1; else J = !0; if (c && 0 < c.length) for (g = 0; g <
                                                                                c.length; g++)Q = E[w - 1][g] === E[w][g] ? !0 : !1; else Q = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)K = t[w - 1][g] === t[w][g] ? !0 : !1; else K = !0
                                                                        } if (s && J && Q && K) break; w++
                                    } if (c && 0 < c.length) for (g = 0; g < c.length; g++)c[g].calculateStripLinesThicknessInValues(), c[g].calculateBreaksInPixels(); if (b && 0 < b.length) for (g = 0; g < b.length; g++)b[g].calculateStripLinesThicknessInValues(), b[g].calculateBreaksInPixels(); if (a && 0 < a.length) for (g = 0; g < a.length; g++)a[g].calculateStripLinesThicknessInValues(), a[g].calculateBreaksInPixels(); if (d &&
                                        0 < d.length) for (g = 0; g < d.length; g++)d[g].calculateStripLinesThicknessInValues(), d[g].calculateBreaksInPixels()
                        }
                    }; D.render = function (a, d, c, b, e) {
                        var f = a[0] ? a[0].chart : d[0].chart; e = f.ctx; f.alignVerticalAxes && f.alignVerticalAxes(); e.save(); e.beginPath(); a && a.length && e.rect(5, a[0].bounds.y1, a[0].chart.width - 10, a[a.length - 1].bounds.y2); d && d.length && e.rect(5, d[d.length - 1].bounds.y1, d[0].chart.width - 10, d[0].bounds.y2); e.clip(); if (a && 0 < a.length) for (var m = 0; m < a.length; m++)a[m].renderLabelsTicksAndTitle(); if (d &&
                            ...
                            var a = this, d = !1, c = 0, b = 0, e = 1, f = 0; 0 !== this.labelAngle && 360 !== this.labelAngle && (e = 1.2); if ("undefined" === typeof this.options.interval) {
                                if ("bottom" === this._position || "top" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                                    ...
                                    for (k = 0; k < this._labels.length; k++)p = this._labels[k], p.position < this.viewportMinimum || (m = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height *
                                        Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += m); c > this.lineCoordinates.width * e && this.labelAutoFit && (d = !0)
                                    ...
                                    for (k = 0; k < this._labels.length; k++)p = this._labels[k], p.position < this.viewportMinimum || p.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(p.position), this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle =
                                        this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (q.x << 0) + 0.5 : q.x << 0, this.ctx.beginPath(), this.ctx.moveTo(b, q.y << 0), this.ctx.lineTo(b, q.y - this.tickLength << 0), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === p.textBlock.angle ? (q.x -= p.textBlock.width / 2, q.y = "inside" === this.labelPlacement ? q.y + this.labelFontSize / 2 + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + p.textBlock.height - p.textBlock.fontSize / 2)) : (q.x = "inside" === this.labelPlacement ? 0 <
                                            this.labelAngle ? q.x : q.x - p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : q.x + (p.textBlock.height - this.labelFontSize) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0), q.y = "inside" === this.labelPlacement ? 0 < this.labelAngle ? q.y + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) +
                                                ((p.textBlock.height - p.textBlock.fontSize / 2) * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))), p.textBlock.x = q.x, p.textBlock.y = q.y)); "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function () {
                                                    for (k = 0; k < a._labels.length; k++)if (p = a._labels[k], !(p.position < a.viewportMinimum || p.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(p.position), a.tickThickness)) {
                                                        ...
                                                        a.ctx.strokeStyle = a.tickColor; var b = 1 === a.ctx.lineWidth % 2 ? (q.x << 0) + 0.5 : q.x << 0; a.ctx.save(); a.ctx.beginPath(); a.ctx.moveTo(b, q.y << 0); a.ctx.lineTo(b, q.y + a.tickLength << 0); a.ctx.stroke(); a.ctx.restore()
                                                    }
                                    ...
                                    this._position) {
                                        for (k = 0; k < this._labels.length; k++)p = this._labels[k], p.position < this.viewportMinimum || p.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(p.position), this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (q.y << 0) + 0.5 : q.y << 0, this.ctx.beginPath(), this.ctx.moveTo(q.x << 0, b), this.ctx.lineTo(q.x + this.tickLength << 0, b), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === this.labelAngle ?
                                            (p.textBlock.y = q.y, p.textBlock.x = "inside" === this.labelPlacement ? q.x - p.textBlock.width - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : q.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5) : (p.textBlock.y = "inside" === this.labelPlacement ? q.y - p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0 > this.labelAngle ? q.y : q.y - (p.textBlock.height - p.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle), p.textBlock.x = "inside" === this.labelPlacement ? q.x - p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) -
                                                ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : 0 < this.labelAngle ? q.x + (p.textBlock.height - p.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + ("inside" === this.tickPlacement ? 0 : this.tickLength) : q.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5))); "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function () {
                                                    for (k = 0; k < a._labels.length; k++)if (p = a._labels[k], !(p.position < a.viewportMinimum || p.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(p.position),
                                                        a.tickThickness)) { a.ctx.lineWidth = a.tickThickness; a.ctx.strokeStyle = a.tickColor; var b = 1 === a.ctx.lineWidth % 2 ? (q.y << 0) + 0.5 : q.y << 0; a.ctx.save(); a.ctx.beginPath(); a.ctx.moveTo(q.x << 0, b); a.ctx.lineTo(q.x - a.tickLength << 0, b); a.ctx.stroke(); a.ctx.restore() }
            ...
            function (a) {
                if (this.stripLines && 0 < this.stripLines.length && a) {
                    for (var d = this, c, b = 0, e = 0, f = !1, m = !1, h = [], l = [], m = !1, b = 0; b < this.stripLines.length; b++) {
                        var k = this.stripLines[b]; k._thicknessType === a && ("pixel" === a && (k.value < this.viewportMinimum || k.value > this.viewportMaximum || r(k.value) || isNaN(this.range)) || "value" === a && (k.startValue <= this.viewportMinimum && k.endValue <= this.viewportMinimum || k.startValue >= this.viewportMaximum && k.endValue >= this.viewportMaximum || r(k.startValue) || r(k.endValue) || isNaN(this.range)) ||
                            h.push(k))
                        ...
                        a = this.getPixelCoordinatesOnAxis(c.position); if ("outside" === c.stripLine.labelPlacement) if (k && (this.ctx.strokeStyle = k.color, "pixel" === k._thicknessType && (this.ctx.lineWidth = k.thickness)), "bottom" === this._position) {
                            var n = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0; this.ctx.beginPath(); this.ctx.moveTo(n, a.y << 0);
                ...
                if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                    var a = this.scaleBreaks._appliedBreaks; w ? (this.maskCanvas = ta(this.chart.width, this.chart.height), this.maskCtx = this.maskCanvas.getContext("2d")) : (this.maskCanvas = this.chart.plotArea.canvas, this.maskCtx = this.chart.plotArea.ctx); this.maskCtx.save(); this.maskCtx.beginPath(); this.maskCtx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1,
                        this.chart.plotArea.width, this.chart.plotArea.height); this.maskCtx.clip(); for (var d = 0; d < a.length; d++)a[d].endValue < this.viewportMinimum || (a[d].startValue > this.viewportMaximum || isNaN(this.range)) || a[d].render(this.maskCtx); this.maskCtx.restore()
                }
            }; D.prototype.renderCrosshair = function (a, d) { isFinite(this.minimum) && isFinite(this.maximum) && (this.crosshair.render(a, d), this.crosshair.dispatchEvent("updated", { chart: this.chart, crosshair: this.options, axis: this, value: this.crosshair.value }, this)) }; D.prototype.showCrosshair =
                function (a) { r(a) || (a < this.viewportMinimum || a > this.viewportMaximum) || ("top" === this._position || "bottom" === this._position ? this.crosshair.render(this.convertValueToPixel(a), null, a) : this.crosshair.render(null, this.convertValueToPixel(a), a)) }; D.prototype.renderGrid = function () {
                    if (this.gridThickness && 0 < this.gridThickness) {
                        var a = this.chart.ctx; a.save(); var d, c = this.chart.plotArea; a.lineWidth = this.gridThickness; a.strokeStyle = this.gridColor; a.setLineDash && a.setLineDash(I(this.gridDashType, this.gridThickness));
                        if ("bottom" === this._position || "top" === this._position) for (b = 0; b < this._labels.length; b++)this._labels[b].position < this.viewportMinimum || (this._labels[b].position > this.viewportMaximum || this._labels[b].breaksLabelType) || (a.beginPath(), d = this.getPixelCoordinatesOnAxis(this._labels[b].position), d = 1 === a.lineWidth % 2 ? (d.x << 0) + 0.5 : d.x << 0, a.moveTo(d, c.y1 << 0), a.lineTo(d, c.y2 << 0), a.stroke()); else if ("left" === this._position || "right" === this._position) for (var b = 0; b < this._labels.length; b++)this._labels[b].position <
                            this.viewportMinimum || (this._labels[b].position > this.viewportMaximum || this._labels[b].breaksLabelType) || (a.beginPath(), d = this.getPixelCoordinatesOnAxis(this._labels[b].position), d = 1 === a.lineWidth % 2 ? (d.y << 0) + 0.5 : d.y << 0, a.moveTo(c.x1 << 0, d), a.lineTo(c.x2 << 0, d), a.stroke()); a.restore()
                    }
                }; D.prototype.renderAxisLine = function () {
                    var a = this.chart.ctx, d = w ? this.chart._preRenderCtx : a, c = Math.ceil(this.tickThickness / (this.reversed ? -2 : 2)), b = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, f; d.save(); if ("bottom" ===
                        ...
                        this.reversed ? (e = this.lineCoordinates.y1, f = this.lineCoordinates.y2) : (e = this.lineCoordinates.y2,
                            f = this.lineCoordinates.y1); d.lineWidth = this.lineThickness; d.strokeStyle = this.lineColor; d.setLineDash && d.setLineDash(I(this.lineDashType, this.lineThickness)); m = 1 === this.lineThickness % 2 ? (this.lineCoordinates.x1 << 0) + 0.5 : this.lineCoordinates.x1 << 0; d.beginPath(); if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex)) if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c; else for (h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++)d.moveTo(m,
                                e), d.lineTo(m, this.scaleBreaks._appliedBreaks[h].startPixel + b), e = this.scaleBreaks._appliedBreaks[h].endPixel + c; e && (d.moveTo(m, e), d.lineTo(m, f)); d.stroke()
                    } w && (a.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height), this.chart._breaksCanvasCtx && this.chart._breaksCanvasCtx.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height), d.clearRect(0, 0, this.chart.width, this.chart.height)); d.restore()
                }; D.prototype.getPixelCoordinatesOnAxis = function (a) {
                    var d = {}; if ("bottom" ===
                        this._position || "top" === this._position) d.x = this.convertValueToPixel(a), d.y = this.lineCoordinates.y1; if ("left" === this._position || "right" === this._position) d.y = this.convertValueToPixel(a), d.x = this.lineCoordinates.x2; return d
                    ...
                    if ("undefined" === typeof a) return null; var d = 0, c = 0, b, d = !0, e = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = "number" === typeof a ? a : "left" === this._position || "right" === this._position ? a.y : a.x; if (this.logarithmic) {
                        a = b = Math.pow(this.logarithmBase,
                            (c - this.conversionParameters.reference) / this.conversionParameters.pixelPerUnit); if (c <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed) for (c = 0; c < e.length; c++) {
                                if (!(e[c].endValue < this.conversionParameters.minimum)) if (d) if (e[c].startValue < this.conversionParameters.minimum) {
                                    if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) < e[c].endValue) {
                                        a = Math.pow(e[c].endValue / e[c].startValue,
                                            Math.log(b) / Math.log(e[c].size)); break
                                    } else a *= e[c].endValue / this.conversionParameters.minimum / Math.pow(e[c].size, Math.log(e[c].endValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue)), b /= Math.pow(e[c].size, Math.log(e[c].endValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue)); d = !1
                                } else if (b > e[c].startValue / this.conversionParameters.minimum) {
                                    b /= e[c].startValue / this.conversionParameters.minimum; if (b < e[c].size) {
                                        a *= Math.pow(e[c].endValue / e[c].startValue,
                            ...
                            } else for (c = e.length - 1; 0 <= c; c--)if (!(e[c].startValue > this.conversionParameters.minimum)) if (d) if (e[c].endValue >
                                this.conversionParameters.minimum) {
                                    if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) > e[c].startValue) { a = Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)); break } else a *= e[c].startValue / this.conversionParameters.minimum * Math.pow(e[c].size, Math.log(e[c].startValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue)) * b, b *= Math.pow(e[c].size, Math.log(this.conversionParameters.minimum / e[c].startValue) /
                                ...
                                b /= e[c].endValue / e[c + 1].startValue; if (b > 1 / e[c].size) {
                        ...
                        } else for (c = e.length - 1; 0 <= c; c--)if (!(e[c].startValue > this.conversionParameters.minimum)) if (d) if (e[c].endValue > this.conversionParameters.minimum) if (e[c].size &&
                            this.conversionParameters.minimum + b * (e[c].endValue - e[c].startValue) / e[c].size > e[c].startValue) { a = 0 >= e[c].size ? 0 : b * (e[c].endValue - e[c].startValue) / e[c].size; break } else a += e[c].startValue - this.conversionParameters.minimum + e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue), b += e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue), d = !1; else if (b < e[c].endValue - this.conversionParameters.minimum) {
                                b -= e[c].endValue - this.conversionParameters.minimum;
                                if (b > -1 * e[c].size) { a += (e[c].endValue - e[c].startValue) * (0 === e[c].size ? 1 : b / e[c].size) + b; break } else a -= e[c].endValue - e[c].startValue - e[c].size; b += e[c].size; d = !1
                    ...
                    } else for (c = r(c) ? Math.abs(d - a) : c, f = 0; f < e.length && !(d < e[f].startValue); f++)a > e[f].endValue || (a <= e[f].startValue && d >= e[f].endValue ? c = c - e[f].endValue + e[f].startValue + e[f].size : a > e[f].startValue && d >= e[f].endValue ? c = c - e[f].endValue + a + e[f].size * (e[f].endValue - a) / (e[f].endValue - e[f].startValue) : a <= e[f].startValue && d <
                        e[f].endValue ? c = c - d + e[f].startValue + e[f].size * (d - e[f].startValue) / (e[f].endValue - e[f].startValue) : !b && (a > e[f].startValue && d < e[f].endValue) && (c = a + e[f].size * (d - a) / (e[f].endValue - e[f].startValue))); return c
                }; D.prototype.setViewPortRange = function (a, d) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, d); this.sessionVariables.newViewportMaximum = this.viewportMaximum = Math.max(a, d) }; D.prototype.getXValueAt = function (a) {
                    if (!a) return null; var d = null; "left" === this._position ? d = this.convertPixelToValue(a.y) :
                        "bottom" === this._position && (d = this.convertPixelToValue(a.x)); return d
        ...
        D.prototype.getLabelStartPoint = function () {
                ...
                0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                    var d = this.ctx, c = this.ctx.globalAlpha; this.ctx = a || this.ctx; this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); var b = this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.startValue), e = this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.endValue); this.ctx.strokeStyle =
                        this.lineColor; this.ctx.fillStyle = this.color; this.ctx.beginPath(); this.ctx.globalAlpha = 1; S(this.id); var f, h, l, r, k, n; a = Math.max(this.spacing, 3); var p = Math.max(0, this.lineThickness); this.ctx.lineWidth = p; this.ctx.setLineDash && this.ctx.setLineDash(I(this.lineDashType, p)); if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, h = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 +
                            p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b - p / 2, y1: e, x2: h + p / 2, y2: l }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, l), this.ctx.lineTo(h, l), this.ctx.lineTo(h, e); else if ("wavy" === this.type) {
                                r = b; k = e; f = 0.5; n = (l - k) / a / 3; for (var q = 0; q < n; q++)this.ctx.bezierCurveTo(r + f * a, k + a, r + f * a, k + 2 * a, r, k + 3 * a), k += 3 * a, f *= -1; this.ctx.bezierCurveTo(r + f * a,
                            ...
                            } else { if ("zigzag" === this.type) { f = -1; k = e + a; r = b + a; n = (l - k) / a / 2; for (q = 0; q < n; q++)this.ctx.lineTo(r, k), r += 2 * f * a, k += 2 * a, f *= -1; this.ctx.lineTo(r, k); r += h - b; for (q = 0; q < n + 1; q++)this.ctx.lineTo(r, k), r += 2 * f * a, k -= 2 * a, f *= -1; this.ctx.lineTo(r + f * a, k + a) } } else if ("left" === this.scaleBreaks.parent._position || "right" === this.scaleBreaks.parent._position) if (e = 1 === p % 2 ? (e.y << 0) + 0.5 : e.y <<
                                0, l = 1 === p % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, h = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, h = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b, y1: e - p / 2, x2: h, y2: l + p / 2 }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(h, e), this.ctx.lineTo(h, l), this.ctx.lineTo(b, l); else if ("wavy" === this.type) {
                                    r = b; k = e; f = 0.5; n =
                                        (h - r) / a / 3; for (q = 0; q < n; q++)this.ctx.bezierCurveTo(r + a, k + f * a, r + 2 * a, k + f * a, r + 3 * a, k), r += 3 * a, f *= -1; this.ctx.bezierCurveTo(r + a, k + f * a, r + 2 * a, k + f * a, r + 3 * a, k); k = l; f *= -1; this.ctx.lineTo(r, k); for (q = 0; q < n; q++)this.ctx.bezierCurveTo(r - a, k + f * a, r - 2 * a, k + f * a, r - 3 * a, k), r -= 3 * a, f *= -1
                                } else if ("zigzag" === this.type) { f = 1; k = e - a; r = b + a; n = (h - r) / a / 2; for (q = 0; q < n; q++)this.ctx.lineTo(r, k), k += 2 * f * a, r += 2 * a, f *= -1; this.ctx.lineTo(r, k); k += l - e; for (q = 0; q < n + 1; q++)this.ctx.lineTo(r, k), k += 2 * f * a, r -= 2 * a, f *= -1; this.ctx.lineTo(r + a, k + f * a) } 0 < p && this.ctx.stroke();
        ...
        }; oa(P, Z); P.prototype.createUserOptions = function (a) {
            if ("undefined" !== typeof a || this.options._isPlaceholder) {
                var d = 0; this.parent.options._isPlaceholder && this.parent.createUserOptions(); this.options._isPlaceholder || (Fa(this.parent.stripLines), d = this.parent.options.stripLines.indexOf(this.options)); this.options = "undefined" ===
            ...
            this.ctx.save(); var a = this.parent.getPixelCoordinatesOnAxis(this.value), d = Math.abs("pixel" === this._thicknessType ? this.thickness : Math.abs(this.parent.convertValueToPixel(this.endValue) - this.parent.convertValueToPixel(this.startValue))); if (0 < d) {
                var c = null === this.opacity ? 1 : this.opacity; this.ctx.strokeStyle = this.color; this.ctx.beginPath(); var b = this.ctx.globalAlpha; this.ctx.globalAlpha = c; S(this.id); var e, f, h,
                    l; this.ctx.lineWidth = d; this.ctx.setLineDash && this.ctx.setLineDash(I(this.lineDashType, d)); if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: h, x2: f + d / 2, y2: l }; else if ("left" === this.parent._position || "right" === this.parent._position) h = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2, this.bounds = {
                        x1: e, y1: h - d / 2, x2: f,
                        y2: l + d / 2
                    }; this.ctx.moveTo(e, h); this.ctx.lineTo(f, l); this.ctx.stroke(); this.ctx.globalAlpha = b
            } this.ctx.restore()
            ...
            var b, e, f, h, l = null, w = null, k = null, n = ""; if (!this.valueFormatString) if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString; else {
                var p = 0, p = "xySwapped" === this.chart.plotInfo.axisPlacement ?
                    50 < this.parent.range ? 0 : 500 < this.chart.width && 25 > this.parent.range ? 2 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0) : 50 < this.parent.range ? 0 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0); this.valueFormatString = D.generateValueFormatString(this.parent.range, p)
                    ...
                    { x: 0, y: 0, padding: { top: 2, right: 3, bottom: 2, left: 4 }, backgroundColor: this.labelBackgroundColor, borderColor: this.labelBorderColor, borderThickness: this.labelBorderThickness, cornerRadius: this.labelCornerRadius, maxWidth: this.labelMaxWidth, maxHeight: this.labelMaxHeight, angle: this.labelAngle, text: n, horizontalAlign: "left", fontSize: this.labelFontSize, fontFamily: this.labelFontFamily, fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle" }); if (this.snapToDataPoint) {
                        var s =
                            0, n = []; if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                                    ...
                                    n.push(v)); v = null; if (0 === n.length) return; n.sort(function (a, b) { return a.distance - b.distance }); v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); x = 0; if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[x].dataPoint.y[0])), t = 0, s = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (var A = 0; A < n[s].dataPoint.y.length; A++)t = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[A])), t < v && (v = t, x = s); else t =
                                        Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y)), t < v && (v = t, x = s); else if ("stackedBar" === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = t = 0, s = x = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (A = 0; A < n[s].dataPoint.y.length; A++)t = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[A])), t < v && (v = t, x = s); else y += n[s].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(y)), t < v && (v = t, x = s); else if ("stackedBar100" === n[0].dataSeries.type) for (var v =
                                            Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), z = y = t = 0, s = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (A = 0; A < n[s].dataPoint.y.length; A++)t = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[A])), t < v && (v = t, x = s); else y += n[s].dataPoint.y, z = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x, z = 100 * (y / n[s].dataSeries.plotUnit.dataPointYSums[z]), t = Math.abs(a - this.parent.convertValueToPixel(z)), t < v && (v = t, x = s); else for (v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                                                s = x = t = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (A = 0; A < n[s].dataPoint.y.length; A++)t = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[A])), t < v && (v = t, x = s); else t = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y)), t < v && (v = t, x = s); A = n[x]; if ("bottom" === this.parent._position || "top" === this.parent._position) {
                                                    b = 0; if ("rangeBar" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type) {
                                                        ...
                                                        v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); y = t = 0; for (s = x; 0 <= s; s--)y += n[s].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(y)), t < v && (v = t, b = s); l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y) << 0) + 0.5 : this.parent.convertValueToPixel(y) << 0; this.value = y; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: A.dataPoint.y }) : r(this.options.label) ?
                                                        ...
                                                        v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); z = y = t = 0; for (s = x; 0 <= s; s--)y += n[s].dataPoint.y, z = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x, z = 100 * (y / n[s].dataSeries.plotUnit.dataPointYSums[z]), t = Math.abs(a - this.parent.convertValueToPixel(z)), t < v && (v = t, b = s); l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z) << 0) + 0.5 :
                                ...
                                k.x = b - k.measureText().width / 2; k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width); k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1); "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
                            } else if ("left" === this.parent._position || "right" === this.parent._position) {
                                    ...
                                    "boxAndWhisker" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), s = t = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (A = 0; A < n[s].dataPoint.y.length; A++)t = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[A])), t < v && (v = t, x = s); else t = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y)), t < v && (v = t, x = s); else if ("stackedColumn" === n[0].dataSeries.type || "stackedArea" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                                        s = y = t = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (A = 0; A < n[s].dataPoint.y.length; A++)t = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[A])), t < v && (v = t, x = s); else y += n[s].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(y)), t < v && (v = t, x = s); else if ("stackedColumn100" === n[0].dataSeries.type || "stackedArea100" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = z = y = t = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (A =
                                            0; A < n[s].dataPoint.y.length; A++)t = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[A])), t < v && (v = t, x = s); else y += n[s].dataPoint.y, z = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x, z = 100 * (y / n[s].dataSeries.plotUnit.dataPointYSums[z]), t = Math.abs(d - this.parent.convertValueToPixel(z)), t < v && (v = t, x = s); else for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = t = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (A = 0; A < n[s].dataPoint.y.length; A++)t =
                                                Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[A])), t < v && (v = t, x = s); else t = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y)), t < v && (v = t, x = s); A = n[x]; b = 0; if ("rangeColumn" === this.parent.dataSeries[x].type || "rangeArea" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type || "rangeSplineArea" === this.parent.dataSeries[x].type || "candlestick" === this.parent.dataSeries[x].type || "ohlc" === this.parent.dataSeries[x].type || "boxAndWhisker" === this.parent.dataSeries[x].type) {
                                                    v =
                                                    Math.abs(d - this.parent.convertValueToPixel(A.dataPoint.y[0])); for (s = t = 0; s < A.dataPoint.y.length; s++)t = Math.abs(d - this.parent.convertValueToPixel(A.dataPoint.y[s])), t < v && (v = t, b = s); w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(A.dataPoint.y[b]) << 0) + 0.5 : this.parent.convertValueToPixel(A.dataPoint.y[b]) << 0; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: A.dataPoint.y[b] }) : r(this.options.label) ? da(r(c) ? A.dataPoint.y[b] : c, this.valueFormatString,
                                                        this.chart._cultureInfo) : this.label; this.value = A.dataPoint.y[b]
                                                } else if ("stackedColumn" === this.parent.dataSeries[x].type || "stackedArea" === this.parent.dataSeries[x].type) {
                                                    v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); y = t = 0; for (s = x; 0 <= s; s--)y += n[s].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(y)), t < v && (v = t, b = s); w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y) << 0) + 0.5 : this.parent.convertValueToPixel(y) << 0; k.text = this.labelFormatter ? this.labelFormatter({
                                                        chart: this.chart,
                                                        axis: this.parent.options, crosshair: this.options, value: A.dataPoint.y
                                                    }) : r(this.options.label) ? da(r(c) ? A.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label; this.value = y
                                                } else if ("stackedColumn100" === this.parent.dataSeries[x].type || "stackedArea100" === this.parent.dataSeries[x].type) {
                                                    v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); y = t = 0; for (s = x; 0 <= s; s--)y += n[s].dataPoint.y, z = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x, z = 100 * (y / n[s].dataSeries.plotUnit.dataPointYSums[z]),
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h }; else if ("left" === this.parent._position || "right" === this.parent._position) f = h = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2, this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 }; if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" ===
                            this.parent._position || "right" === this.parent._position) {
                                z = !1; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s += n)if (this.parent.labels[s]) z = !0; else { z = !1; break } if (z) {
                                ...
                                } else k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(d) : c }) : r(this.options.label) ? da(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart,
                            ...
                            z = !1; n = ""; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s += n)if (this.parent.labels[s]) z =
                                !0; else { z = !1; break } if (z) { if ("axisX" === this.parent.type) for (s = this.parent.convertPixelToValue({ x: a }), v = null, x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(s, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c }) : r(this.options.label) ? r(c) ? v.dataPoint.label : c : this.label) } else k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ?
                                    this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" : c }) : r(this.options.label) ? da(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c }) : r(this.options.label) ? Da(r(c) ?
                                        this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label; k.x = b - k.measureText().width / 2; k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width); k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1); "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
        ...
        }; ca.prototype.renderLabel = function () { r(this._textBlock) || (r(this._textBlock.text) || !("number" === typeof this._textBlock.text.valueOf() || 0 < this._textBlock.text.length) || this._hidden) || this._textBlock.render(!0) }; oa(W, Z); W.prototype._initialize = function () {
            ...
            c = "undefined" === typeof c ? !0 : c; this.container || this._initialize(); this.enabled || this.hide(); if (!this.chart.disableToolTip) {
                if ("undefined" === typeof a || "undefined" === typeof d) { if (isNaN(this._prevX) || isNaN(this._prevY)) return; a = this._prevX; d = this._prevY } else this._prevX = a, this._prevY = d; var b = null, e = null, f = [], h = 0; if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    var l =
                        []; if (this.chart.axisX) for (var v = 0; v < this.chart.axisX.length; v++) { for (var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[v].convertPixelToValue({ y: d }) : this.chart.axisX[v].convertPixelToValue({ x: a }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)(k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && l.push(k)); k = null } if (this.chart.axisX2) for (v = 0; v < this.chart.axisX2.length; v++) {
                            h =
                            "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX2[v].convertPixelToValue({ y: d }) : this.chart.axisX2[v].convertPixelToValue({ x: a }); k = null; for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && l.push(k)); k = null
                        } if (0 === l.length) return; l.sort(function (a, b) { return a.distance - b.distance }); c = l[0]; for (b = 0; b < l.length; b++)l[b].dataPoint.x.valueOf() ===
                            c.dataPoint.x.valueOf() && f.push(l[b]); l = null
                } else {
            ...
            var c, b, e, f = []; e = !1; d = !r(d) && 0 <= d && d < this.chart.data.length ? d : 0; if (this.shared) for (var h = 0; h < this.chart.data.length; h++)c = this.chart.data[h], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b)); else c = this.chart.data[d], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b)); if (0 < f.length) {
                for (h = 0; h < f.length; h++)if (b = f[h], (this.shared || 0 <= b.dataSeries.type.indexOf("100")) && b.dataPoint.x >= b.dataSeries.axisX.viewportMinimum &&
                    b.dataPoint.x <= b.dataSeries.axisX.viewportMaximum) { e = !1; break } else if (b.dataPoint.x < b.dataSeries.axisX.viewportMinimum || b.dataPoint.x > b.dataSeries.axisX.viewportMaximum || b.dataPoint.y < b.dataSeries.axisY.viewportMinimum || b.dataPoint.y > b.dataSeries.axisY.viewportMaximum) e = !0; else { e = !1; break } if (e) return this.hide(), !1; this.highlightObjects(f); this._entries = f; h = ""; h = this.getToolTipInnerHTML({ entries: f }); if (null !== h) {
                        this.contentDiv.innerHTML = h; if (this.isToolTipDefinedInData && r(this.options.content) &&
                            r(this.options.contentFormatter)) for (b = this.contentDiv.getElementsByTagName("span"), h = 0; h < b.length; h++)b[h] && (b[h].style.color = b[h].getAttribute("data-color")); h = !1; "none" === this.container.style.display && (h = !0, this.container.style.display = "block"); try {
                            ...
                            } catch (l) { } "pie" === f[0].dataSeries.type || "doughnut" ===
        ...
        W.prototype.getContainerTransition = function (a) { return "left " + a + "s ease-out 0s, bottom " + a + "s ease-out 0s" }; ha.prototype.reset = function () { this.lastObjectId = 0; this.objectMap = []; this.rectangularRegionEventSubscriptions = []; this.previousDataPointEventObject = null; this.eventObjects = []; w && (this.ghostCtx.clearRect(0, 0, this.chart.width, this.chart.height), this.ghostCtx.beginPath()) }; ha.prototype.getNewObjectTrackingId = function () { return ++this.lastObjectId }; ha.prototype.mouseEventHandler = function (a) {
            if ("mousemove" ===
                a.type || "click" === a.type) {
                    var d = [], c = Qa(a), b = null; if ((b = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[b]) if (b = this.objectMap[b], "dataPoint" === b.objectType) {
                        var e = this.chart.data[b.dataSeriesIndex], f = e.dataPoints[b.dataPointIndex], h = b.dataPointIndex; b.eventParameter = { x: c.x, y: c.y, dataPoint: f, dataSeries: e.options, dataPointIndex: h, dataSeriesIndex: e.index, chart: this.chart }; b.eventContext = {
                            context: f, userContext: f, mouseover: "mouseover", mousemove: "mousemove", mouseout: "mouseout",
                            click: "click"
                        }; d.push(b); b = this.objectMap[e.id]; b.eventParameter = { x: c.x, y: c.y, dataPoint: f, dataSeries: e.options, dataPointIndex: h, dataSeriesIndex: e.index, chart: this.chart }; b.eventContext = { context: e, userContext: e.options, mouseover: "mouseover", mousemove: "mousemove", mouseout: "mouseout", click: "click" }; d.push(this.objectMap[e.id])
                        ...
                        dataPoint: f, dataPointIndex: b.dataPointIndex, dataSeriesIndex: b.dataSeriesIndex, chart: this.chart
            ...
            if (a && d) {
                var b = a.eventParameter, e = a.eventContext, f = a.eventContext.userContext; f && (e && f[e[d]]) && f[e[d]].call(f, b); "mouseout" !== d ? f.cursor && f.cursor !==
            ...
            yScaleAnimation: function (a, d) {
                ...
                if (0 !== a) {
                    var c = d.dest, b = d.source.canvas; c.save(); c.globalAlpha = a; c.drawImage(b, 0, 0, b.width, b.height, 0, 0, c.canvas.width / ka, c.canvas.height /
                        ka); c.restore()
                }
            ...
            drawMarker: function (a, d, c, b, e, f, h, l) {
                if (c) {
                    var r = 1; c.fillStyle = f ? f : "#000000"; c.strokeStyle = h ? h : "#000000"; c.lineWidth = l ? l : 0; c.setLineDash && c.setLineDash(I("solid", l)); "circle" === b ? (c.moveTo(a, d), c.beginPath(),
    ...
    }(); x.version = "v3.7.12 GA"; window.CanvasJS && (x && !window.CanvasJS.Chart) && (window.CanvasJS.Chart = x)
})();
